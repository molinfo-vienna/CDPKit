...
if (Boost_FIND_VERSION_EXACT)
  ...
  set( _boost_TEST_VERSIONS ${Boost_ADDITIONAL_VERSIONS} 
    "1.61.0" "1.60.0" "1.59.0" "1.58.0" "1.57.0" "1.56.0" "1.55.0" "1.54.0"
    "1.53.0" "1.52.0" "1.51.0" "1.50.0" "1.49.0" "1.48.0" "1.47.0" "1.46.0"
    "1.45.0" "1.44.0" "1.43.0" "1.42.0" "1.41.0"
    "1.40.0" "1.39.0" "1.38.0" "1.37.0" "1.36.1" "1.36.0" "1.36" "1.35.1"
    ...
    FIND_LIBRARY(Boost_${UPPERCOMPONENT}_LIBRARY_RELEASE
        NAMES  ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}-${Boost_LIB_VERSION}
	       ...
	       boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}-${Boost_LIB_VERSION}
               boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}${_boost_STATIC_TAG}-${Boost_LIB_VERSION}
               boost_${COMPONENT}${_boost_MULTITHREADED}
               boost_${COMPONENT}${_boost_MULTITHREADED}${_boost_STATIC_TAG}
               boost_${COMPONENT}
    ...
    FIND_LIBRARY(Boost_${UPPERCOMPONENT}_LIBRARY_DEBUG
        NAMES  ${Boost_LIB_PREFIX}boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}-${_boost_ABI_TAG}-${Boost_LIB_VERSION}
	       ...
	       boost_${COMPONENT}${_boost_COMPILER}${_boost_MULTITHREADED}-${_boost_ABI_TAG}-${Boost_LIB_VERSION}
               ...
               boost_${COMPONENT}${_boost_MULTITHREADED}-${_boost_ABI_TAG}
               boost_${COMPONENT}${_boost_MULTITHREADED}${_boost_STATIC_TAG}${_boost_ABI_TAG}
               boost_${COMPONENT}-${_boost_ABI_TAG}
        HINTS  ${_boost_LIBRARIES_SEARCH_DIRS}
    )
