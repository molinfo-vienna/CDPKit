...
void CDPLPythonVis::exportMolecularGraphFunctions()
{
    ...
    EXPORT_MOLGRAPH_FUNCS_INT_REF(AtomConfigurationLabelColor, color)
    EXPORT_MOLGRAPH_FUNCS_INT_REF(AtomCustomLabelFont, font)
    EXPORT_MOLGRAPH_FUNCS_INT_REF(AtomCustomLabelSize, size)
    EXPORT_MOLGRAPH_FUNCS_INT_REF(AtomCustomLabelColor, color)
    ...
    EXPORT_MOLGRAPH_FUNCS_INT_REF(BondConfigurationLabelColor, color)
