...
void CDPLPythonVis::exportMolecularGraphProperties()
{
    ...
    python::class_<MolecularGraphProperty, boost::noncopyable>("MolecularGraphProperty", python::no_init)
        ...
        .def_readonly("ATOM_HIGHLIGHT_AREA_SIZE", &Vis::MolecularGraphProperty::ATOM_HIGHLIGHT_AREA_SIZE)
        .def_readonly("ATOM_HIGHLIGHT_AREA_BRUSH", &Vis::MolecularGraphProperty::ATOM_HIGHLIGHT_AREA_BRUSH)
        .def_readonly("ATOM_HIGHLIGHT_AREA_OUTLINE_PEN", &Vis::MolecularGraphProperty::ATOM_HIGHLIGHT_AREA_OUTLINE_PEN)
        .def_readonly("HIGHLIGHT_AREA_OUTLINE_WIDTH", &Vis::MolecularGraphProperty::HIGHLIGHT_AREA_OUTLINE_WIDTH)
        ...
        .def_readonly("BOND_HIGHLIGHT_AREA_WIDTH", &Vis::MolecularGraphProperty::BOND_HIGHLIGHT_AREA_WIDTH)
        .def_readonly("BOND_HIGHLIGHT_AREA_BRUSH", &Vis::MolecularGraphProperty::BOND_HIGHLIGHT_AREA_BRUSH)
        .def_readonly("BOND_HIGHLIGHT_AREA_OUTLINE_PEN", &Vis::MolecularGraphProperty::BOND_HIGHLIGHT_AREA_OUTLINE_PEN)
