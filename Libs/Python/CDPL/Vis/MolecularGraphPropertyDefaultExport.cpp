...
void CDPLPythonVis::exportMolecularGraphPropertyDefaults()
{
    ...
    python::class_<MolecularGraphPropertyDefault, boost::noncopyable>("MolecularGraphPropertyDefault", python::no_init)
        ...
        .def_readonly("ATOM_HIGHLIGHT_AREA_SIZE", &Vis::MolecularGraphPropertyDefault::ATOM_HIGHLIGHT_AREA_SIZE)
        .def_readonly("ATOM_HIGHLIGHT_AREA_BRUSH", &Vis::MolecularGraphPropertyDefault::ATOM_HIGHLIGHT_AREA_BRUSH)
        .def_readonly("ATOM_HIGHLIGHT_AREA_OUTLINE_PEN", &Vis::MolecularGraphPropertyDefault::ATOM_HIGHLIGHT_AREA_OUTLINE_PEN)
        .def_readonly("HIGHLIGHT_AREA_OUTLINE_WIDTH", &Vis::MolecularGraphPropertyDefault::HIGHLIGHT_AREA_OUTLINE_WIDTH)
        ...
        .def_readonly("BOND_HIGHLIGHT_AREA_WIDTH", &Vis::MolecularGraphPropertyDefault::BOND_HIGHLIGHT_AREA_WIDTH)
        .def_readonly("BOND_HIGHLIGHT_AREA_BRUSH", &Vis::MolecularGraphPropertyDefault::BOND_HIGHLIGHT_AREA_BRUSH)
        .def_readonly("BOND_HIGHLIGHT_AREA_OUTLINE_PEN", &Vis::MolecularGraphPropertyDefault::BOND_HIGHLIGHT_AREA_OUTLINE_PEN)
        ...
        .def_readonly("ATOM_CUSTOM_LABEL_FONT", &Vis::MolecularGraphPropertyDefault::ATOM_CUSTOM_LABEL_FONT)
        .def_readonly("ATOM_CUSTOM_LABEL_SIZE", &Vis::MolecularGraphPropertyDefault::ATOM_CUSTOM_LABEL_SIZE)
        .def_readonly("ATOM_CUSTOM_LABEL_COLOR", &Vis::MolecularGraphPropertyDefault::ATOM_CUSTOM_LABEL_COLOR)
        .def_readonly("BOND_CUSTOM_LABEL_FONT", &Vis::MolecularGraphPropertyDefault::BOND_CUSTOM_LABEL_FONT)
        .def_readonly("BOND_CUSTOM_LABEL_SIZE", &Vis::MolecularGraphPropertyDefault::BOND_CUSTOM_LABEL_SIZE)
        .def_readonly("BOND_CUSTOM_LABEL_COLOR", &Vis::MolecularGraphPropertyDefault::BOND_CUSTOM_LABEL_COLOR)
        ;
}
