...
void CDPLPythonChem::exportBondOrderGenerator()
{
    using namespace boost;
    using namespace CDPL;

    bool (Chem::BondOrderGenerator::*undefOnlyGetterFunc)() const = &Chem::BondOrderGenerator::undefinedOnly;
    void (Chem::BondOrderGenerator::*undefOnlySetterFunc)(bool) = &Chem::BondOrderGenerator::undefinedOnly;
