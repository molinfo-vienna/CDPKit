...
namespace
{
    ...
    MAKE_CONTROL_PARAM_FUNC_WRAPPERS(bool, MDLEnableAromaticBondTypes)
    ...
    MAKE_CONTROL_PARAM_FUNC_WRAPPERS(bool, CMLEnableAromaticBondTypes)
...
void CDPLPythonChem::exportControlParameterFunctions()
{
    ...
    EXPORT_CONTROL_PARAM_FUNCS(MDLEnableAromaticBondTypes, enable)
    ...
    EXPORT_CONTROL_PARAM_FUNCS(CMLEnableAromaticBondTypes, enable)
