...
void CDPLPythonChem::exportFragmentList()
{
    ...
    python::class_<Chem::FragmentList, Chem::FragmentList::SharedPointer>("FragmentList", python::no_init)
        ...
        .def("__eq__", &Util::operator==<Chem::FragmentList::BaseType::ElementType>, (python::arg("self"), python::arg("list")))
        .def("__ne__", &Util::operator!=<Chem::FragmentList::BaseType::ElementType>, (python::arg("self"), python::arg("list")));
}
