...
void CDPLPythonChem::exportHydrophobicFeatureGenerator()
{
    ...
    python::class_<Chem::HydrophobicFeatureGenerator, python::bases<Chem::PatternBasedFeatureGenerator>, boost::noncopyable>("HydrophobicFeatureGenerator", python::no_init)
