...
namespace
{
	...
	MAKE_FUNCTION_WRAPPER2(std::size_t, getExplicitBondCount, CDPL::Chem::BondContainer&, std::size_t);
...
void CDPLPythonChem::exportBondContainerFunctions()
{
	using namespace boost;
	using namespace CDPL;

	python::def("getExplicitBondCount", &getExplicitBondCountWrapper1, python::arg("cntnr"));
	python::def("getExplicitBondCount", &getExplicitBondCountWrapper2, (python::arg("cntnr"), python::arg("order")));
