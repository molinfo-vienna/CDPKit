...
void CDPLPythonChem::exportSMARTSMoleculeReader()
{
	...
	python::class_<Util::FileDataReader<Chem::SMARTSMoleculeReader>, python::bases<Base::DataReader<Chem::Molecule> >, 
		boost::noncopyable>("FileSMARTSMoleculeReader", python::no_init)
