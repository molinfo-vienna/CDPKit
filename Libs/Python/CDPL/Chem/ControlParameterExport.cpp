...
void CDPLPythonChem::exportControlParameters()
{
    ...
    python::class_<ControlParameter, boost::noncopyable>("ControlParameter", python::no_init)
        ...
        .def_readonly("MDL_ENABLE_AROMATIC_BOND_TYPES", &Chem::ControlParameter::MDL_ENABLE_AROMATIC_BOND_TYPES)
        ...
        .def_readonly("CML_ENABLE_AROMATIC_BOND_TYPES", &Chem::ControlParameter::CML_ENABLE_AROMATIC_BOND_TYPES)
