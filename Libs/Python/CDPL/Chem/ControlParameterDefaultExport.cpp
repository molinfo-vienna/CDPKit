...
void CDPLPythonChem::exportControlParameterDefaults()
{
    ...
    python::class_<ControlParameterDefault, boost::noncopyable>("ControlParameterDefault", python::no_init)
        ...
        .def_readonly("MDL_OUTPUT_AROMATIC_BOND_TYPES", &Chem::ControlParameterDefault::MDL_OUTPUT_AROMATIC_BOND_TYPES)
        ...
        .def_readonly("CML_OUTPUT_KEKULE_FORM", &Chem::ControlParameterDefault::CML_OUTPUT_KEKULE_FORM)
