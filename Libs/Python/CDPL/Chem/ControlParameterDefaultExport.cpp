...
void CDPLPythonChem::exportControlParameterDefaults()
{
    ...
    python::class_<ControlParameterDefault, boost::noncopyable>("ControlParameterDefault", python::no_init)
        ...
        .def_readonly("MDL_ENABLE_AROMATIC_BOND_TYPES", &Chem::ControlParameterDefault::MDL_ENABLE_AROMATIC_BOND_TYPES)
        .def_readonly("SMILES_RECORD_FORMAT", &Chem::ControlParameterDefault::SMILES_RECORD_FORMAT)
        .def_readonly("SMILES_OUTPUT_CANONICAL_FORM", &Chem::ControlParameterDefault::SMILES_OUTPUT_CANONICAL_FORM)
        .def_readonly("SMILES_OUTPUT_KEKULE_FORM", &Chem::ControlParameterDefault::SMILES_OUTPUT_KEKULE_FORM)
        .def_readonly("SMILES_OUTPUT_ATOM_STEREO", &Chem::ControlParameterDefault::SMILES_OUTPUT_ATOM_STEREO)
        .def_readonly("SMILES_OUTPUT_BOND_STEREO", &Chem::ControlParameterDefault::SMILES_OUTPUT_BOND_STEREO)
        .def_readonly("SMILES_OUTPUT_RING_BOND_STEREO", &Chem::ControlParameterDefault::SMILES_OUTPUT_RING_BOND_STEREO)
        .def_readonly("SMILES_MIN_STEREO_BOND_RING_SIZE", &Chem::ControlParameterDefault::SMILES_MIN_STEREO_BOND_RING_SIZE)
        .def_readonly("SMILES_OUTPUT_ISOTOPE", &Chem::ControlParameterDefault::SMILES_OUTPUT_ISOTOPE)
        .def_readonly("SMILES_OUTPUT_HYDROGEN_COUNT", &Chem::ControlParameterDefault::SMILES_OUTPUT_HYDROGEN_COUNT)
        .def_readonly("SMILES_RXN_OUTPUT_ATOM_MAPPING_ID", &Chem::ControlParameterDefault::SMILES_RXN_OUTPUT_ATOM_MAPPING_ID)
        .def_readonly("SMILES_MOL_OUTPUT_ATOM_MAPPING_ID", &Chem::ControlParameterDefault::SMILES_MOL_OUTPUT_ATOM_MAPPING_ID)
        .def_readonly("SMILES_OUTPUT_SINGLE_BONDS", &Chem::ControlParameterDefault::SMILES_OUTPUT_SINGLE_BONDS)
        .def_readonly("SMILES_OUTPUT_AROMATIC_BONDS", &Chem::ControlParameterDefault::SMILES_OUTPUT_AROMATIC_BONDS)
        ...
        .def_readonly("CDF_OUTPUT_SINGLE_PRECISION_FLOATS", &Chem::ControlParameterDefault::CDF_OUTPUT_SINGLE_PRECISION_FLOATS)
        ...
        .def_readonly("MOL2_READ_PARTIAL_AS_FORMAL_CHARGES", &Chem::ControlParameterDefault::MOL2_READ_PARTIAL_AS_FORMAL_CHARGES)
        .def_readonly("MOL2_OUTPUT_FORMAL_CHARGES", &Chem::ControlParameterDefault::MOL2_OUTPUT_FORMAL_CHARGES)
        ...
        .def_readonly("CML_ENABLE_AROMATIC_BOND_TYPES", &Chem::ControlParameterDefault::CML_ENABLE_AROMATIC_BOND_TYPES)
