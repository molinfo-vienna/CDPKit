...
void CDPLPythonBiomol::exportControlParameterDefaults()
{
    ...
    python::class_<ControlParameterDefault, boost::noncopyable>("ControlParameterDefault", python::no_init)
        ...
        .def_readonly("PDB_WRITE_FORMAL_CHARGES", &Biomol::ControlParameterDefault::PDB_OUTPUT_FORMAL_CHARGES)
        .def_readonly("PDB_OUTPUT_CONECT_RECORDS", &Biomol::ControlParameterDefault::PDB_OUTPUT_CONECT_RECORDS)
        .def_readonly("PDB_OUTPUT_CONECT_RECORDS_FOR_ALL_BONDS", &Biomol::ControlParameterDefault::PDB_OUTPUT_CONECT_RECORDS_FOR_ALL_BONDS)
        .def_readonly("PDB_OUTPUT_CONECT_RECORDS_REFLECTING_BOND_ORDER", &Biomol::ControlParameterDefault::PDB_OUTPUT_CONECT_RECORDS_REFLECTING_BOND_ORDER)
        ...
        .def_readonly("MMCIF_OUTPUT_DATA_POSTPROC_FUNCTION", &Biomol::ControlParameterDefault::MMCIF_OUTPUT_DATA_POSTPROC_FUNCTION)
        ;
}
