...
void CDPLPythonBiomol::exportControlParameters()
{
	...
	python::class_<ControlParameter, boost::noncopyable>("ControlParameter", python::no_init)
		...
		.def_readonly("PDB_USE_DICT_FOR_NON_STD_RESIDUES", &Biomol::ControlParameter::PDB_USE_DICT_FOR_NON_STD_RESIDUES)
		.def_readonly("PDB_USE_DICT_FOR_STD_RESIDUES", &Biomol::ControlParameter::PDB_USE_DICT_FOR_STD_RESIDUES)
		...
		.def_readonly("PDB_CALC_FORMAL_CHARGES", &Biomol::ControlParameter::PDB_CALC_FORMAL_CHARGES)
		.def_readonly("PDB_PERCEIVE_BOND_ORDERS", &Biomol::ControlParameter::PDB_PERCEIVE_BOND_ORDERS)
