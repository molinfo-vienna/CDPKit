...
namespace
{
    ...
    MAKE_CONTROL_PARAM_FUNC_WRAPPERS(bool, PDBOutputFormalCharges)
    MAKE_CONTROL_PARAM_FUNC_WRAPPERS(bool, PDBOutputCONECTRecords)
    MAKE_CONTROL_PARAM_FUNC_WRAPPERS(bool, PDBOutputCONECTRecordsForAllBonds)
    MAKE_CONTROL_PARAM_FUNC_WRAPPERS(bool, PDBOutputCONECTRecordsReflectingBondOrder)
    ...
    MAKE_CONTROL_PARAM_FUNC_WRAPPERS(const CDPL::Biomol::MMCIFDataProcessingFunction&, MMCIFOutputDataPostprocFunction)
}
...
void CDPLPythonBiomol::exportControlParameterFunctions()
{
    ...
    EXPORT_CONTROL_PARAM_FUNCS(PDBOutputFormalCharges, output)
    EXPORT_CONTROL_PARAM_FUNCS(PDBOutputCONECTRecords, output)
    EXPORT_CONTROL_PARAM_FUNCS(PDBOutputCONECTRecordsForAllBonds, output)
    EXPORT_CONTROL_PARAM_FUNCS(PDBOutputCONECTRecordsReflectingBondOrder, output)
    ...
    EXPORT_CONTROL_PARAM_FUNCS_INT_REF(MMCIFOutputDataPostprocFunction, func)
}
