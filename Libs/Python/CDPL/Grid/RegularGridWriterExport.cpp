...
void CDPLPythonGrid::exportRegularGridWriter()
{
    ...
    CDPLPythonBase::DataWriterExport<Grid::DRegularGrid>("DRegularGridWriterBase", "grid");
    CDPLPythonUtil::MultiFormatDataWriterExport<Grid::DRegularGrid>("DRegularGridWriter");
}
