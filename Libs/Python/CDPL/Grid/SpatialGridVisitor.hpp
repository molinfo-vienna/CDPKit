...
namespace CDPLPythonGrid
{
    ...
    template <typename GridType>
    class SpatialGridVirtualFunctionsVisitor : private SpatialGridVisitorBase,
                                               public boost::python::def_visitor<SpatialGridVirtualFunctionsVisitor<GridType> >
    {
    ...
    template <typename GridType>
    class SpatialGridSpecialFunctionsVisitor : private SpatialGridVisitorBase,
                                               public boost::python::def_visitor<SpatialGridSpecialFunctionsVisitor<GridType> >
    {
