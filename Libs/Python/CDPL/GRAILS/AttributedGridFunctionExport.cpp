...
{                                                                   \
	return CDPL::GRAILS::get##FUNC_SUFFIX(grid);						\
}                                                                   \
                                                                    \
bool has##FUNC_SUFFIX##Wrapper(CDPL::Grid::AttributedGrid& grid)    \
{                                                                   \
	return CDPL::GRAILS::has##FUNC_SUFFIX(grid);						\
}
...
python::def("clear"#FUNC_SUFFIX, &GRAILS::clear##FUNC_SUFFIX, python::arg("grid"));                        \
python::def("set"#FUNC_SUFFIX, &GRAILS::set##FUNC_SUFFIX, (python::arg("grid"), python::arg(#ARG_NAME))); 
...
void CDPLPythonGRAILS::exportAttributedGridFunctions()
{
