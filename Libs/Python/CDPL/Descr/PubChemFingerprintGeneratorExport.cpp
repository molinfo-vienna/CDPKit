...
void CDPLPythonDescr::exportPubChemFingerprintGenerator()
{
    ...
    python::scope scope = python::class_<Descr::PubChemFingerprintGenerator>("PubChemFingerprintGenerator", python::no_init)
        ...
        .def(python::init<const Descr::PubChemFingerprintGenerator&>((python::arg("self"), python::arg("gen"))))
        .def(CDPLPythonBase::ObjectIdentityCheckVisitor<Descr::PubChemFingerprintGenerator>())    
