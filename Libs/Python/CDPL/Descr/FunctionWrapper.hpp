...
#ifndef CDPL_PYTHON_DESCR_FUNCTIONWRAPPER_HPP
#define CDPL_PYTHON_DESCR_FUNCTIONWRAPPER_HPP

#define MAKE_FUNCTION_WRAPPER1(RET_TYPE, FUNC_NAME, ARG_TYPE) \
RET_TYPE FUNC_NAME##Wrapper1(ARG_TYPE arg)                    \
{                                                             \
	return CDPL::Descr::FUNC_NAME(arg);                       \
}
...
{                                                                         \
	return CDPL::Descr::FUNC_NAME(arg1, arg2);                            \
}
...
{                                                                                    \
	return CDPL::Descr::FUNC_NAME(arg1, arg2, arg3);                                 \
}
...
{                                                                                               \
	return CDPL::Descr::FUNC_NAME(arg1, arg2, arg3, arg4);                                      \
}
...
{                                                                                                            \
	return CDPL::Descr::FUNC_NAME(arg1, arg2, arg3, arg4, arg5);                                             \
}
...
{                                                                                                                            \
	return CDPL::Descr::FUNC_NAME(arg1, arg2, arg3, arg4, arg5, arg6);                                                       \
}

#endif // CDPL_PYTHON_DESCR_FUNCTIONWRAPPER_HPP
