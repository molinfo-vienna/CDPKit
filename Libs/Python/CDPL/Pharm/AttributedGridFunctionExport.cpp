...
{                                                                   \
	return CDPL::Pharm::get##FUNC_SUFFIX(grid);						\
}                                                                   \
                                                                    \
bool has##FUNC_SUFFIX##Wrapper(CDPL::Grid::AttributedGrid& grid)    \
{                                                                   \
	return CDPL::Pharm::has##FUNC_SUFFIX(grid);						\
}
...
python::def("clear"#FUNC_SUFFIX, &Pharm::clear##FUNC_SUFFIX, python::arg("grid"));                        \
python::def("set"#FUNC_SUFFIX, &Pharm::set##FUNC_SUFFIX, (python::arg("grid"), python::arg(#ARG_NAME))); 
...
void CDPLPythonPharm::exportAttributedGridFunctions()
{
