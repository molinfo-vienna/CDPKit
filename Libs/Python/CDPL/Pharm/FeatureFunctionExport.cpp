...
namespace
{
	...
	MAKE_FEATURE_FUNC_WRAPPERS(double, ConeAngle)
    MAKE_FEATURE_FUNC_WRAPPERS(bool, DisabledFlag)
    MAKE_FEATURE_FUNC_WRAPPERS(bool, OptionalFlag)
	MAKE_FEATURE_FUNC_WRAPPERS(bool, InteractionFlag)
