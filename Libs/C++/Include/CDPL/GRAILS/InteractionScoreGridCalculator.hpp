...
/**
 * \file
 * \brief Definition of the class CDPL::GRAILS::InteractionScoreGridCalculator.
 */

#ifndef CDPL_GRAILS_INTERACTIONSCOREGRIDCALCULATOR_HPP
#define CDPL_GRAILS_INTERACTIONSCOREGRIDCALCULATOR_HPP
...
namespace CDPL 
{
    ...
    namespace GRAILS
    {
		 ...
		 */
		class CDPL_GRAILS_API InteractionScoreGridCalculator
		{
		  ...
		  public:
			...
			void calculate(const Pharm::FeatureContainer& features, Grid::DSpatialGrid& grid, const FeaturePredicate& tgt_ftr_pred);
	
			void calculate(const Pharm::FeatureContainer& features, Grid::DSpatialGrid& grid);
...
#endif // CDPL_GRAILS_INTERACTIONSCOREGRIDCALCULATOR_HPP
