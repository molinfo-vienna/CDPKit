...
/**
 * \file
 * \brief Definition of the class CDPL::GRAILS::BuriednessGridCalculator.
 */

#ifndef CDPL_GRAILS_BURIEDNESSGRIDCALCULATOR_HPP
#define CDPL_GRAILS_BURIEDNESSGRIDCALCULATOR_HPP
...
namespace CDPL 
{
	...
	namespace GRAILS
    {
		 ...
		 */
		class CDPL_GRAILS_API BuriednessGridCalculator
		{
...
#endif // CDPL_GRAILS_BURIEDNESSGRIDCALCULATOR_HPP
