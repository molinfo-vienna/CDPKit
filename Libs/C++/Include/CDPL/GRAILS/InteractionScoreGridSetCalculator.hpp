...
/**
 * \file
 * \brief Definition of the class CDPL::GRAILS::InteractionScoreGridSetCalculator.
 */

#ifndef CDPL_GRAILS_INTERACTIONSCOREGRIDSETCALCULATOR_HPP
#define CDPL_GRAILS_INTERACTIONSCOREGRIDSETCALCULATOR_HPP
...
namespace CDPL 
{
    ...
    namespace GRAILS
    {
		 ...
		 */
		class CDPL_GRAILS_API InteractionScoreGridSetCalculator
		{
		  ...
		  protected:
			void calculate(const Pharm::FeatureContainer& features);
...
#endif // CDPL_GRAILS_INTERACTIONSCOREGRIDSETCALCULATOR_HPP
