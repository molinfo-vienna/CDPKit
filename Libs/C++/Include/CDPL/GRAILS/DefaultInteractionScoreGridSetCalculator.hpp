...
/**
 * \file
 * \brief Definition of the class CDPL::GRAILS::DefaultInteractionScoreGridSetCalculator.
 */

#ifndef CDPL_GRAILS_DEFAULTINTERACTIONSCOREGRIDSETCALCULATOR_HPP
#define CDPL_GRAILS_DEFAULTINTERACTIONSCOREGRIDSETCALCULATOR_HPP
...
namespace CDPL 
{
    ...
    namespace GRAILS
    {
		 ...
		 */
		class CDPL_GRAILS_API DefaultInteractionScoreGridSetCalculator : public InteractionScoreGridSetCalculator
		{
		  ...
		  public:
			...
			void calculate(const Pharm::FeatureContainer& features, Grid::DRegularGridSet& grid_set);
...
#endif // CDPL_GRAILS_DEFAULTINTERACTIONSCOREGRIDSETCALCULATOR_HPP
