...
/**
 * \file
 * \brief Definition of the class CDPL::GRAILS::BuriednessScore.
 */

#ifndef CDPL_GRAILS_BURIEDNESSSCORE_HPP
#define CDPL_GRAILS_BURIEDNESSSCORE_HPP
...
namespace CDPL 
{
    ...
    namespace GRAILS
    {
		 ...
		 */
		class CDPL_GRAILS_API BuriednessScore
		{
...
#endif // CDPL_GRAILS_BURIEDNESSSCORE_HPP
