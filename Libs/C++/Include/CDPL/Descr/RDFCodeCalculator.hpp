...
#define CDPL_DESCR_RDFCODECALCULATOR_HPP
    ...
    namespace Descr
    {
        ...
        class RDFCodeCalculator
        {
          ...
          public:
             ...
             * a \c const reference to Math::Vector3D (see [\ref FUNWRP]).
             */
...
template <typename T>
double CDPL::Descr::RDFCodeCalculator<T>::getSmoothingFactor() const
{
    return smoothingFactor;
}

template <typename T>
double CDPL::Descr::RDFCodeCalculator<T>::getScalingFactor() const
{
    return scalingFactor;
}

template <typename T>
double CDPL::Descr::RDFCodeCalculator<T>::getStartRadius() const
{
    return startRadius;
}

template <typename T>
double CDPL::Descr::RDFCodeCalculator<T>::getRadiusIncrement() const
{
    return radiusIncrement;
}

template <typename T>
std::size_t CDPL::Descr::RDFCodeCalculator<T>::getNumSteps() const
{
    return numSteps;
}
...
template <typename T>
bool CDPL::Descr::RDFCodeCalculator<T>::distanceToIntervalsCenterRoundingEnabled() const
{
...
template <typename T>
template <typename Iter, typename Vec>
void CDPL::Descr::RDFCodeCalculator<T>::calculate(Iter beg, Iter end, Vec& rdf_code)
{
    init(beg, end);
...
template <typename T>
template <typename Iter>
void CDPL::Descr::RDFCodeCalculator<T>::init(Iter beg, Iter end)
{
...
#endif // CDPL_DESCR_RDFCODECALCULATOR_HPP
