...
/**
 * \file
 * \brief Definition of the class CDPL::Pharm::CDFGZPharmacophoreReader.
 */

#ifndef CDPL_PHARM_CDFGZPHARMACOPHOREREADER_HPP
#define CDPL_PHARM_CDFGZPHARMACOPHOREREADER_HPP
