...
/**
 * \file
 * \brief Definition of the class CDPL::Pharm::FeatureInteractionAnalyzer.
 */

#ifndef CDPL_PHARM_FEATUREINTERACTIONANALYZER_HPP
#define CDPL_PHARM_FEATUREINTERACTIONANALYZER_HPP
...
namespace CDPL 
{
    ...
    namespace Pharm
    {
		...
		/**
		 * \addtogroup CDPL_PHARM_INTERACTION_PERCEPTION
		 * @{
		 */
		 ...
		 */
		class CDPL_PHARM_API FeatureInteractionAnalyzer 
		{
...
#endif // CDPL_PHARM_FEATUREINTERACTIONANALYZER_HPP
