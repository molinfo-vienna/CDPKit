...
/**
 * \file
 * \brief Definition of the class CDPL::Pharm::CDFFeatureContainerWriter.
 */

#ifndef CDPL_PHARM_CDFFEATURECONTAINERWRITER_HPP
#define CDPL_PHARM_CDFFEATURECONTAINERWRITER_HPP
