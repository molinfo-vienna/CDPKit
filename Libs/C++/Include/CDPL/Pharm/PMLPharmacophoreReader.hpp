...
/**
 * \file
 * \brief Definition of class CDPL::Pharm::PMLPharmacophoreReader.
 */
...
namespace CDPL
{
    ...
    namespace Pharm
    {
        ...
        /**
         * \brief Reader for pharmacophore data in the native I/O format of <em>LigandScout</em>.
         */
        class CDPL_PHARM_API PMLPharmacophoreReader : public Util::StreamDataReader<Pharmacophore, PMLPharmacophoreReader>
        {
          ...
          public:
            ...
            PMLPharmacophoreReader(const PMLPharmacophoreReader&) = delete;
            ...
            PMLPharmacophoreReader& operator=(const PMLPharmacophoreReader&) = delete;
