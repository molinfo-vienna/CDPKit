...
namespace CDPL
{
    ...
    namespace Pharm
    {
        ...
        /**
         * \brief Reader for molecule data in the <em>%CDPL</em> <em>PSD</em>-format.
         */
        class CDPL_PHARM_API PSDMoleculeReader : public Base::DataReader<Chem::Molecule>
        {
          ...
          public:
            ...
            /**
             * \brief Reads the next molecule into \a mol.
            ...
            /**
             * \brief Reads the molecule at record index \a idx into \a mol.
            ...
            /**
             * \brief Skips the next molecule record (advances the current record index).
             * \return A reference to itself.
             */
