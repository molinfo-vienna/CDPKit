...
/**
 * \file
 * \brief Definition of class CDPL::Pharm::HBondDonorFeatureGenerator.
 */
...
namespace CDPL
{
    ...
    namespace Pharm
    {
        ...
        /**
         * \brief Pharm::FeatureGenerator implementation that perceives H-bond donor features by matching
