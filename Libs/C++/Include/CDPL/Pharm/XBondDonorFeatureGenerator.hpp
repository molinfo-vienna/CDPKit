...
/**
 * \file
 * \brief Definition of class CDPL::Pharm::XBondDonorFeatureGenerator.
 */
...
namespace CDPL
{
    ...
    namespace Pharm
    {
        ...
        /**
         * \brief Pharm::FeatureGenerator implementation that perceives halogen-bond donor features by matching
