...
/* 
 * CDFGZFeatureContainerWriter.hpp 
 *
...
/**
 * \file
 * \brief Definition of the class CDPL::Pharm::CDFGZFeatureContainerWriter.
 */

#ifndef CDPL_PHARM_CDFGZFEATURECONTAINERWRITER_HPP
#define CDPL_PHARM_CDFGZFEATURECONTAINERWRITER_HPP
