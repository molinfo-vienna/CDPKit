...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::MOL2GZMolecularGraphWriter.
 */

#ifndef CDPL_CHEM_MOL2GZMOLECULARGRAPHWRITER_HPP
#define CDPL_CHEM_MOL2GZMOLECULARGRAPHWRITER_HPP
