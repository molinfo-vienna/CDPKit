...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::SMILESGZReactionInputHandler.
 */

#ifndef CDPL_CHEM_SMILESGZREACTIONINPUTHANDLER_HPP
#define CDPL_CHEM_SMILESGZREACTIONINPUTHANDLER_HPP
