...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::NAME property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored name. */
        CDPL_CHEM_API const std::string& getName(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::NAME property of \a molgraph to \a name.
         *  \param molgraph The molecular graph to modify.
         *  \param name The new name. */
        CDPL_CHEM_API void setName(MolecularGraph& molgraph, const std::string& name);

        /** \brief Removes the Chem::MolecularGraphProperty::NAME property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearName(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::NAME property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasName(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::TIMESTAMP property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored timestamp. */
        CDPL_CHEM_API std::time_t getTimestamp(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::TIMESTAMP property of \a molgraph to \a time.
         *  \param molgraph The molecular graph to modify.
         *  \param time The new timestamp value. */
        CDPL_CHEM_API void setTimestamp(MolecularGraph& molgraph, std::time_t time);

        /** \brief Removes the Chem::MolecularGraphProperty::TIMESTAMP property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearTimestamp(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::TIMESTAMP property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasTimestamp(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::COMMENT property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored comment. */
        CDPL_CHEM_API const std::string& getComment(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::COMMENT property of \a molgraph to \a comment.
         *  \param molgraph The molecular graph to modify.
         *  \param comment The new comment string. */
        CDPL_CHEM_API void setComment(MolecularGraph& molgraph, const std::string& comment);

        /** \brief Removes the Chem::MolecularGraphProperty::COMMENT property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearComment(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::COMMENT property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasComment(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MATCH_CONSTRAINTS property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::MATCH_CONSTRAINTS property of \a molgraph to \a constr.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::MATCH_CONSTRAINTS property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMatchConstraints(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MATCH_CONSTRAINTS property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMatchConstraints(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MATCH_EXPRESSION property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::MATCH_EXPRESSION property of \a molgraph to \a expr.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::MATCH_EXPRESSION property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMatchExpression(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MATCH_EXPRESSION property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        ...
        /** \brief Builds and (optionally) stores the top-level match expression of \a molgraph.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::RINGS property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored full ring set. */
        CDPL_CHEM_API const FragmentList::SharedPointer& getRings(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::RINGS property of \a molgraph to \a rings.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::RINGS property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearRings(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::RINGS property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasRings(const MolecularGraph& molgraph);

        /** \brief Perceives the full set of rings of \a molgraph without modifying it.
         *  \param molgraph The molecular graph to inspect.
         *  \return The perceived ring set. */
        CDPL_CHEM_API FragmentList::SharedPointer perceiveRings(const MolecularGraph& molgraph);

        /** \brief Perceives and (optionally) stores the full set of rings of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::SSSR property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::SSSR property of \a molgraph to \a sssr.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::SSSR property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearSSSR(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::SSSR property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasSSSR(const MolecularGraph& molgraph);

        /** \brief Perceives the Smallest Set of Smallest Rings of \a molgraph without modifying it.
         *  \param molgraph The molecular graph to inspect.
         *  \return The perceived SSSR. */
        CDPL_CHEM_API FragmentList::SharedPointer perceiveSSSR(const MolecularGraph& molgraph);

        /** \brief Perceives and (optionally) stores the Smallest Set of Smallest Rings of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Extracts the subset of the SSSR of \a src_molgraph whose rings consist of atoms and bonds of \a tgt_molgraph.
        ...
        /** \brief Extracts the SSSR subset of \a src_molgraph that fits within \a tgt_molgraph and (optionally) stores it on the latter.
         *  \param src_molgraph The source molecular graph whose SSSR is to be projected.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::CYCLIC_SUBSTRUCTURE property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::CYCLIC_SUBSTRUCTURE property of \a molgraph to \a substruct.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::CYCLIC_SUBSTRUCTURE property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearCyclicSubstructure(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::CYCLIC_SUBSTRUCTURE property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasCyclicSubstructure(const MolecularGraph& molgraph);

        /** \brief Perceives the cyclic substructure (union of all rings) of \a molgraph without modifying it.
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Perceives and (optionally) stores the cyclic substructure of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::COMPONENTS property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::COMPONENTS property of \a molgraph to \a comps.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::COMPONENTS property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearComponents(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::COMPONENTS property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasComponents(const MolecularGraph& molgraph);

        /** \brief Perceives the connected components of \a molgraph without modifying it.
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Perceives and (optionally) stores the connected components of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::COMPONENT_GROUPS property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::COMPONENT_GROUPS property of \a molgraph to \a comp_groups.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::COMPONENT_GROUPS property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearComponentGroups(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::COMPONENT_GROUPS property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasComponentGroups(const MolecularGraph& molgraph);

        /** \brief Perceives the component groups of \a molgraph (from atom-level Chem::AtomProperty::COMPONENT_GROUP_ID values).
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Perceives and (optionally) stores the component groups of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::CONFORMATION_INDEX property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::CONFORMATION_INDEX property of \a molgraph to \a index.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::CONFORMATION_INDEX property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearConformationIndex(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::CONFORMATION_INDEX property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasConformationIndex(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::CONFORMER_ENERGIES property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::CONFORMER_ENERGIES property of \a molgraph to \a energies.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::CONFORMER_ENERGIES property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearConformerEnergies(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::CONFORMER_ENERGIES property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::HASH_CODE property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored 64-bit hash code. */
        CDPL_CHEM_API std::uint64_t getHashCode(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::HASH_CODE property of \a molgraph to \a hash_code.
         *  \param molgraph The molecular graph to modify.
         *  \param hash_code The new 64-bit hash code. */
        CDPL_CHEM_API void setHashCode(MolecularGraph& molgraph, std::uint64_t hash_code);

        /** \brief Removes the Chem::MolecularGraphProperty::HASH_CODE property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearHashCode(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::HASH_CODE property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        ...
        /** \brief Collects every atom and bond of \a molgraph that carries a reaction-center flag into the fragment \a rxn_center.
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::STOICHIOMETRIC_NUMBER property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored stoichiometric number. */
        CDPL_CHEM_API double getStoichiometricNumber(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::STOICHIOMETRIC_NUMBER property of \a molgraph to \a num.
         *  \param molgraph The molecular graph to modify.
         *  \param num The new stoichiometric number. */
        CDPL_CHEM_API void setStoichiometricNumber(MolecularGraph& molgraph, double num);

        /** \brief Removes the Chem::MolecularGraphProperty::STOICHIOMETRIC_NUMBER property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearStoichiometricNumber(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::STOICHIOMETRIC_NUMBER property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasStoichiometricNumber(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_USER_INITIALS property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored MDL user initials. */
        CDPL_CHEM_API const std::string& getMDLUserInitials(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_USER_INITIALS property of \a molgraph to \a initials.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::MDL_USER_INITIALS property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLUserInitials(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_USER_INITIALS property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLUserInitials(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_PROGRAM_NAME property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored MDL program name. */
        CDPL_CHEM_API const std::string& getMDLProgramName(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_PROGRAM_NAME property of \a molgraph to \a name.
         *  \param molgraph The molecular graph to modify.
         *  \param name The new MDL program name. */
        CDPL_CHEM_API void setMDLProgramName(MolecularGraph& molgraph, const std::string& name);

        /** \brief Removes the Chem::MolecularGraphProperty::MDL_PROGRAM_NAME property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLProgramName(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_PROGRAM_NAME property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLProgramName(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_REGISTRY_NUMBER property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored MDL registry number. */
        CDPL_CHEM_API std::size_t getMDLRegistryNumber(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_REGISTRY_NUMBER property of \a molgraph to \a reg_no.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::MDL_REGISTRY_NUMBER property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLRegistryNumber(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_REGISTRY_NUMBER property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLRegistryNumber(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_CTAB_VERSION property of \a molgraph (see namespace Chem::MDLDataFormatVersion).
         *  \param molgraph The molecular graph to query.
         *  \return The stored CTab version. */
        CDPL_CHEM_API unsigned int getMDLCTABVersion(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_CTAB_VERSION property of \a molgraph to \a version (see namespace Chem::MDLDataFormatVersion).
         *  \param molgraph The molecular graph to modify.
         *  \param version The new CTab version. */
        CDPL_CHEM_API void setMDLCTABVersion(MolecularGraph& molgraph, unsigned int version);

        /** \brief Removes the Chem::MolecularGraphProperty::MDL_CTAB_VERSION property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLCTABVersion(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_CTAB_VERSION property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLCTABVersion(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::STRUCTURE_DATA property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::STRUCTURE_DATA property of \a molgraph to \a data.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::STRUCTURE_DATA property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearStructureData(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::STRUCTURE_DATA property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasStructureData(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_DIMENSIONALITY property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::MDL_DIMENSIONALITY property of \a molgraph to \a dim.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::MDL_DIMENSIONALITY property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLDimensionality(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_DIMENSIONALITY property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLDimensionality(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR1 property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored MDL scaling factor 1. */
        CDPL_CHEM_API long getMDLScalingFactor1(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR1 property of \a molgraph to \a factor.
         *  \param molgraph The molecular graph to modify.
         *  \param factor The new MDL scaling factor 1. */
        CDPL_CHEM_API void setMDLScalingFactor1(MolecularGraph& molgraph, long factor);

        /** \brief Removes the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR1 property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLScalingFactor1(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR1 property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLScalingFactor1(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR2 property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored MDL scaling factor 2. */
        CDPL_CHEM_API double getMDLScalingFactor2(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR2 property of \a molgraph to \a factor.
         *  \param molgraph The molecular graph to modify.
         *  \param factor The new MDL scaling factor 2. */
        CDPL_CHEM_API void setMDLScalingFactor2(MolecularGraph& molgraph, double factor);

        /** \brief Removes the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR2 property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLScalingFactor2(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_SCALING_FACTOR2 property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLScalingFactor2(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_ENERGY property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored MDL energy. */
        CDPL_CHEM_API double getMDLEnergy(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_ENERGY property of \a molgraph to \a energy.
         *  \param molgraph The molecular graph to modify.
         *  \param energy The new MDL energy. */
        CDPL_CHEM_API void setMDLEnergy(MolecularGraph& molgraph, double energy);

        /** \brief Removes the Chem::MolecularGraphProperty::MDL_ENERGY property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLEnergy(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_ENERGY property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLEnergy(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MDL_CHIRAL_FLAG property of \a molgraph.
         *  \param molgraph The molecular graph to query.
         *  \return The stored MDL chiral flag. */
        CDPL_CHEM_API bool getMDLChiralFlag(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MDL_CHIRAL_FLAG property of \a molgraph to \a flag.
         *  \param molgraph The molecular graph to modify.
         *  \param flag The new MDL chiral flag. */
        CDPL_CHEM_API void setMDLChiralFlag(MolecularGraph& molgraph, bool flag);

        /** \brief Removes the Chem::MolecularGraphProperty::MDL_CHIRAL_FLAG property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMDLChiralFlag(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MDL_CHIRAL_FLAG property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMDLChiralFlag(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MOL2_MOLECULE_TYPE property of \a molgraph (see namespace Chem::MOL2MoleculeType).
         *  \param molgraph The molecular graph to query.
         *  \return The stored MOL2 molecule type. */
        CDPL_CHEM_API unsigned int getMOL2MoleculeType(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MOL2_MOLECULE_TYPE property of \a molgraph to \a type (see namespace Chem::MOL2MoleculeType).
         *  \param molgraph The molecular graph to modify.
         *  \param type The new MOL2 molecule type. */
        CDPL_CHEM_API void setMOL2MoleculeType(MolecularGraph& molgraph, unsigned int type);

        /** \brief Removes the Chem::MolecularGraphProperty::MOL2_MOLECULE_TYPE property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMOL2MoleculeType(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MOL2_MOLECULE_TYPE property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMOL2MoleculeType(const MolecularGraph& molgraph);


        /** \brief Returns the Chem::MolecularGraphProperty::MOL2_CHARGE_TYPE property of \a molgraph (see namespace Chem::MOL2ChargeType).
         *  \param molgraph The molecular graph to query.
         *  \return The stored MOL2 charge type. */
        CDPL_CHEM_API unsigned int getMOL2ChargeType(const MolecularGraph& molgraph);

        /** \brief Sets the Chem::MolecularGraphProperty::MOL2_CHARGE_TYPE property of \a molgraph to \a type (see namespace Chem::MOL2ChargeType).
         *  \param molgraph The molecular graph to modify.
         *  \param type The new MOL2 charge type. */
        CDPL_CHEM_API void setMOL2ChargeType(MolecularGraph& molgraph, unsigned int type);

        /** \brief Removes the Chem::MolecularGraphProperty::MOL2_CHARGE_TYPE property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearMOL2ChargeType(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::MOL2_CHARGE_TYPE property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasMOL2ChargeType(const MolecularGraph& molgraph);


        /** \brief Builds the adjacency matrix of \a molgraph (entry \c (i,j) is the bond count between atoms \c i and \c j).
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Builds the atom/bond incidence matrix of \a molgraph (entry \c (i,j) is \c 1 if atom \c i is an endpoint of bond \c j).
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Builds the bond-order matrix of \a molgraph (entry \c (i,j) is the order of the bond between atoms \c i and \c j).
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Builds the bond-electron-count matrix of \a molgraph (entry \c (i,j) is the number of bonding electrons between atoms \c i and \c j).
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::TOPOLOGICAL_DISTANCE_MATRIX property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::TOPOLOGICAL_DISTANCE_MATRIX property of \a molgraph to \a mtx.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::TOPOLOGICAL_DISTANCE_MATRIX property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearTopologicalDistanceMatrix(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::TOPOLOGICAL_DISTANCE_MATRIX property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasTopologicalDistanceMatrix(const MolecularGraph& molgraph);

        /** \brief Computes and (optionally) stores the topological-distance matrix of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Computes the topological-distance matrix of \a molgraph into the supplied \a mtx.
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Extracts the topological-distance sub-matrix of \a src_molgraph that covers the atoms of \a tgt_molgraph and (optionally) stores it on the latter.
        ...
        /** \brief Extracts the topological-distance sub-matrix of \a src_molgraph that covers the atoms of \a tgt_molgraph into the supplied \a mtx.
         *  \param src_molgraph The source molecular graph providing the full matrix.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::GEOMETRICAL_DISTANCE_MATRIX property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::GEOMETRICAL_DISTANCE_MATRIX property of \a molgraph to \a mtx.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::GEOMETRICAL_DISTANCE_MATRIX property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearGeometricalDistanceMatrix(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::GEOMETRICAL_DISTANCE_MATRIX property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasGeometricalDistanceMatrix(const MolecularGraph& molgraph);

        /** \brief Computes and (optionally) stores the geometrical-distance matrix of \a molgraph from its 3D coordinates.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::AROMATIC_SUBSTRUCTURE property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::AROMATIC_SUBSTRUCTURE property of \a molgraph to \a substruct.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::AROMATIC_SUBSTRUCTURE property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearAromaticSubstructure(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::AROMATIC_SUBSTRUCTURE property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasAromaticSubstructure(const MolecularGraph& molgraph);

        /** \brief Perceives the aromatic substructure of \a molgraph without modifying it.
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Perceives and (optionally) stores the aromatic substructure of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Returns the Chem::MolecularGraphProperty::PI_ELECTRON_SYSTEMS property of \a molgraph.
         *  \param molgraph The molecular graph to query.
        ...
        /** \brief Sets the Chem::MolecularGraphProperty::PI_ELECTRON_SYSTEMS property of \a molgraph to \a pi_systems.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Removes the Chem::MolecularGraphProperty::PI_ELECTRON_SYSTEMS property from \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void clearPiElectronSystems(MolecularGraph& molgraph);

        /** \brief Tells whether \a molgraph carries the Chem::MolecularGraphProperty::PI_ELECTRON_SYSTEMS property.
         *  \param molgraph The molecular graph to query.
         *  \return \c true if the property is set, and \c false otherwise. */
        CDPL_CHEM_API bool hasPiElectronSystems(const MolecularGraph& molgraph);

        /** \brief Perceives the pi-electron systems of \a molgraph without modifying it.
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Perceives and (optionally) stores the pi-electron systems of \a molgraph.
         *  \param molgraph The molecular graph to inspect/modify.
        ...
        /** \brief Reorders the atoms (and optionally their neighbors and bonds) of \a molgraph according to a user-supplied comparator.
        ...
        /** \brief Reorders the atoms (and optionally their neighbors and bonds) of \a molgraph according to the canonical-numbering attached to its atoms.
         *  \param molgraph The molecular graph to canonicalize.
         *  \param atoms \c true to sort atoms.
         *  \param atom_nbrs \c true to sort each atom's neighbor list.
         *  \param bonds \c true to sort bonds.
         ...
         * \param fix_bond_stereo If \c true, post-process bond stereo flags so that they remain consistent with the aligned coordinates.
        ...
        /** \brief Computes 3D coordinates for the hydrogen atoms of \a molgraph from the geometry of their non-hydrogen neighbors.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Derives 2D wedge/hash bond stereo flags for the bonds of \a molgraph from the atoms' stereo descriptors and 2D layout.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores CIP priorities for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores topological-symmetry classes for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores canonical atom numbers for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores Morgan numbers for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores implicit-hydrogen counts for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores formal charges for the atoms of \a molgraph from their valence environment.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores hybridization states for the atoms of \a molgraph from their valence environment.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Perceives bond orders for the bonds of \a molgraph from atom geometry and ligand environment.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Assigns Kekulé bond orders to the aromatic bonds of \a molgraph.
         *  \param molgraph The molecular graph to modify. */
        CDPL_CHEM_API void kekulizeBonds(MolecularGraph& molgraph);

        /** \brief Flags the atoms of \a molgraph that qualify as stereo centers under the supplied criteria.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Flags the bonds of \a molgraph that qualify as stereo centers under the supplied criteria.
         *  \param molgraph The molecular graph to modify.
         *  \param overwrite If \c true, replaces any existing stereo-center flags.
         *  \param check_asym \c true to enforce non-equivalent ligand environments.
        ...
        /** \brief Computes and stores MDL parities for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores stereo descriptors for the atoms of \a molgraph from their geometric layout.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Derives atom stereo descriptors of \a molgraph from previously-assigned MDL parities.
         *  \param molgraph The molecular graph to modify.
         *  \param overwrite If \c true, replaces any existing stereo descriptors. */
        CDPL_CHEM_API void calcAtomStereoDescriptorsFromMDLParities(MolecularGraph& molgraph, bool overwrite);

        /** \brief Computes and stores stereo descriptors for the bonds of \a molgraph from their geometric layout.
         *  \param molgraph The molecular graph to modify.
         *  \param overwrite If \c true, replaces any existing stereo descriptors.
         *  \param dim The dimensionality of the atomic coordinates to use (\e 2 or \e 3).
        ...
        /** \brief Computes and stores CIP configuration labels for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Computes and stores CIP configuration labels for the bonds of \a molgraph.
         *  \param molgraph The molecular graph to modify.
         *  \param overwrite If \c true, replaces any existing CIP configuration labels. */
        CDPL_CHEM_API void calcBondCIPConfigurations(MolecularGraph& molgraph, bool overwrite);

        /** \brief Sets the atom-level match-constraint list \a constr on every atom of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Sets the bond-level match-constraint list \a constr on every bond of \a molgraph.
         *  \param molgraph The molecular graph to modify.
         *  \param constr The match-constraint list to assign.
        ...
        /** \brief Generates and stores textual representations of the match expressions of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Perceives aromaticity and sets the corresponding atom/bond aromaticity flags on \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Perceives ring membership and sets the corresponding atom/bond ring flags on \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Sets the atom types of \a molgraph from their element symbols.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Sets the atom symbols of \a molgraph from their atom types.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Perceives Sybyl atom types for the atoms of \a molgraph.
         *  \param molgraph The molecular graph to modify.
        ...
        /** \brief Returns the subset of the aromatic rings of \a molgraph (a fresh list, not stored on \a molgraph).
         *  \param molgraph The molecular graph to inspect.
         *  \return The aromatic rings. */
        CDPL_CHEM_API FragmentList::SharedPointer getAromaticRings(const MolecularGraph& molgraph);

        /** \brief Returns the subset of the SSSR of \a molgraph that contains only aromatic rings (a fresh list, not stored on \a molgraph).
         *  \param molgraph The molecular graph to inspect.
        ...
        /** \brief Tells whether \a molgraph contains the atoms and/or bonds of \a sub_molgraph.
         *  \param molgraph The host molecular graph.
         *  \param sub_molgraph The candidate sub-graph.
         *  \param atoms If \c true, every atom of \a sub_molgraph must be a member of \a molgraph.
         *  \param bonds If \c true, every bond of \a sub_molgraph must be a member of \a molgraph.
        ...
        /** \brief Collects the fragments in \a frag_list that are fully contained in \a molgraph into \a cont_frag_list.
         *  \param molgraph The host molecular graph.
        ...
        /** \brief Collects the fragments in \a frag_list that contain \a molgraph into \a cont_frag_list.
        ...
        /** \brief Translates the atoms/bonds of \a src_frag (a fragment of \a src_molgraph) to the corresponding atoms/bonds of \a tgt_molgraph and stores them in \a tgt_frag.
        ...
        /** \brief Translates every fragment in \a src_frag_list (defined on \a src_molgraph) to the corresponding fragments on \a tgt_molgraph.
         *  \param src_molgraph The source molecular graph providing the original atoms/bonds.
        ...
        /** \brief Splits \a molgraph into connected fragments by removing the bonds flagged in \a split_bond_mask.
        ...
        /** \brief Returns the number of bonds of \a molgraph that lie between two atoms of \a molgraph (i.e. no dangling cross-graph bonds).
         *  \param molgraph The molecular graph to inspect.
         *  \return The count of fully-contained bonds. */
        CDPL_CHEM_API std::size_t getCompleteBondCount(const MolecularGraph& molgraph);

        /**
         * \brief Computes the basic per-atom/per-bond properties (aromaticity, ring info, etc.) of \a molgraph.
         * \param molgraph The molecular graph to modify.
         * \param overwrite If \c true, recomputes derived data; if \c false, leaves up-to-date data unchanged.
         * \since 1.1
         */
        ...
        /**
         * \brief Builds \a result_mol from \a molgraph by replacing all substructures matching the SMARTS patterns in \a search_ptns with \a result_ptn.
