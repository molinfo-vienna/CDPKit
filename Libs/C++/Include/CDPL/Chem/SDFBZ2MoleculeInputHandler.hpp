...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::SDFBZ2MoleculeInputHandler.
 */

#ifndef CDPL_CHEM_SDFBZ2MOLECULEINPUTHANDLER_HPP
#define CDPL_CHEM_SDFBZ2MOLECULEINPUTHANDLER_HPP
