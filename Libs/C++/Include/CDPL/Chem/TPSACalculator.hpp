...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::TPSACalculator.
 */

#ifndef CDPL_CHEM_TPSACALCULATOR_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		 ...
		 * \see [\ref TPSA]
		 */
		class CDPL_CHEM_API TPSACalculator
		{
		...
		public:
			 ...
			 */
			TPSACalculator(const MolecularGraph& molgraph);
...
#endif // CDPL_CHEM_TPSACALCULATOR_HPP
