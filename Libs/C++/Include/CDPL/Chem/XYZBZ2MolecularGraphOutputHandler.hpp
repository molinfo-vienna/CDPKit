...
/**
 * \file
 * \brief Declaration of type CDPL::Chem::XYZBZ2MolecularGraphOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Handler for the output of bzip2-compressed molecular graph data in the <em>XYZ</em> format.
         * \since 1.1
         */
