...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        namespace ReactionPropertyDefault
        {
            ...
            /**
             * \brief Default value of the Chem::ReactionProperty::MATCH_CONSTRAINTS property
             *        (empty Chem::MatchConstraintList).
             */
            extern CDPL_CHEM_API const MatchConstraintList::SharedPointer MATCH_CONSTRAINTS;
            
            /**
             * \brief Default value of the Chem::ReactionProperty::MDL_RXN_FILE_VERSION property
             *        (Chem::MDLDataFormatVersion::UNDEF).
             */
            extern CDPL_CHEM_API const unsigned int                       MDL_RXN_FILE_VERSION;
            
            /**
             * \brief Default value of the Chem::ReactionProperty::MDL_PROGRAM_NAME property (\c "CDPL").
             */
