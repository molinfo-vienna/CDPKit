...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::FeatureGeometryMatchFunctor.
 */

#ifndef CDPL_CHEM_FEATUREGEOMETRYMATCHFUNCTOR_HPP
#define CDPL_CHEM_FEATUREGEOMETRYMATCHFUNCTOR_HPP
...
namespace CDPL 
{
    ...
    namespace Chem
    {
		 ...
		 */
		class CDPL_CHEM_API FeatureGeometryMatchFunctor
		{
...
#endif // CDPL_CHEM_FEATUREGEOMETRYMATCHFUNCTOR_HPP
