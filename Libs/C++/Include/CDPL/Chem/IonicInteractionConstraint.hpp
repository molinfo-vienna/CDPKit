...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::IonicInteractionConstraint.
 */

#ifndef CDPL_CHEM_IONICINTERACTIONCONSTRAINT_HPP
#define CDPL_CHEM_IONICINTERACTIONCONSTRAINT_HPP
...
namespace CDPL 
{
    ...
    namespace Chem
    {
		 ...
		 */
		class CDPL_CHEM_API IonicInteractionConstraint : public FeatureDistanceConstraint
		{

		  public:
			static const double DEF_MIN_DISTANCE = 1.5;
...
#endif // CDPL_CHEM_IONICINTERACTIONCONSTRAINT_HPP
