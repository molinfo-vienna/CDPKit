...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::MoleculeRDFDescriptorCalculator.
 */

#ifndef CDPL_CHEM_MOLECULERDFDESCRIPTORCALCULATOR_HPP
#define CDPL_CHEM_MOLECULERDFDESCRIPTORCALCULATOR_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		 ...
		 */
		class CDPL_CHEM_API MoleculeRDFDescriptorCalculator
		{

			typedef Chem::RDFCodeCalculator<Atom> RDFCodeCalculator;
		...
		public:
			...
			MoleculeRDFDescriptorCalculator(const AtomContainer& cntnr, Math::DVector& descr);
...
#endif // CDPL_CHEM_MOLECULERDFDESCRIPTORCALCULATOR_HPP
