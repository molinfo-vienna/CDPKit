...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::PathFingerprintGenerator.
 */

#ifndef CDPL_CHEM_PATHFINGERPRINTGENERATOR_HPP
#define CDPL_CHEM_PATHFINGERPRINTGENERATOR_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		 ...
		 * \see [\ref DTPFP]
		 */
		class CDPL_CHEM_API PathFingerprintGenerator
		{
		...
		public:
			 ...
			 */
			PathFingerprintGenerator(const MolecularGraph& molgraph, Util::BitSet& fp);
...
#endif // CDPL_CHEM_PATHFINGERPRINTGENERATOR_HPP
