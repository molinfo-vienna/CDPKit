...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::JMEMolecularGraphWriter.
 */
...
namespace CDPL
{
    ...
    namespace Chem
    {
         ...
         *   <td>Only written if the constraints are user-defined and can be expressed by
         ...
         *   <td>Only written if the atom is a query atom, a corresponding matching constraint has been specified
         *       and the type is supported by the \e JME format.
         *  </tr>
         *  <tr>
         ...
         * atom matching constraints for the definition of substructure search queries. If an atom of the output structure
         * specifies any constraints by a Chem::MatchConstraintList data structure that has been assigned to the property
         ...
         * </table>
         *
         * \c %JMEMolecularGraphWriter can be configured with the following control-parameters:
         *
         * <table width="95%" bgcolor="#FAFAFA" border="1" align="center" rules="all" cellpadding="3">
         *  <tr bgcolor="#DDDDDD" align="center" valign="middle">
         ...
         *   <td align="center">\c true</td>
         *   <td>Specifies whether the components of a moleculargraph shall be written separately or combined as a single
         *       \e JME component</td>
         *  </tr>
         * </table>
         */
