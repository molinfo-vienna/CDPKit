...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::MolecularGraphComplexityCalculator.
 */

#ifndef CDPL_CHEM_MOLECULARCOMPLEXITYCALCULATOR_HPP
#define CDPL_CHEM_MOLECULARCOMPLEXITYCALCULATOR_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		...
		/**
		 * \addtogroup CDPL_CHEM_MOLECULAR_COMPLEXITY
		 * @{
		 */
		 ...
		 * \see [\ref MCPLX]
		 */
		class CDPL_CHEM_API MolecularComplexityCalculator
		{
		...
		/**
			 ...
			 */
			MolecularComplexityCalculator(const MolecularGraph& molgraph);
		...
		private:
			...
			void processAtom(const Atom&);
			void processBond(const Bond&);
			...
			public:
				SymmetryTerm(const MolecularGraph&, const Atom&);
...
#endif // CDPL_CHEM_MOLECULARCOMPLEXITYCALCULATOR_HPP
