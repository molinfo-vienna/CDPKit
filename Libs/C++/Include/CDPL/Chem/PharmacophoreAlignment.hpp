...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::PharmacophoreAlignment.
 */

#ifndef CDPL_CHEM_PHARMACOPHOREALIGNMENT_HPP
#define CDPL_CHEM_PHARMACOPHOREALIGNMENT_HPP
...
namespace CDPL 
{
    ...
    namespace Chem
    {
		 ...
		 */
		class CDPL_CHEM_API PharmacophoreAlignment : public GeometricalEntityAlignment<Feature>
		{
...
#endif // CDPL_CHEM_PHARMACOPHOREALIGNMENT_HPP
