...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::BuriednessScore.
 */

#ifndef CDPL_CHEM_BURIEDNESSSCORE_HPP
#define CDPL_CHEM_BURIEDNESSSCORE_HPP
    ...
    namespace Chem
    {
		...
		class CDPL_CHEM_API BuriednessScore
		{
		  ...
		  public:
			...
			double operator()(const Math::Vector3D& pos, const AtomContainer& atoms);
...
#endif // CDPL_CHEM_BURIEDNESSSCORE_HPP
