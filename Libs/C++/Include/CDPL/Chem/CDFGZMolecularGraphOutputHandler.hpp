...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::CDFGZMolecularGraphOutputHandler.
 */

#ifndef CDPL_CHEM_CDFGZMOLECULARGRAPHOUTPUTHANDLER_HPP
#define CDPL_CHEM_CDFGZMOLECULARGRAPHOUTPUTHANDLER_HPP
