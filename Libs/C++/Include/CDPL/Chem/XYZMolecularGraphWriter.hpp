...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::XYZMolecularGraphWriter.
 */

#ifndef CDPL_CHEM_XYZMOLECULARGRAPHWRITER_HPP
#define CDPL_CHEM_XYZMOLECULARGRAPHWRITER_HPP
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        class CDPL_CHEM_API XYZMolecularGraphWriter : public Base::DataWriter<MolecularGraph>
        {
          ...
          public:
            /**
             * \brief Constructs a \c %XYZMolecularGraphWriter instance that will write data of molecular graphs to the output
             *        stream \a os.
          ...
          private:
            ...
            std::ostream&    output;
            bool             state;
            XYZDataWriterPtr writer;
        };
    } // namespace Chem
} // namespace CDPL

#endif // CDPL_CHEM_XYZMOLECULARGRAPHWRITER_HPP
