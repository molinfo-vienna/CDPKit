...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::NAME property of \a rxn.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::NAME property of \a rxn to \a name.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::NAME property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearName(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::NAME property.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::TIMESTAMP property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::TIMESTAMP property of \a rxn to \a time.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::TIMESTAMP property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearTimestamp(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::TIMESTAMP property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::COMMENT property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::COMMENT property of \a rxn to \a comment.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::COMMENT property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearComment(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::COMMENT property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MATCH_EXPRESSION property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MATCH_EXPRESSION property of \a rxn to \a expr.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MATCH_EXPRESSION property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMatchExpression(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MATCH_EXPRESSION property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Builds and (optionally) stores the reaction-level match expression of \a rxn.
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MATCH_CONSTRAINTS property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MATCH_CONSTRAINTS property of \a rxn to \a constr.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MATCH_CONSTRAINTS property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMatchConstraints(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MATCH_CONSTRAINTS property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::COMPONENT_GROUPS property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::COMPONENT_GROUPS property of \a rxn to \a comp_groups.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::COMPONENT_GROUPS property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearComponentGroups(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::COMPONENT_GROUPS property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Perceives the component groups of \a rxn without modifying it.
         * \param rxn The reaction to inspect.
        ...
        /**
         * \brief Perceives and (optionally) stores the component groups of \a rxn.
         * \param rxn The reaction to inspect/modify.
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::ATOM_MAPPING property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::ATOM_MAPPING property of \a rxn to \a mapping.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::ATOM_MAPPING property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearAtomMapping(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::ATOM_MAPPING property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Derives the reactant-to-product atom mapping from the atom mapping IDs of \a rxn
        ...
        /**
         * \brief Derives and (optionally) stores the reactant-to-product atom mapping of \a rxn.
         * \param rxn The reaction to inspect/modify.
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MDL_USER_INITIALS property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MDL_USER_INITIALS property of \a rxn to \a initials.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MDL_USER_INITIALS property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMDLUserInitials(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MDL_USER_INITIALS property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MDL_PROGRAM_NAME property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MDL_PROGRAM_NAME property of \a rxn to \a name.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MDL_PROGRAM_NAME property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMDLProgramName(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MDL_PROGRAM_NAME property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MDL_REGISTRY_NUMBER property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MDL_REGISTRY_NUMBER property of \a rxn to \a reg_no.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MDL_REGISTRY_NUMBER property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMDLRegistryNumber(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MDL_REGISTRY_NUMBER property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::REACTION_DATA property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::REACTION_DATA property of \a rxn to \a data.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::REACTION_DATA property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearReactionData(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::REACTION_DATA property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MDL_MOLECULE_RECORD property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MDL_MOLECULE_RECORD property of \a rxn to \a mol_rec.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MDL_MOLECULE_RECORD property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMDLMoleculeRecord(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MDL_MOLECULE_RECORD property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MDL_INTERNAL_REGISTRY_NUMBER property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MDL_INTERNAL_REGISTRY_NUMBER property of \a rxn to \a reg_no.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MDL_INTERNAL_REGISTRY_NUMBER property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMDLInternalRegistryNumber(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MDL_INTERNAL_REGISTRY_NUMBER property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MDL_EXTERNAL_REGISTRY_NUMBER property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MDL_EXTERNAL_REGISTRY_NUMBER property of \a rxn to \a reg_no.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MDL_EXTERNAL_REGISTRY_NUMBER property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMDLExternalRegistryNumber(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MDL_EXTERNAL_REGISTRY_NUMBER property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the value of the Chem::ReactionProperty::MDL_RXN_FILE_VERSION property of \a rxn.
         * \param rxn The reaction to query.
        ...
        /**
         * \brief Sets the Chem::ReactionProperty::MDL_RXN_FILE_VERSION property of \a rxn to \a version.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Removes the Chem::ReactionProperty::MDL_RXN_FILE_VERSION property from \a rxn.
         * \param rxn The reaction to modify.
         */
        CDPL_CHEM_API void clearMDLRXNFileVersion(Reaction& rxn);

        /**
         * \brief Tells whether \a rxn carries the Chem::ReactionProperty::MDL_RXN_FILE_VERSION property.
         * \param rxn The reaction to query.
         * \return \c true if the property is set, and \c false otherwise.
         */
        ...
        /**
         * \brief Returns the largest component-group ID found on any of the components of \a rxn.
        ...
        /**
         * \brief Sets the atom-level match-constraint list \a constr on every atom of every component of \a rxn.
         * \param rxn The reaction to modify.
        ...
        /**
         * \brief Sets the bond-level match-constraint list \a constr on every bond of every component of \a rxn.
         * \param rxn The reaction to modify.
         * \param constr The match-constraint list to assign.
