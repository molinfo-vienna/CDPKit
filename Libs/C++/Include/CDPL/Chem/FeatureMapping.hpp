...
/**
 * \file
 * \brief Definition of the type CDPL::Chem::FeatureMapping.
 */

#ifndef CDPL_CHEM_FEATUREMAPPING_HPP
#define CDPL_CHEM_FEATUREMAPPING_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		 ...
		 *
		 * Features mappings are stored as pairs of pointers to the mapped \c const Chem::Feature objects.
...
#endif // CDPL_CHEM_FEATUREMAPPING_HPP
