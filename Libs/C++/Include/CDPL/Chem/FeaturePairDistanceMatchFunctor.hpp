...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::FeaturePairDistanceMatchFunctor.
 */

#ifndef CDPL_CHEM_FEATUREPAIRDISTANCEMATCHFUNCTOR_HPP
#define CDPL_CHEM_FEATUREPAIRDISTANCEMATCHFUNCTOR_HPP
...
namespace CDPL 
{
    ...
    namespace Chem
    {
		 ...
		 */
		class CDPL_CHEM_API FeaturePairDistanceMatchFunctor
		{
...
#endif // CDPL_CHEM_FEATUREPAIRDISTANCEMATCHFUNCTOR_HPP
