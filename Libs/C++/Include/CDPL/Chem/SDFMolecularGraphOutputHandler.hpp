...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::SDFMolecularGraphOutputHandler.
 */

#ifndef CDPL_CHEM_SDFMOLECULARGRAPHOUTPUTHANDLER_HPP
#define CDPL_CHEM_SDFMOLECULARGRAPHOUTPUTHANDLER_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		 ...
		 */
		class CDPL_CHEM_API SDFMolecularGraphOutputHandler : public Base::DataOutputHandler<MolecularGraph>
		{
