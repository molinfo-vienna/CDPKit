...
#define CDPL_CHEM_RXNREACTIONWRITER_HPP
...
namespace CDPL
{
    ...
    namespace Chem
    {
         ...
         * </table>
         */
        class CDPL_CHEM_API RXNReactionWriter : public Base::DataWriter<Reaction>
        {

          public:
            /**
             * \brief Constructs a \c %RXNReactionWriter instance that will write the reaction data to the output
             *        stream \a os.
...
#endif // CDPL_CHEM_RXNREACTIONWRITER_HPP
