...
/**
 * \file
 * \brief Definition of class CDPL::Chem::CMLMolecularGraphWriter.
 */
    ...
    namespace Chem
    {
        ...
        class CDPL_CHEM_API CMLMolecularGraphWriter : public Base::DataWriter<MolecularGraph>
        {
          ...
          public:
            ...
            /**
             * \brief Finishes the CML output (writes any pending closing tags) and flushes the output stream.
             */
            void close();
