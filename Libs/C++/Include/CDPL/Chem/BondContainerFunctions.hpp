...
#ifndef CDPL_CHEM_BONDCONTAINERFUNCTIONS_HPP
#define CDPL_CHEM_BONDCONTAINERFUNCTIONS_HPP
...
namespace CDPL 
{
	...
	namespace Chem 
	{
		...
		CDPL_CHEM_API std::size_t getExplicitHydrogenBondCount(const BondContainer& cntnr);

		CDPL_CHEM_API std::size_t getExplicitChainBondCount(const BondContainer& cntnr);

		CDPL_CHEM_API std::size_t getRingBondCount(const BondContainer& cntnr);
...
#endif // CDPL_CHEM_BONDCONTAINERFUNCTIONS_HPP
