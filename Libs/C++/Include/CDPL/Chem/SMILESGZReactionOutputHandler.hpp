...
#define CDPL_CHEM_SMILESGZREACTIONOUTPUTHANDLER_HPP
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Handler for the output of gzip-compressed reaction data in the <em>Daylight SMILES</em> [\ref SMILES] format.
         */
