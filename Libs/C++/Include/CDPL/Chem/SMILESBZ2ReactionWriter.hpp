...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::SMILESBZ2ReactionWriter.
 */

#ifndef CDPL_CHEM_SMILESBZ2REACTIONWRITER_HPP
#define CDPL_CHEM_SMILESBZ2REACTIONWRITER_HPP
