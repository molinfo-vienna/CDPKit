...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::FeatureInteractionConstraintConnector.
 */

#ifndef CDPL_CHEM_FEATUREINTERACTIONCONSTRAINTCONNECTOR_HPP
#define CDPL_CHEM_FEATUREINTERACTIONCONSTRAINTCONNECTOR_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		 ...
		 */
		class CDPL_CHEM_API FeatureInteractionConstraintConnector : public std::binary_function<Feature, Feature, bool>
		{
...
#endif // CDPL_CHEM_FEATUREINTERACTIONCONSTRAINTCONNECTOR_HPP
