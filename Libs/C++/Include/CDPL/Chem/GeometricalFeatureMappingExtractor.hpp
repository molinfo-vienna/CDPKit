...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::GeometricalFeatureMappingExtractor.
 */

#ifndef CDPL_CHEM_GEOMETRICALFEATUREMAPPINGEXTRACTOR_HPP
#define CDPL_CHEM_GEOMETRICALFEATUREMAPPINGEXTRACTOR_HPP
...
namespace CDPL 
{
    ...
    namespace Chem
    {
		 ...
		 */
		class CDPL_CHEM_API GeometricalFeatureMappingExtractor
		{
...
#endif // CDPL_CHEM_GEOMETRICALFEATUREMAPPINGEXTRACTOR_HPP
