...
namespace CDPL
{
    ...
    namespace Chem
    {
         ...
         *
         * Provides constant-time access to connected atoms and incident bonds via the inherited Chem::Atom interface.
         * \c %BasicAtom instances are created, owned and managed exclusively by a Chem::BasicMolecule instance.
         */
