...
/**
 * \file
 * \brief Declaration of type CDPL::Chem::SMILESMolecularGraphOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Handler for the output of molecular graph data in the <em>Daylight SMILES</em> [\ref SMILES] format.
         */
