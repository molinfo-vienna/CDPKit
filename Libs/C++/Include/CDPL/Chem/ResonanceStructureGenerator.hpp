...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Enumerates the resonance structures of a molecular graph by redistributing &pi;-electrons across
         *        conjugated bonds.
         *
         * For each generated resonance structure the formal atom charges and bond orders are reported as a
         * StructureData record. Optional postprocessing minimizes octet rule violations, sp-hybridization
         * geometry violations, and 1,2-charge separations on adjacent carbon atoms.
         */
        class CDPL_CHEM_API ResonanceStructureGenerator
        {
          ...
          public:
            ...
            /**
             * \brief A constant random access iterator used to iterate over the generated \c const StructureData records.
             */
            ...
            class CDPL_CHEM_API StructureData
            {
              ...
              public:
                 ...
                 * \return A \c const reference to the formal charge array.
                 */
            ...
            /**
             * \brief Specifies whether resonance structures with 1,2-charge separations on adjacent carbon atoms
             *        shall be filtered out.
             * \param minimize If \c true, 1,2-charged carbon-carbon bonds are minimized.
             */
             ...
             * \return \c true if 1,2-charged carbon-carbon bonds are minimized, and \c false otherwise.
             */
            bool carbonBond12ChargesMinimized() const;

            /**
             * \brief Sets the maximum allowed difference between the lowest and highest total absolute formal atom
             *        charge count of accepted resonance structures.
            ...
            /**
             * \brief Returns a constant iterator pointing to the beginning of the generated \c const StructureData records.
             * \return A constant iterator pointing to the beginning of the generated \c const StructureData records.
             */
            ConstStructureDataIterator getStructureDataBegin() const;

            /**
             * \brief Returns a constant iterator pointing to the end of the generated \c const StructureData records.
             * \return A constant iterator pointing to the end of the generated \c const StructureData records.
             */
