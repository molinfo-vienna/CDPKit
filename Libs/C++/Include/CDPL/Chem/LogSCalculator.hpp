...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::LogSCalculator.
 */

#ifndef CDPL_CHEM_LOGSCALCULATOR_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		 ...
		 * \see [\ref LOGS]
		 */
		class CDPL_CHEM_API LogSCalculator 
		{
		...
		public:
			 ...
			 */
			LogSCalculator(const MolecularGraph& molgraph);
...
#endif // CDPL_CHEM_LOGSCALCULATOR_HPP
