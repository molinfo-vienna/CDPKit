...
/**
 * \file
 * \brief Declaration of type CDPL::Chem::INCHIMolecularGraphOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Handler for the output of molecular graph data in the <em>IUPAC International Chemical Identifier (InChI)</em>
         *        [\ref INCHI] format.
         */
