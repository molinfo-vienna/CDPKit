...
/**
 * \file
 * \brief Declaration of type CDPL::Chem::SMILESBZ2MoleculeReader.
 */

#ifndef CDPL_CHEM_SMILESBZ2MOLECULEREADER_HPP
#define CDPL_CHEM_SMILESBZ2MOLECULEREADER_HPP
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Reader for molecule data in the bzip2-compressed <em>Daylight SMILES</em> [\ref SMILES] format.
         */
