...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::MOL2MoleculeInputHandler.
 */

#ifndef CDPL_CHEM_MOL2MOLECULEINPUTHANDLER_HPP
#define CDPL_CHEM_MOL2MOLECULEINPUTHANDLER_HPP
