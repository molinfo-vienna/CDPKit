...
/**
 * \file
 * \brief Declaration of type CDPL::Chem::SMILESBZ2ReactionInputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Handler for the input of bzip2-compressed reaction data in the <em>Daylight SMILES</em> [\ref SMILES] format.
         */
