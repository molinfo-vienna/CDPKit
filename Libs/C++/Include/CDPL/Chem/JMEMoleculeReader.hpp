...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::JMEMoleculeReader.
 */

#ifndef CDPL_CHEM_JMEMOLECULEREADER_HPP
#define CDPL_CHEM_JMEMOLECULEREADER_HPP
...
namespace CDPL
{
    ...
    namespace Chem
    {
         ...
         * provides the molecule data in the native I/O format of the <em>JME Molecular Editor</em> applet.
         *
         * Attributes of the atoms and bonds of a read input molecule are stored as properties of allocated 
         * Chem::Atom and Chem::Bond objects. The affected properties are summarized in the tables below:
         *
         ...
         * </table>
         *
         * The error handling behaviour of a \c %JMEMoleculeReader instance can be configured with the following
         * control-parameter:
         *
         * <table width="95%" bgcolor="#FAFAFA" border="1" align="center" rules="all" cellpadding="3">
         *  <tr bgcolor="#DDDDDD" align="center" valign="middle">
