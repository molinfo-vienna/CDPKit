...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::FeatureDistanceConstraint.
 */

#ifndef CDPL_CHEM_FEATUREDISTANCECONSTRAINT_HPP
#define CDPL_CHEM_FEATUREDISTANCECONSTRAINT_HPP
...
namespace CDPL 
{
    ...
    namespace Chem
    {
		 ...
		 */
		class CDPL_CHEM_API FeatureDistanceConstraint : public std::binary_function<Feature, Feature, bool>
		{
...
#endif // CDPL_CHEM_FEATUREDISTANCECONSTRAINT_HPP
