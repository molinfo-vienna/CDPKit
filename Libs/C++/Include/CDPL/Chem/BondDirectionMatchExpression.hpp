...
namespace CDPL 
{
	...
	namespace Chem
	{
		...
		public:
			/**
			 * \brief A reference-counted smart pointer [\ref BSHPTR] for dynamically allocated \c %BondDirectionMatchExpression instances.
			 */
			typedef boost::shared_ptr<BondDirectionMatchExpression> SharedPointer;
