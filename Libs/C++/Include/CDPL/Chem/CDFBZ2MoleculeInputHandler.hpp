...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::CDFBZ2MoleculeInputHandler.
 */

#ifndef CDPL_CHEM_CDFBZ2MOLECULEINPUTHANDLER_HPP
#define CDPL_CHEM_CDFBZ2MOLECULEINPUTHANDLER_HPP
