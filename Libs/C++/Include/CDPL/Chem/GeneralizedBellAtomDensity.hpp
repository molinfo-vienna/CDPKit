...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::GeneralizedBellAtomDensity.
 */

#ifndef CDPL_CHEM_GENERALIZEDBELLATOMDENSITY_HPP
#define CDPL_CHEM_GENERALIZEDBELLATOMDENSITY_HPP
    ...
    namespace Chem
    {
		...
		class CDPL_CHEM_API GeneralizedBellAtomDensity
		{
		  ...
		  public:
			...
			double operator()(const Math::Vector3D& pos, const Math::Vector3D& atom_pos, const Atom& atom) const;
...
#endif // CDPL_CHEM_GENERALIZEDBELLATOMDENSITY_HPP
