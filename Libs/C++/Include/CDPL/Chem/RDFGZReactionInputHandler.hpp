...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::RDFGZReactionInputHandler.
 */

#ifndef CDPL_CHEM_RDFGZREACTIONINPUTHANDLER_HPP
#define CDPL_CHEM_RDFGZREACTIONINPUTHANDLER_HPP
