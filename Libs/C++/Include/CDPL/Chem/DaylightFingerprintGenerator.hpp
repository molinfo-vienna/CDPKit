...
/* 
 * DaylightFingerprintGenerator.hpp 
 *
 * Implementation of Daylight style Fingerprints
 *
...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::DaylightFingerprintGenerator.
 */

#ifndef CDPL_CHEM_DAYLIGHTFINGERPRINTGENERATOR_HPP
#define CDPL_CHEM_DAYLIGHTFINGERPRINTGENERATOR_HPP
...
namespace CDPL 
{
	...
	namespace Chem
	{
		...
		/**
		 * \brief DaylightFingerprintGenerator.
		 * \see [\ref DTPFP]
		 */
		class CDPL_CHEM_API DaylightFingerprintGenerator
		{

		public:
			/**
			 * \brief Specifies the default set of atomic properties considered in the generation
			 *        of atom descriptors by DaylightFingerprintGenerator::DefAtomDescriptorFunction.
			 */
			 ...
			 *        of bond descriptors by DaylightFingerprintGenerator::DefBondDescriptorFunction.
			 */
			 ...
			 */
			class CDPL_CHEM_API DefAtomDescriptorFunctor
			{
			 ...
			 */
			class CDPL_CHEM_API DefBondDescriptorFunctor
			{
			 ...
			 */
			typedef boost::function1<Base::uint64, const Atom&> AtomDescriptorFunction;
			 ...
			 * an integer of type Base::uint64. For details refer to the <em>Boost.Function</em> documentation [\ref BFUN]. 
			 */
			typedef boost::function1<Base::uint64, const Bond&> BondDescriptorFunction;

			/**
			 * \brief Constructs the \c %DaylightFingerprintGenerator instance.
			 */
			DaylightFingerprintGenerator();
			 ...
			 * \param func A DaylightFingerprintGenerator::AtomDescriptorFunction instance that wraps the target function.
			 * \note By default, atom descriptors are generated by DaylightFingerprintGenerator::DefAtomDescriptorFunctor.
			 */
			 ...
			 * \param func A DaylightFingerprintGenerator::BondDescriptorFunction instance that wraps the target function.
			 * \note By default, bond descriptors are generated by DaylightFingerprintGenerator::DefBondDescriptorFunctor.
			 */
			 ...
			 * \note By default, the generated fingerprints are \e 256 bits wide.
			 */
...
#endif // CDPL_CHEM_DAYLIGHTFINGERPRINTGENERATOR_HPP
