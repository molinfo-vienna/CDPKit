...
/**
 * \file
 * \brief Declaration of type CDPL::Chem::JMEMolecularGraphOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Chem
    {
        ...
        /**
         * \brief Handler for the output of molecular graph data in the native I/O format of the <em>JME Molecular Editor</em>
         *        [\ref JME] java applet.
         */
