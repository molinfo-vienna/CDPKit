...
namespace CDPL 
{
	...
	namespace Chem 
	{
		 ...
		 * \return The calculated similarity measure.
		 */
		CDPL_CHEM_API double calcCosineSimilarity(const Util::BitSet& bs1, const Util::BitSet& bs2);
		 ...
		 * \return The calculated similarity measure.
		 */
		CDPL_CHEM_API double calcEuclideanSimilarity(const Util::BitSet& bs1, const Util::BitSet& bs2);
		 ...
		 * \return The calculated similarity measure.
		 */
		CDPL_CHEM_API double calcManhattanSimilarity(const Util::BitSet& bs1, const Util::BitSet& bs2);
		 ...
		 * \return The calculated similarity measure.
		 */
		CDPL_CHEM_API double calcDiceSimilarity(const Util::BitSet& bs1, const Util::BitSet& bs2);
		 ...
		 * \return The calculated similarity measure.
		 */
		CDPL_CHEM_API double calcTverskySimilarity(const Util::BitSet& bs1, const Util::BitSet& bs2, double a, double b);
