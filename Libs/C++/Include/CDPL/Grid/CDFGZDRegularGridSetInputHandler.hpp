...
/**
 * \file
 * \brief Declaration of type CDPL::Grid::CDFGZDRegularGridSetInputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Grid
    {
        ...
        /**
         * \brief A handler for the input of gzip-compressed regular spatial grid set data in the native I/O format of the <em>CDPL</em>.
         */
