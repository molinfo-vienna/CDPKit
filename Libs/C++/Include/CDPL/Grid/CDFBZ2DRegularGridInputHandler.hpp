...
/**
 * \file
 * \brief Declaration of type CDPL::Grid::CDFBZ2DRegularGridInputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Grid
    {
        ...
        /**
         * \brief A handler for the input of bzip2-compressed regular spatial grid data in the native I/O format of the <em>CDPL</em>.
         */
