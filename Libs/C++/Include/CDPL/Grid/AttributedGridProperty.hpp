...
/**
 * \file
 * \brief Definition of constants in namespace CDPL::Grid::AttributedGridProperty.
 */

#ifndef CDPL_GRID_ATTRIBUTEDGRIDPROPERTY_HPP
#define CDPL_GRID_ATTRIBUTEDGRIDPROPERTY_HPP
