...
/**
 * \file
 * \brief Declaration of type CDPL::Biomol::MMTFBZ2MoleculeInputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Biomol
    {
        ...
        /**
         * \brief Handler for the input of bzip2-compressed molecule data in the <em>Macromolecular Transmission Format (MMTF)</em>
         *        [\ref MMTF] format.
         */
