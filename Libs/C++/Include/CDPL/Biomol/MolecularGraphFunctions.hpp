...
namespace CDPL
{
    ...
    namespace Biomol
    {
        ...
        /**
         * \brief Returns the value of the Biomol::MolecularGraphProperty::RESIDUE_CODE property of the molecular graph \a molgraph.
        ...
        /**
         * \brief Sets the value of the Biomol::MolecularGraphProperty::RESIDUE_CODE property of the molecular graph \a molgraph to \a code.
        ...
        /**
         * \brief Clears the value of the Biomol::MolecularGraphProperty::RESIDUE_CODE property of the molecular graph \a molgraph.
        ...
        /**
         * \brief Tells whether the Biomol::MolecularGraphProperty::RESIDUE_CODE property of the molecular graph \a molgraph is set.
        ...
        /**
         * \brief Returns the value of the Biomol::MolecularGraphProperty::RESIDUE_SEQUENCE_NUMBER property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to return the property value.
        ...
        /**
         * \brief Sets the value of the Biomol::MolecularGraphProperty::RESIDUE_SEQUENCE_NUMBER property of the molecular graph \a molgraph to \a seq_no.
         * \param molgraph The molecular graph for which to set the property value.
        ...
        /**
         * \brief Clears the value of the Biomol::MolecularGraphProperty::RESIDUE_SEQUENCE_NUMBER property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to clear the property value.
         */
        CDPL_BIOMOL_API void clearResidueSequenceNumber(Chem::MolecularGraph& molgraph);

        /**
         * \brief Tells whether the Biomol::MolecularGraphProperty::RESIDUE_SEQUENCE_NUMBER property of the molecular graph \a molgraph is set.
         * \param molgraph The molecular graph for which to query the property value.
        ...
        /**
         * \brief Returns the value of the Biomol::MolecularGraphProperty::RESIDUE_INSERTION_CODE property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to return the property value.
        ...
        /**
         * \brief Sets the value of the Biomol::MolecularGraphProperty::RESIDUE_INSERTION_CODE property of the molecular graph \a molgraph to \a code.
         * \param molgraph The molecular graph for which to set the property value.
        ...
        /**
         * \brief Clears the value of the Biomol::MolecularGraphProperty::RESIDUE_INSERTION_CODE property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to clear the property value.
         */
        CDPL_BIOMOL_API void clearResidueInsertionCode(Chem::MolecularGraph& molgraph);

        /**
         * \brief Tells whether the Biomol::MolecularGraphProperty::RESIDUE_INSERTION_CODE property of the molecular graph \a molgraph is set.
         * \param molgraph The molecular graph for which to query the property value.
        ...
        /**
         * \brief Returns the value of the Biomol::MolecularGraphProperty::CHAIN_ID property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to return the property value.
        ...
        /**
         * \brief Sets the value of the Biomol::MolecularGraphProperty::CHAIN_ID property of the molecular graph \a molgraph to \a id.
         * \param molgraph The molecular graph for which to set the property value.
        ...
        /**
         * \brief Clears the value of the Biomol::MolecularGraphProperty::CHAIN_ID property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to clear the property value.
         */
        CDPL_BIOMOL_API void clearChainID(Chem::MolecularGraph& molgraph);

        /**
         * \brief Tells whether the Biomol::MolecularGraphProperty::CHAIN_ID property of the molecular graph \a molgraph is set.
         * \param molgraph The molecular graph for which to query the property value.
        ...
        /**
         * \brief Returns the value of the Biomol::MolecularGraphProperty::MODEL_NUMBER property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to return the property value.
        ...
        /**
         * \brief Sets the value of the Biomol::MolecularGraphProperty::MODEL_NUMBER property of the molecular graph \a molgraph to \a model_no.
         * \param molgraph The molecular graph for which to set the property value.
        ...
        /**
         * \brief Clears the value of the Biomol::MolecularGraphProperty::MODEL_NUMBER property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to clear the property value.
         */
        CDPL_BIOMOL_API void clearModelNumber(Chem::MolecularGraph& molgraph);

        /**
         * \brief Tells whether the Biomol::MolecularGraphProperty::MODEL_NUMBER property of the molecular graph \a molgraph is set.
         * \param molgraph The molecular graph for which to query the property value.
        ...
        /**
         * \brief Clears the value of the Biomol::MolecularGraphProperty::PDB_DATA property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to clear the property value.
         */
        ...
        /**
         * \brief Clears the value of the Biomol::MolecularGraphProperty::MMCIF_DATA property of the molecular graph \a molgraph.
         * \param molgraph The molecular graph for which to clear the property value.
         */
        ...
        /**
         * \brief Extracts the substructures of all residues that are specified by atoms in the molecular graph \a molgraph from the parent molecular graph \a parent_molgraph.
        ...
        /**
         * \brief Extracts the atoms of the molecular graph \a macromol that lie within \a max_dist of any atom of \a core.
        ...
        /**
         * \brief Extracts the atoms of the molecular graph \a macromol that lie within \a max_dist of any atom of \a core, using \a coords_func to obtain atom positions.
         * \param core The core molecular graph defining the reference atom positions.
        ...
        /**
         * \brief Extracts the residues of the molecular graph \a macromol that contain at least one atom within \a max_dist of any atom of \a core.
         * \param core The core molecular graph defining the reference atom positions.
        ...
        /**
         * \brief Extracts the residues of the molecular graph \a macromol that contain at least one atom within \a max_dist of
         *        any atom of \a core, using \a coords_func to obtain atom positions.
         * \param core The core molecular graph defining the reference atom positions.
        ...
        /**
         * \brief Copies residue identifying properties from heavy atoms to their attached hydrogen atoms in the molecular graph \a molgraph.
