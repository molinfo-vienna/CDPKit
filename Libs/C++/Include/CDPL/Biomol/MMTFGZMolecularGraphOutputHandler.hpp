...
/**
 * \file
 * \brief Declaration of type CDPL::Biomol::MMTFGZMolecularGraphOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Biomol
    {
        ...
        /**
         * \brief Handler for the output of gzip-compressed molecular graph data in the <em>Macromolecular Transmission Format (MMTF)</em>
         *        [\ref MMTF].
         */
