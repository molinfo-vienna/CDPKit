...
/**
 * \file
 * \brief Declaration of type CDPL::Biomol::MMTFBZ2MolecularGraphOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Biomol
    {
        ...
        /**
         * \brief Handler for the output of bzip2-compressed molecular graph data in the <em>Macromolecular Transmission Format (MMTF)</em>
         *        [\ref MMTF].
         */
