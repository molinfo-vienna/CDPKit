...
/**
 * \file
 * \brief Definition of the preprocessor macro \ref CDPL_BASE_API.
 */

#ifndef CDPL_BASE_APIPREFIX_HPP
#define CDPL_BASE_APIPREFIX_HPP

#ifdef CDPL_BASE_STATIC_LINK
