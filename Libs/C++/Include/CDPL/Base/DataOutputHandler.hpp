...
/**
 * \file
 * \brief Definition of class CDPL::Base::DataOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Base
    {
        ...
        /**
         * \brief Factory interface providing methods for the creation of Base::DataWriter instances handling a particular
