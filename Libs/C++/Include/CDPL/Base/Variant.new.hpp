	...
	namespace Base
	{
		...
		public:
			...
			const T& getData() const {
				...
				if (data->getTypeID() == typeid(T))
					return static_cast<const DataHolder<T>*>(data)->data;

				throw BadCast(std::string("Variant: extraction of held data of type '") + data->getTypeID().name() + 
		...
		private:
			...
			{ 
				...
				virtual const void* getDataPointer() const override {
					return &data;
				}
