...
/**
 * \file
 * \brief Definition of constants in namespace CDPL::ConfGen::ControlParameterDefault.
 */

#ifndef CDPL_CONFGEN_CONTROLPARAMETERDEFAULT_HPP
#define CDPL_CONFGEN_CONTROLPARAMETERDEFAULT_HPP
