...
namespace CDPL 
{
    ...
    namespace ConfGen 
    {
		...
		class CDPL_CONFGEN_API FragmentConformerGenerator
		{
			...
			typedef std::vector<ConformerDataPtr> ConformerDataArray;
		  ...
		  public:
			...
			const ConformerData& getConformer(std::size_t conf_idx) const;
		  ...
		  private:
			...
			bool init(const Chem::MolecularGraph& molgraph);
