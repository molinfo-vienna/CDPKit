...
namespace CDPL
{
    ...
    namespace ConfGen
    {
        ...
        /**
         * \brief Driver for the fragment-based generation of 3D structures: decomposes a molecular graph into chain
         *        and ring fragments, looks up pre-built conformers from a ConfGen::FragmentLibrary for each fragment
         *        and assembles them into one or more full 3D conformers.
         */
