...
/**
 * \file
 * \brief Definition of the class CDPL::GRAIL::DefaultInteractionScoreGridSetCalculator.
 */

#ifndef CDPL_GRAIL_DEFAULTINTERACTIONSCOREGRIDSETCALCULATOR_HPP
#define CDPL_GRAIL_DEFAULTINTERACTIONSCOREGRIDSETCALCULATOR_HPP
...
namespace CDPL 
{
    ...
    namespace GRAIL
    {
		 ...
		 */
		class CDPL_GRAIL_API DefaultInteractionScoreGridSetCalculator : public InteractionScoreGridSetCalculator
		{
...
#endif // CDPL_GRAIL_DEFAULTINTERACTIONSCOREGRIDSETCALCULATOR_HPP
