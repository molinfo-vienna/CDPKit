...
/**
 * \file
 * \brief Definition of constants in namespace CDPL::GRAIL::AttributedGridPropertyDefault.
 */

#ifndef CDPL_GRAIL_ATTRIBUTEDGRIDPROPERTYDEFAULT_HPP
#define CDPL_GRAIL_ATTRIBUTEDGRIDPROPERTYDEFAULT_HPP
