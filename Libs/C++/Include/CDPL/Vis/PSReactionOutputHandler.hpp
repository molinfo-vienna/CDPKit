...
/**
 * \file
 * \brief Declaration of type CDPL::Vis::PSReactionOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Vis
    {
        ...
        /**
         * \brief Handler for the output of 2D depictions of chemical reactions in the <em>PostScript (PS)</em> [\ref WPS]
         *        format.
         */
