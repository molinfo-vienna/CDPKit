...
namespace CDPL
{
    ...
    namespace Vis
    {
        ...
        /**
         * \brief Implements the Vis::FontMetrics interface for the \e Cairo rendering backend.
         *
        ...
        class CDPL_VIS_API CairoFontMetrics : public FontMetrics
        {
          ...
          public:
            /**
             * \brief Constructs a \c %CairoFontMetrics instance that operates on the \e Cairo drawing context specified by
             *        \a cairo_ctxt.
