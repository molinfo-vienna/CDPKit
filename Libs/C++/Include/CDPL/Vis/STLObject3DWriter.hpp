...
/**
 * \file
 * \brief Definition of class CDPL::Vis::STLObject3DWriter.
 */
    ...
    namespace Vis
    {
        ...
        class CDPL_VIS_API STLObject3DWriter : public Base::DataWriter<Object3D>, private Shape3DVisitor
        {
          ...
          public:
            ...
            /**
             * \brief Destructor; finalizes the STL output and flushes the underlying stream.
             */
            ~STLObject3DWriter();
            ...
            /**
             * \brief Finalizes the STL output and flushes the underlying stream.
             */
            void close();
