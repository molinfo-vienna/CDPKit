...
/**
 * \file
 * \brief Definition of class CDPL::Vis::SizeSpecification.
 */
    ...
    namespace Vis
    {
        ...
        class CDPL_VIS_API SizeSpecification
        {
          ...
          public:
             ...
             *
             * Input scaling is a preprocessing step (performed by some other part of the system) where an input size quantity
