...
/**
 * \file
 * \brief Declaration of type CDPL::Vis::SVGMolecularGraphOutputHandler.
 */
...
namespace CDPL
{
    ...
    namespace Vis
    {
        ...
        /**
         * \brief Handler for the output of 2D depictions of chemical structures in the <em>Scalable Vector Graphics (SVG)</em>
         *        [\ref WSVG] format.
         */
