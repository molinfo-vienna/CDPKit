...
/**
 * \file
 * \brief Definition of class CDPL::Vis::PolylinePrimitive2D.
 */
    ...
    namespace Vis
    {
                                                 ...
                                                 public GraphicsPrimitive2D
        {
          ...
          public:
            ...
            /**
             * \brief Renders the polyline via \a renderer using the configured pen.
            ...
            /**
             * \brief Computes the axis-aligned bounding rectangle of the polyline.
             * \param bounds The Rectangle2D instance storing the result.
             * \param font_metrics Unused for polylines; included to satisfy the GraphicsPrimitive2D interface.
             */
