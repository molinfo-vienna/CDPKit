    ...
    namespace Util
    {
        ...
        class Array
        {
          ...
          public:
            ...
            /**
             * \brief Returns a non-\c const reference to the underlying array storage.
             * \return A non-\c const reference to the underlying array storage.
             */
            StorageType& getData();

            /**
             * \brief Returns a \c const reference to the underlying array storage.
             * \return A \c const reference to the underlying array storage.
             */
