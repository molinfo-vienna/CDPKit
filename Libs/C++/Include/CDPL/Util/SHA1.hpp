...
/**
 * \file
 * \brief Definition of the class CDPL::Util::SHA1.
 */

#ifndef CDPL_UTIL_SHA1_HPP
#define CDPL_UTIL_SHA1_HPP
...
template <typename InputIter>
inline void CDPL::Util::SHA1::input(InputIter in, InputIter end)
{
	if (digestComputed)
		reset();
...
template <typename OutputIter>
inline void CDPL::Util::SHA1::getResult(OutputIter out)
{
	if (!digestComputed) {
		padMessage();
