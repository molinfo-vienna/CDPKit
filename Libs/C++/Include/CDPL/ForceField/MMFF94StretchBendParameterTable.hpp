...
/**
 * \file
 * \brief Definition of class CDPL::ForceField::MMFF94StretchBendParameterTable.
 */
...
namespace CDPL
{
    ...
    namespace ForceField
    {
        ...
        class CDPL_FORCEFIELD_API MMFF94StretchBendParameterTable
        {
          ...
          public:
            /**
             * \brief A reference-counted smart pointer [\ref SHPTR] for dynamically allocated \c %MMFF94StretchBendParameterTable instances.
             */
            ...
            /**
             * \brief Constructs an empty \c %MMFF94StretchBendParameterTable instance.
             */
