    ...
    namespace ForceField 
    {
		...
		class CDPL_FORCEFIELD_API MMFF94StretchBendInteractionAnalyzer
		{
		  ...
		  public:
			...
			MMFF94StretchBendInteractionAnalyzer(const Chem::MolecularGraph& molgraph, 
												 MMFF94StretchBendInteractionList& iactions);

			void analyze(const Chem::MolecularGraph& molgraph, MMFF94StretchBendInteractionList& iactions);
