...
namespace CDPL 
{
	...
	namespace ForceField 
	{
		...
		CDPL_FORCEFIELD_API void assignMMFF94BondTypeIndices(Chem::MolecularGraph& molgraph, bool overwrite);

		CDPL_FORCEFIELD_API void calcMMFF94AtomCharges(Chem::MolecularGraph& molgraph, bool overwrite);
