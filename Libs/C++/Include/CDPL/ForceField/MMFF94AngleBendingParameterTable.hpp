...
/**
 * \file
 * \brief Definition of class CDPL::ForceField::MMFF94AngleBendingParameterTable.
 */
...
namespace CDPL
{
    ...
    namespace ForceField
    {
        ...
        class CDPL_FORCEFIELD_API MMFF94AngleBendingParameterTable
        {
          ...
          public:
            /** \brief A reference-counted smart pointer [\ref SHPTR] for dynamically allocated \c %MMFF94AngleBendingParameterTable instances. */
            ...
            /**
             * \brief Constructs an empty \c %MMFF94AngleBendingParameterTable instance.
             */
