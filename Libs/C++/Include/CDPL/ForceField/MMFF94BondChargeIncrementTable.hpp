...
/**
 * \file
 * \brief Definition of class CDPL::ForceField::MMFF94BondChargeIncrementTable.
 */
...
namespace CDPL
{
    ...
    namespace ForceField
    {
         ...
         *
         * The charge increment is applied to the first atom (and its negative to the second atom) when partitioning partial atomic
