...
/**
 * \file
 * \brief Definition of constants in namespace CDPL::ForceField::MolecularGraphProperty.
 */

#ifndef CDPL_FORCEFIELD_MOLECULARGRAPHPROPERTY_HPP
#define CDPL_FORCEFIELD_MOLECULARGRAPHPROPERTY_HPP
