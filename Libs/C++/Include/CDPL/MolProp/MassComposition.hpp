...
namespace CDPL
{
    ...
    namespace MolProp
    {
         ...
         *
         * \c %MassComposition is a unique associative map where the keys specify the atom type
        ...
        class CDPL_MOLPROP_API MassComposition : public Util::Map<unsigned int, double, true>
        {
          ...
          public:
            /**
             * \brief A reference-counted smart pointer [\ref SHPTR] for dynamically allocated \c %MassComposition instances.
             */
