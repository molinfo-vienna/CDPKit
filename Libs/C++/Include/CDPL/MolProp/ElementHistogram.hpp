...
/**
 * \file
 * \brief Definition of the type CDPL::MolProp::ElementHistogram.
 */

#ifndef CDPL_MOLPROP_ELEMENTHISTOGRAM_HPP
#define CDPL_MOLPROP_ELEMENTHISTOGRAM_HPP
...
namespace CDPL
{
    ...
    namespace MolProp
    {
        ...
        class CDPL_MOLPROP_API ElementHistogram : public Util::Map<unsigned int, std::size_t, true>
        {
          ...
          public:
            /**
             * \brief A reference-counted smart pointer [\ref SHPTR] for dynamically allocated \c %ElementHistogram instances.
             */
