...
namespace
{
    ...
    boost::once_flag loadFallbackTorsionLibraryFlag = BOOST_ONCE_INIT;

    ConfGen::TorsionLibrary::SharedPointer fallbackTorLib;

    void loadFallbackTorsionLibrary()
    {
...
{
    boost::call_once(&loadFallbackTorsionLibrary, loadFallbackTorsionLibraryFlag);
