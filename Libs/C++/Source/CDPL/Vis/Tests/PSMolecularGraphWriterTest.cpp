...
BOOST_AUTO_TEST_CASE(PSMolecularGraphWriterTest)
{
	...
	std::ofstream os("PSMolecularGraphWriterTest_1.ps", 
					 std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);

	BOOST_CHECK(os);

	PSMolecularGraphWriter writer(os);
...
//-----
	...
	os.close();
	os.open("PSMolecularGraphWriterTest_2.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSMolecularGraphWriterTest_3.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSMolecularGraphWriterTest_4.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSMolecularGraphWriterTest_5.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSMolecularGraphWriterTest_6.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
