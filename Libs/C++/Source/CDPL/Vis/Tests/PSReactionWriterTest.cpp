...
BOOST_AUTO_TEST_CASE(PSReactionWriterTest)
{
	...
	std::ofstream os("PSReactionWriterTest_1.ps", 
					 std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);

	BOOST_CHECK(os);

	PSReactionWriter writer(os);
...
//-----
	...
	os.close();
	os.open("PSReactionWriterTest_2.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSReactionWriterTest_3.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSReactionWriterTest_4.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSReactionWriterTest_5.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PSReactionWriterTest_6.ps",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
