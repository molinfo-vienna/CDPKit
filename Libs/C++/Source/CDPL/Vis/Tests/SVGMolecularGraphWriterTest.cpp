...
BOOST_AUTO_TEST_CASE(SVGMolecularGraphWriterTest)
{
	...
	std::ofstream os("SVGMolecularGraphWriterTest_1.svg",
					 std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);

	BOOST_CHECK(os);

	SVGMolecularGraphWriter writer(os);
...
//-----
	...
	os.close();
	os.open("SVGMolecularGraphWriterTest_2.svg",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("SVGMolecularGraphWriterTest_3.svg",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("SVGMolecularGraphWriterTest_4.svg",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("SVGMolecularGraphWriterTest_5.svg",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("SVGMolecularGraphWriterTest_6.svg",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
