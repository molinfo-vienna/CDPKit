...
BOOST_AUTO_TEST_CASE(PDFMolecularGraphWriterTest)
{
	...
	std::ofstream os("PDFMolecularGraphWriterTest_1.pdf",
					 std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);

	BOOST_CHECK(os);

	PDFMolecularGraphWriter writer(os);
...
//-----
	...
	os.close();
	os.open("PDFMolecularGraphWriterTest_2.pdf",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PDFMolecularGraphWriterTest_3.pdf",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PDFMolecularGraphWriterTest_4.pdf",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PDFMolecularGraphWriterTest_5.pdf",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
...
//-----
	...
	os.close();
	os.open("PDFMolecularGraphWriterTest_6.pdf",
			std::ios_base::binary | std::ios_base::out | std::ios_base::trunc);
