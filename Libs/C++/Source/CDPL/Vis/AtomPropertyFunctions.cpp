...
MAKE_ATOM_PROPERTY_FUNCTIONS(CONFIGURATION_LABEL_COLOR, const Vis::Color&, ConfigurationLabelColor)
MAKE_ATOM_PROPERTY_FUNCTIONS(CONFIGURATION_LABEL_SIZE, const Vis::SizeSpecification&, ConfigurationLabelSize)
MAKE_ATOM_PROPERTY_FUNCTIONS(CUSTOM_LABEL_FONT, const Vis::Font&, CustomLabelFont)
MAKE_ATOM_PROPERTY_FUNCTIONS(CUSTOM_LABEL_COLOR, const Vis::Color&, CustomLabelColor)
MAKE_ATOM_PROPERTY_FUNCTIONS(CUSTOM_LABEL_SIZE, const Vis::SizeSpecification&, CustomLabelSize)
MAKE_ATOM_PROPERTY_FUNCTIONS(CUSTOM_LABEL, const std::string&, CustomLabel)
MAKE_ATOM_PROPERTY_FUNCTIONS(HIGHLIGHTED_FLAG, bool, HighlightedFlag)
MAKE_ATOM_PROPERTY_FUNCTIONS(HIGHLIGHT_AREA_BRUSH, const Vis::Brush&, HighlightAreaBrush)
MAKE_ATOM_PROPERTY_FUNCTIONS(HIGHLIGHT_AREA_OUTLINE_PEN, const Vis::Pen&, HighlightAreaOutlinePen)
