...
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(ATOM_CUSTOM_LABEL_FONT, const Vis::Font&, AtomCustomLabelFont)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(ATOM_CUSTOM_LABEL_COLOR, const Vis::Color&, AtomCustomLabelColor)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(ATOM_CUSTOM_LABEL_SIZE, const Vis::SizeSpecification&, AtomCustomLabelSize)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(ATOM_HIGHLIGHT_AREA_SIZE, const Vis::SizeSpecification&, AtomHighlightAreaSize)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(ATOM_HIGHLIGHT_AREA_BRUSH, const Vis::Brush&, AtomHighlightAreaBrush)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(ATOM_HIGHLIGHT_AREA_OUTLINE_PEN, const Vis::Pen&, AtomHighlightAreaOutlinePen)

MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(HIGHLIGHT_AREA_OUTLINE_WIDTH, const Vis::SizeSpecification&, HighlightAreaOutlineWidth)
...
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(BOND_CUSTOM_LABEL_FONT, const Vis::Font&, BondCustomLabelFont)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(BOND_CUSTOM_LABEL_COLOR, const Vis::Color&, BondCustomLabelColor)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(BOND_CUSTOM_LABEL_SIZE, const Vis::SizeSpecification&, BondCustomLabelSize)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(BOND_HIGHLIGHT_AREA_WIDTH, const Vis::SizeSpecification&, BondHighlightAreaWidth)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(BOND_HIGHLIGHT_AREA_BRUSH, const Vis::Brush&, BondHighlightAreaBrush)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(BOND_HIGHLIGHT_AREA_OUTLINE_PEN, const Vis::Pen&, BondHighlightAreaOutlinePen)
