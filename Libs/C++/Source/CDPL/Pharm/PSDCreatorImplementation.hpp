...
#ifndef CDPL_PHARM_PSDCREATORIMPLEMENTATION_HPP
#define CDPL_PHARM_PSDCREATORIMPLEMENTATION_HPP
...
namespace CDPL 
{
	...
	class PSDCreatorImplementation : private SQLiteDataIOBase
	{

	public:
	    PSDCreatorImplementation();
...
#endif // CDPL_PHARM_PSDCREATORIMPLEMENTATION_HPP
