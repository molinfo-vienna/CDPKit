...
void Pharm::FeatureInteractionAnalyzer::setConstraintFunction(unsigned int type1, unsigned int type2, const ConstraintFunction& func)
{
...
void Pharm::FeatureInteractionAnalyzer::removeConstraintFunction(unsigned int type1, unsigned int type2)
{
    constraintFuncMap.erase(std::make_pair(type1, type2));
}

const Pharm::FeatureInteractionAnalyzer::ConstraintFunction& 
Pharm::FeatureInteractionAnalyzer::getConstraintFunction(unsigned int type1, unsigned int type2) const
{
...
void Pharm::FeatureInteractionAnalyzer::analyze(const Pharmacophore& pharm1, const Pharmacophore& pharm2, FeatureMapping& iactions) const
{
