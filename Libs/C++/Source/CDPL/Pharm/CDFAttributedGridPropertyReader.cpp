...
void Pharm::CDFAttributedGridPropertyReader::registerExternalPropertyHandlers()
{
    Grid::CDFDataReader::registerExternalPropertyHandler(&readProperties);
}

bool Pharm::CDFAttributedGridPropertyReader::readProperties(unsigned int handler_id, const Grid::CDFDataReader& reader, 
