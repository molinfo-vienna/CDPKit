...
BOOST_AUTO_TEST_CASE(FeatureTest)
{
	...
	BOOST_CHECK(&const_cast<const Feature&>(pharm.getFeature(0)).getPharmacophore() == &pharm);
	BOOST_CHECK(&const_cast<Feature&>(pharm.getFeature(0)).getPharmacophore() == &pharm);

	//-----

	BOOST_CHECK(&const_cast<const Feature&>(pharm.getFeature(1)).getPharmacophore() == &pharm);
	BOOST_CHECK(&const_cast<Feature&>(pharm.getFeature(1)).getPharmacophore() == &pharm);
