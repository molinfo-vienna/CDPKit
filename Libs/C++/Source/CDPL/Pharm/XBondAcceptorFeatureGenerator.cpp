...
void Pharm::XBondAcceptorFeatureGenerator::init()
{
	...
	addIncludePattern(parseSMARTS("[*:8]~[#8,#7,S;X2:7]~[*:8]"), FeatureType::HALOGEN_BOND_ACCEPTOR, 1.5, FeatureGeometry::SPHERE);
	addIncludePattern(parseSMARTS("[*:8]=[N;X2:7]-[#1]"), FeatureType::HALOGEN_BOND_ACCEPTOR, 1.5, FeatureGeometry::SPHERE);
	addIncludePattern(parseSMARTS("[*:8]#[N;X1:7]"), FeatureType::HALOGEN_BOND_ACCEPTOR, 1.5, FeatureGeometry::SPHERE);
	...
	addIncludePattern(parseSMARTS("[*:8]-[N;X3:7](-[*:8])-[*:8]"), FeatureType::HALOGEN_BOND_ACCEPTOR, 1.5, FeatureGeometry::SPHERE);
	...
	addIncludePattern(parseSMARTS("[*:8]-[F:7]"), FeatureType::HALOGEN_BOND_ACCEPTOR, 1.5, FeatureGeometry::SPHERE);
}
