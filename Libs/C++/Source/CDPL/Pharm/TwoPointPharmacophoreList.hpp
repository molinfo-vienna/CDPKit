...
#ifndef CDPL_PHARM_TWOPOINTPHARMACOPHORELIST_HPP
#define CDPL_PHARM_TWOPOINTPHARMACOPHORELIST_HPP
...
namespace CDPL 
{
    ...
    namespace Pharm
    {
		...
		typedef boost::unordered_multiset<TwoPointPharmacophore, TwoPointPharmHashFunc, TwoPointPharmEqCmpFunc> TwoPointPharmacophoreList;
    }
}

#endif // CDPL_PHARM_TWOPOINTPHARMACOPHORELIST_HPP
