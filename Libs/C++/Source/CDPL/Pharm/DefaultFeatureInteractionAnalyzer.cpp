...
Pharm::DefaultFeatureInteractionAnalyzer::DefaultFeatureInteractionAnalyzer()
{
    init();
}

Pharm::DefaultFeatureInteractionAnalyzer::DefaultFeatureInteractionAnalyzer(const Pharmacophore& pharm1, const Pharmacophore& pharm2, FeatureMapping& interactions)
{
    init();
    analyze(pharm1, pharm2, interactions);
}

void Pharm::DefaultFeatureInteractionAnalyzer::init()
{
