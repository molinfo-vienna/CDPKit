...
Pharm::TopologicalQueryPharmAlignmentFilter::TopologicalQueryPharmAlignmentFilter(const Pharmacophore& query, std::size_t max_omtd_ftrs):
...
bool Pharm::TopologicalQueryPharmAlignmentFilter::operator()(const FeatureMapping& mapping) const
{
