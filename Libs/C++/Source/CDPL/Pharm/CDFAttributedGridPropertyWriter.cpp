...
void Pharm::CDFAttributedGridPropertyWriter::registerExternalPropertyHandlers()
{
	Grid::CDFDataWriter::registerExternalPropertyHandler(&outputProperties);
}

unsigned int Pharm::CDFAttributedGridPropertyWriter::outputProperties(const Grid::CDFDataWriter& writer, const Grid::AttributedGrid& grid, Internal::ByteBuffer& data) 
{
