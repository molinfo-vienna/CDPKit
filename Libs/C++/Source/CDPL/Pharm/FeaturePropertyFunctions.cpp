...
MAKE_FEATURE_PROPERTY_FUNCTIONS(ENVIRONMENT_RESIDUE_INFO, const std::string&, EnvironmentResidueInfo)
MAKE_FEATURE_PROPERTY_FUNCTIONS(ENVIRONMENT_RESIDUE_ATOM_INFO, const std::string&, EnvironmentResidueAtomInfo) 
MAKE_FEATURE_PROPERTY_FUNCTIONS(ENVIRONMENT_SUBSTRUCTURE, const Chem::Fragment::SharedPointer&, EnvironmentSubstructure) 
