...
MAKE_CONTROL_PARAM_FUNCTIONS(CUBE_COMMENT_IS_NAME, bool, CUBECommentIsName)
MAKE_CONTROL_PARAM_FUNCTIONS(CUBE_INPUT_DISTANCE_SCALING_FACTOR, double, CUBEInputDistanceScalingFactor)
MAKE_CONTROL_PARAM_FUNCTIONS(CUBE_OUTPUT_DISTANCE_SCALING_FACTOR, double, CUBEOutputDistanceScalingFactor)
