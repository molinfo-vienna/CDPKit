...
#define MAKE_ATTRGRID_PROPERTY_FUNCTIONS_COMMON(PROP_NAME, TYPE, FUNC_SUFFIX) \
	void GRAILS::set##FUNC_SUFFIX(Grid::AttributedGrid& grid, TYPE arg)	\
	{																	\
		grid.setProperty(AttributedGridProperty::PROP_NAME, arg);		\
	}																	\
																		\
	bool GRAILS::has##FUNC_SUFFIX(const Grid::AttributedGrid& grid)		\
	{																	\
		return grid.isPropertySet(AttributedGridProperty::PROP_NAME);	\
	}																	\
																		\
	void GRAILS::clear##FUNC_SUFFIX(Grid::AttributedGrid& grid)			\
	{																	\
		grid.removeProperty(AttributedGridProperty::PROP_NAME);			\
	}

#define MAKE_ATTRGRID_PROPERTY_FUNCTIONS(PROP_NAME, TYPE, FUNC_SUFFIX)	\
	TYPE GRAILS::get##FUNC_SUFFIX(const Grid::AttributedGrid& grid)		\
	{																	\
...
MAKE_ATTRGRID_PROPERTY_FUNCTIONS_WITH_DEF(TARGET_FEATURE_TYPE, unsigned int, TargetFeatureType)
