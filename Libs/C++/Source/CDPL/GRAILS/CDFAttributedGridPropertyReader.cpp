...
void GRAILS::CDFAttributedGridPropertyReader::registerExternalPropertyHandlers()
{
    Grid::CDFDataReader::registerExternalPropertyHandler(&readProperties);
}

bool GRAILS::CDFAttributedGridPropertyReader::readProperties(unsigned int handler_id, const Grid::CDFDataReader& reader, 
