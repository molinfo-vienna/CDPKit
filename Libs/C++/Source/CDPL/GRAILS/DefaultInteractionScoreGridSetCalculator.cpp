...
GRAILS::DefaultInteractionScoreGridSetCalculator::DefaultInteractionScoreGridSetCalculator(): 
...
GRAILS::DefaultInteractionScoreGridSetCalculator::DefaultInteractionScoreGridSetCalculator(double step_size, std::size_t x_size, std::size_t y_size, std::size_t z_size): 
...
GRAILS::DefaultInteractionScoreGridSetCalculator::DefaultInteractionScoreGridSetCalculator(double x_step_size, double y_step_size, double z_step_size, 
...
const Math::Matrix4D& GRAILS::DefaultInteractionScoreGridSetCalculator::getCoordinatesTransform() const
{
    return coordsTransform;
}

double GRAILS::DefaultInteractionScoreGridSetCalculator::getXStepSize() const
{
    return xStepSize;
}

void GRAILS::DefaultInteractionScoreGridSetCalculator::setXStepSize(double size)
{
    xStepSize = size;
}

double GRAILS::DefaultInteractionScoreGridSetCalculator::getYStepSize() const
{
    return yStepSize;
}

void GRAILS::DefaultInteractionScoreGridSetCalculator::setYStepSize(double size)
{
    yStepSize = size;
}

double GRAILS::DefaultInteractionScoreGridSetCalculator::getZStepSize() const
{
    return zStepSize;
}

void GRAILS::DefaultInteractionScoreGridSetCalculator::setZStepSize(double size)
{
    zStepSize = size;
}

std::size_t GRAILS::DefaultInteractionScoreGridSetCalculator::getGridXSize() const
{
    return gridXSize;
}

void GRAILS::DefaultInteractionScoreGridSetCalculator::setGridXSize(std::size_t size)
{
    gridXSize = size;
}

std::size_t GRAILS::DefaultInteractionScoreGridSetCalculator::getGridYSize() const
{
    return gridYSize;
}

void GRAILS::DefaultInteractionScoreGridSetCalculator::setGridYSize(std::size_t size)
{
    gridYSize = size;
}

std::size_t GRAILS::DefaultInteractionScoreGridSetCalculator::getGridZSize() const
{
    return gridZSize;
}

void GRAILS::DefaultInteractionScoreGridSetCalculator::setGridZSize(std::size_t size)
{
    gridZSize = size;
}

void GRAILS::DefaultInteractionScoreGridSetCalculator::calculate(const Pharm::FeatureContainer& features, Grid::DRegularGridSet& grid_set)
{
	gridSet = &grid_set;
...
Grid::DSpatialGrid::SharedPointer GRAILS::DefaultInteractionScoreGridSetCalculator::createGrid(unsigned int ftr_type, unsigned int tgt_ftr_type) const
{
...
void GRAILS::DefaultInteractionScoreGridSetCalculator::init()
{
