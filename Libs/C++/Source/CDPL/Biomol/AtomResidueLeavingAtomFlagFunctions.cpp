...
bool Biomol::getResidueLeavingAtomFlag(const Chem::Atom& atom)
{
...
void Biomol::setResidueLeavingAtomFlag(Chem::Atom& atom, bool leaving)
{
    atom.setProperty(AtomProperty::RESIDUE_LEAVING_ATOM_FLAG, leaving);
}

void Biomol::clearResidueLeavingAtomFlag(Chem::Atom& atom)
{
    atom.removeProperty(AtomProperty::RESIDUE_LEAVING_ATOM_FLAG);
}

bool Biomol::hasResidueLeavingAtomFlag(const Chem::Atom& atom)
{
