...
bool Biomol::getHeteroAtomFlag(const Chem::Atom& atom)
{
    return atom.getProperty<bool>(AtomProperty::HETERO_ATOM_FLAG);
}

void Biomol::setHeteroAtomFlag(Chem::Atom& atom, bool is_het)
{
    atom.setProperty(AtomProperty::HETERO_ATOM_FLAG, is_het);
}

void Biomol::clearHeteroAtomFlag(Chem::Atom& atom)
{
    atom.removeProperty(AtomProperty::HETERO_ATOM_FLAG);
}

bool Biomol::hasHeteroAtomFlag(const Chem::Atom& atom)
{
