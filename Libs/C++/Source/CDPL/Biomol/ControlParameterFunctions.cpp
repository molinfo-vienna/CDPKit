...
MAKE_CONTROL_PARAM_FUNCTIONS(PDB_OUTPUT_FORMAL_CHARGES, bool, PDBOutputFormalCharges)
MAKE_CONTROL_PARAM_FUNCTIONS(PDB_OUTPUT_CONECT_RECORDS, bool, PDBOutputCONECTRecords)
MAKE_CONTROL_PARAM_FUNCTIONS(PDB_OUTPUT_CONECT_RECORDS_FOR_ALL_BONDS, bool, PDBOutputCONECTRecordsForAllBonds)
MAKE_CONTROL_PARAM_FUNCTIONS(PDB_OUTPUT_CONECT_RECORDS_REFLECTING_BOND_ORDER, bool, PDBOutputCONECTRecordsReflectingBondOrder)
...
MAKE_CONTROL_PARAM_FUNCTIONS(MMCIF_OUTPUT_DATA_POSTPROC_FUNCTION, const Biomol::MMCIFDataProcessingFunction&, MMCIFOutputDataPostprocFunction)
