...
void Biomol::setResidueInsertionCode(Chem::Atom& atom, char code)
{
    atom.setProperty(AtomProperty::RESIDUE_INSERTION_CODE, code);
}

void Biomol::clearResidueInsertionCode(Chem::Atom& atom)
{
    atom.removeProperty(AtomProperty::RESIDUE_INSERTION_CODE);
}

bool Biomol::hasResidueInsertionCode(const Chem::Atom& atom)
{
