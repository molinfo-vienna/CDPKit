...
namespace CDPL 
{
    ...
    namespace Biomol
    {
        ...
        namespace ControlParameter
        {
            ...
            CDPL_DEFINE_LOOKUP_KEY(RESIDUE_DICTIONARY);
            CDPL_DEFINE_LOOKUP_KEY(APPLY_DICT_FORMAL_CHARGES);
            CDPL_DEFINE_LOOKUP_KEY(APPLY_DICT_ATOM_TYPES);
            CDPL_DEFINE_LOOKUP_KEY(CALC_MISSING_FORMAL_CHARGES);
            CDPL_DEFINE_LOOKUP_KEY(PERCEIVE_MISSING_BOND_ORDERS);
            ...
            CDPL_DEFINE_LOOKUP_KEY(PDB_OUTPUT_FORMAL_CHARGES);
            CDPL_DEFINE_LOOKUP_KEY(PDB_OUTPUT_CONECT_RECORDS);
            CDPL_DEFINE_LOOKUP_KEY(PDB_OUTPUT_CONECT_RECORDS_FOR_ALL_BONDS);
            CDPL_DEFINE_LOOKUP_KEY(PDB_OUTPUT_CONECT_RECORDS_REFLECTING_BOND_ORDER);
            CDPL_DEFINE_LOOKUP_KEY(PDB_FORMAT_VERSION);
            CDPL_DEFINE_LOOKUP_KEY(MMCIF_APPLY_DICT_ATOM_BONDING);
            CDPL_DEFINE_LOOKUP_KEY(MMCIF_APPLY_DICT_BOND_ORDERS);
            CDPL_DEFINE_LOOKUP_KEY(MMCIF_OUTPUT_BIOPOLYMERS_AS_CHEM_COMP);
            CDPL_DEFINE_LOOKUP_KEY(MMCIF_OUTPUT_DATA_POSTPROC_FUNCTION);
        }
