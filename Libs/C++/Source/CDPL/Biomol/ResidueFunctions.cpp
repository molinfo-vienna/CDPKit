...
bool Biomol::isStandardResidue(const std::string& code)
{
	initLookupTables();
...
unsigned int Biomol::getResidueType(const std::string& code)
{	
...
const std::string& Biomol::getResidueName(const std::string& code)
{
...
const Chem::MolecularGraph* Biomol::getResidueStructure(const std::string& code)
{
	ResidueDictionaryEntry* entry = getDictionaryEntry(code);
