...
Base::DataWriter<Chem::MolecularGraph>& Biomol::CDFMolecularGraphWriter::write(const Chem::MolecularGraph& molgraph)
{
	state = false;
...
Biomol::CDFMolecularGraphWriter::operator const void*() const
{
	return (state ? this : 0);
}

bool Biomol::CDFMolecularGraphWriter::operator!() const
{
	return !state;
}
