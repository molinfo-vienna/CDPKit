...
double Chem::calcKierShape1(const MolecularGraph& molgraph)
{
...
double Chem::calcKierShape2(const MolecularGraph& molgraph)
{
	Util::BitSet h_mask(molgraph.getNumAtoms());
	std::size_t num_hvy_atoms = molgraph.getNumAtoms() - buildAtomTypeMask(molgraph, h_mask, AtomType::H);
...
double Chem::calcKierShape3(const MolecularGraph& molgraph)
{
	Util::BitSet h_mask(molgraph.getNumAtoms());
	std::size_t num_hvy_atoms = molgraph.getNumAtoms() - buildAtomTypeMask(molgraph, h_mask, AtomType::H);
