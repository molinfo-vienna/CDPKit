...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::CIPRule2.
 */

#ifndef CDPL_CHEM_CIPRULE2_HPP
#define CDPL_CHEM_CIPRULE2_HPP
...
namespace CDPL
{
    ...
    namespace Chem
    {
         ...
         * CIP Sequence Rule 2
         */
        class CIPRule2 : public CIPSequenceRule
        {
