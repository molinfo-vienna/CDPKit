...
bool Chem::FeaturePairDistanceMatchFunctor::queryMode() const
{
	return qryMode;
}

bool Chem::FeaturePairDistanceMatchFunctor::operator()(const Feature& p1_ftr1, const Feature& p1_ftr2,
