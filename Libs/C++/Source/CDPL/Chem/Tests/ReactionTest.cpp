...
//-----	
	...
	BasicReaction::SharedPointer rxn1_ptr(new BasicReaction());
	Reaction& rxn1 = *rxn1_ptr;
...
//-----
	...
	Reaction& rxn1_clone1 = *rxn1_clone1_ptr;
...
//-----
	...
	Molecule* reactant2 = &rxn1_ptr->addComponent(ReactionRole::REACTANT, comp1);
	Molecule* agent2 = &rxn1_ptr->addComponent(ReactionRole::AGENT, comp2);
	Molecule* product2 = &rxn1_ptr->addComponent(ReactionRole::PRODUCT, comp3);
...
//-----
	...
	Molecule* product3 = &rxn1_ptr->addComponent(ReactionRole::PRODUCT, comp3);
	Molecule* reactant3 = &rxn1_ptr->addComponent(ReactionRole::REACTANT,  comp1);
	Molecule* agent3 = &rxn1_ptr->addComponent(ReactionRole::AGENT, comp2);
...
//-----
	...
	Molecule* product4 = &rxn1.addComponent(ReactionRole::PRODUCT);
	Molecule* agent4 = &rxn1.addComponent(ReactionRole::AGENT);
	Molecule* reactant4 = &rxn1.addComponent(ReactionRole::REACTANT);
	Molecule* product5 = &rxn1.addComponent(ReactionRole::PRODUCT);
	Molecule* product6 = &rxn1.addComponent(ReactionRole::PRODUCT);
	Molecule* reactant5 = &rxn1.addComponent(ReactionRole::REACTANT);
...
//-----
	...
	Reaction::SharedPointer rxn2_ptr(new BasicReaction(rxn1));
	Reaction& rxn2 = *rxn2_ptr;
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn2).getComponentsBegin() == &rxn2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*const_cast<Reaction&>(rxn2).getComponentsBegin() == &rxn2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 1) == &rxn2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 1) == &rxn2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 2) == &rxn2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 2) == &rxn2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 3) == &rxn2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 3) == &rxn2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 4) == &rxn2.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 4) == &rxn2.getComponent(4, ReactionRole::REACTANT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 5) == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 5) == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 6) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 6) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 7) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 7) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 8) == &rxn2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 8) == &rxn2.getComponent(3, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 9) == &rxn2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 9) == &rxn2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 10) == &rxn2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 10) == &rxn2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 11) == &rxn2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 11) == &rxn2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 12) == &rxn2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 12) == &rxn2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 13) == &rxn2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 13) == &rxn2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 14) == &rxn2.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 14) == &rxn2.getComponent(5, ReactionRole::PRODUCT));
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) == &rxn2.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) == &rxn2.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn2.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn2.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn2.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn2.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn2.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn2.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn2.getComponent(4, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn2.getComponent(4, ReactionRole::REACTANT)); 
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) == &rxn2.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) == &rxn2.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn2.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn2.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn2.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn2.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn2.getComponent(3, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn2.getComponent(3, ReactionRole::AGENT)); 
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) == &rxn2.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) == &rxn2.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn2.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn2.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn2.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn2.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn2.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn2.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn2.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn2.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn2.getComponent(5, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn2.getComponent(5, ReactionRole::PRODUCT)); 

	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(0) == &rxn2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(0) == &rxn2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(1) == &rxn2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(1) == &rxn2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(2) == &rxn2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(2) == &rxn2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(3) == &rxn2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(3) == &rxn2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(4) == &rxn2.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(4) == &rxn2.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(5) == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(5) == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(6) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(6) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(7) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(7) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(8) == &rxn2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(8) == &rxn2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(9) == &rxn2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(9) == &rxn2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(10) == &rxn2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(10) == &rxn2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(11) == &rxn2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(11) == &rxn2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(12) == &rxn2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(12) == &rxn2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(13) == &rxn2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(13) == &rxn2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(14) == &rxn2.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(14) == &rxn2.getComponent(5, ReactionRole::PRODUCT));
...
//-----
	...
	Reaction::SharedPointer rxn6_ptr(new BasicReaction(rxn1));
	Reaction& rxn6 = *rxn6_ptr;
	...
	BOOST_CHECK(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 15 == 
				const_cast<const Reaction&>(rxn6).getComponentsEnd());
	BOOST_CHECK(const_cast<Reaction&>(rxn6).getComponentsBegin() + 15 == 
				const_cast<Reaction&>(rxn6).getComponentsEnd());

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn6).getComponentsBegin() == &rxn6.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*const_cast<Reaction&>(rxn6).getComponentsBegin() == &rxn6.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 1) == &rxn6.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 1) == &rxn6.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 2) == &rxn6.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 2) == &rxn6.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 3) == &rxn6.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 3) == &rxn6.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 4) == &rxn6.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 4) == &rxn6.getComponent(4, ReactionRole::REACTANT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 5) == &rxn6.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 5) == &rxn6.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 6) == &rxn6.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 6) == &rxn6.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 7) == &rxn6.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 7) == &rxn6.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 8) == &rxn6.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 8) == &rxn6.getComponent(3, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 9) == &rxn6.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 9) == &rxn6.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 10) == &rxn6.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 10) == &rxn6.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 11) == &rxn6.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 11) == &rxn6.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 12) == &rxn6.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 12) == &rxn6.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 13) == &rxn6.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 13) == &rxn6.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin() + 14) == &rxn6.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin() + 14) == &rxn6.getComponent(5, ReactionRole::PRODUCT));

	BOOST_CHECK(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 5 == 
				const_cast<const Reaction&>(rxn6).getComponentsEnd(ReactionRole::REACTANT));
	BOOST_CHECK(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 5 == 
				const_cast<Reaction&>(rxn6).getComponentsEnd(ReactionRole::REACTANT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) == &rxn6.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) == &rxn6.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn6.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn6.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn6.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn6.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn6.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn6.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn6.getComponent(4, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn6.getComponent(4, ReactionRole::REACTANT)); 

	BOOST_CHECK(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 4 == 
				const_cast<const Reaction&>(rxn6).getComponentsEnd(ReactionRole::AGENT));
	BOOST_CHECK(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 4 == 
				const_cast<Reaction&>(rxn6).getComponentsEnd(ReactionRole::AGENT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) == &rxn6.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) == &rxn6.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn6.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn6.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn6.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn6.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn6.getComponent(3, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn6.getComponent(3, ReactionRole::AGENT)); 

	BOOST_CHECK(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 6 == 
				const_cast<const Reaction&>(rxn6).getComponentsEnd(ReactionRole::PRODUCT));
	BOOST_CHECK(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 6 == 
				const_cast<Reaction&>(rxn6).getComponentsEnd(ReactionRole::PRODUCT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) == &rxn6.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) == &rxn6.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn6.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn6.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn6.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn6.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn6.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn6.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn6.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn6.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn6.getComponent(5, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn6).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn6.getComponent(5, ReactionRole::PRODUCT)); 

	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(0) == &rxn6.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(0) == &rxn6.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(1) == &rxn6.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(1) == &rxn6.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(2) == &rxn6.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(2) == &rxn6.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(3) == &rxn6.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(3) == &rxn6.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(4) == &rxn6.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(4) == &rxn6.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(5) == &rxn6.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(5) == &rxn6.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(6) == &rxn6.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(6) == &rxn6.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(7) == &rxn6.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(7) == &rxn6.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(8) == &rxn6.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(8) == &rxn6.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(9) == &rxn6.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(9) == &rxn6.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(10) == &rxn6.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(10) == &rxn6.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(11) == &rxn6.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(11) == &rxn6.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(12) == &rxn6.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(12) == &rxn6.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(13) == &rxn6.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(13) == &rxn6.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn6).getComponent(14) == &rxn6.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn6).getComponent(14) == &rxn6.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn6).getComponent(15), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn6).getComponent(15), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn6).getComponent(5, ReactionRole::REACTANT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn6).getComponent(5, ReactionRole::REACTANT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn6).getComponent(4, ReactionRole::AGENT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn6).getComponent(4, ReactionRole::AGENT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn6).getComponent(6, ReactionRole::PRODUCT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn6).getComponent(6, ReactionRole::PRODUCT), IndexError);
...
//-----
	...
	Reaction::SharedPointer rxn7_ptr(new BasicReaction());
	Reaction& rxn7 = *rxn7_ptr;
	...
	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 15 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd());
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin() + 15 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd());

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn7).getComponentsBegin() == &rxn7.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*const_cast<Reaction&>(rxn7).getComponentsBegin() == &rxn7.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 1) == &rxn7.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 1) == &rxn7.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 2) == &rxn7.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 2) == &rxn7.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 3) == &rxn7.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 3) == &rxn7.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 4) == &rxn7.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 4) == &rxn7.getComponent(4, ReactionRole::REACTANT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 5) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 5) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 6) == &rxn7.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 6) == &rxn7.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 7) == &rxn7.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 7) == &rxn7.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 8) == &rxn7.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 8) == &rxn7.getComponent(3, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 9) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 9) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 10) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 10) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 11) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 11) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 12) == &rxn7.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 12) == &rxn7.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 13) == &rxn7.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 13) == &rxn7.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 14) == &rxn7.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 14) == &rxn7.getComponent(5, ReactionRole::PRODUCT));

	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 5 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::REACTANT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 5 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::REACTANT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) == &rxn7.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) == &rxn7.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn7.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn7.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn7.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn7.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn7.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn7.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn7.getComponent(4, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn7.getComponent(4, ReactionRole::REACTANT)); 

	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 4 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::AGENT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 4 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::AGENT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) == &rxn7.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) == &rxn7.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn7.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn7.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn7.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn7.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn7.getComponent(3, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn7.getComponent(3, ReactionRole::AGENT)); 

	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 6 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::PRODUCT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 6 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::PRODUCT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) == &rxn7.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) == &rxn7.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn7.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn7.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn7.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn7.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn7.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn7.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn7.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn7.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn7.getComponent(5, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn7.getComponent(5, ReactionRole::PRODUCT)); 

	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(0) == &rxn7.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(0) == &rxn7.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(1) == &rxn7.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(1) == &rxn7.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(2) == &rxn7.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(2) == &rxn7.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(3) == &rxn7.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(3) == &rxn7.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(4) == &rxn7.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(4) == &rxn7.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(5) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(5) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(6) == &rxn7.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(6) == &rxn7.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(7) == &rxn7.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(7) == &rxn7.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(8) == &rxn7.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(8) == &rxn7.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(9) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(9) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(10) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(10) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(11) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(11) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(12) == &rxn7.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(12) == &rxn7.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(13) == &rxn7.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(13) == &rxn7.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(14) == &rxn7.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(14) == &rxn7.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(15), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(15), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(5, ReactionRole::REACTANT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(5, ReactionRole::REACTANT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(4, ReactionRole::AGENT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(4, ReactionRole::AGENT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(6, ReactionRole::PRODUCT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(6, ReactionRole::PRODUCT), IndexError);
...
//-----
	...
	Reaction& rxn1_clone2 = *rxn1_clone2_ptr;
	...
	BOOST_CHECK(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 15 == 
				const_cast<const Reaction&>(rxn1_clone2).getComponentsEnd());
	BOOST_CHECK(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 15 == 
				const_cast<Reaction&>(rxn1_clone2).getComponentsEnd());

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() == &rxn1_clone2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() == &rxn1_clone2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 1) == &rxn1_clone2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 1) == &rxn1_clone2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 2) == &rxn1_clone2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 2) == &rxn1_clone2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 3) == &rxn1_clone2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 3) == &rxn1_clone2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 4) == &rxn1_clone2.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 4) == &rxn1_clone2.getComponent(4, ReactionRole::REACTANT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 5) == &rxn1_clone2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 5) == &rxn1_clone2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 6) == &rxn1_clone2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 6) == &rxn1_clone2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 7) == &rxn1_clone2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 7) == &rxn1_clone2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 8) == &rxn1_clone2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 8) == &rxn1_clone2.getComponent(3, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 9) == &rxn1_clone2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 9) == &rxn1_clone2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 10) == &rxn1_clone2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 10) == &rxn1_clone2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 11) == &rxn1_clone2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 11) == &rxn1_clone2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 12) == &rxn1_clone2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 12) == &rxn1_clone2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 13) == &rxn1_clone2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 13) == &rxn1_clone2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin() + 14) == &rxn1_clone2.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin() + 14) == &rxn1_clone2.getComponent(5, ReactionRole::PRODUCT));

	BOOST_CHECK(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 5 == 
				const_cast<const Reaction&>(rxn1_clone2).getComponentsEnd(ReactionRole::REACTANT));
	BOOST_CHECK(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 5 == 
				const_cast<Reaction&>(rxn1_clone2).getComponentsEnd(ReactionRole::REACTANT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) == &rxn1_clone2.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) == &rxn1_clone2.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn1_clone2.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn1_clone2.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn1_clone2.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn1_clone2.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn1_clone2.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn1_clone2.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn1_clone2.getComponent(4, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn1_clone2.getComponent(4, ReactionRole::REACTANT)); 

	BOOST_CHECK(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 4 == 
				const_cast<const Reaction&>(rxn1_clone2).getComponentsEnd(ReactionRole::AGENT));
	BOOST_CHECK(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 4 == 
				const_cast<Reaction&>(rxn1_clone2).getComponentsEnd(ReactionRole::AGENT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) == &rxn1_clone2.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) == &rxn1_clone2.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn1_clone2.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn1_clone2.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn1_clone2.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn1_clone2.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn1_clone2.getComponent(3, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn1_clone2.getComponent(3, ReactionRole::AGENT)); 

	BOOST_CHECK(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 6 == 
				const_cast<const Reaction&>(rxn1_clone2).getComponentsEnd(ReactionRole::PRODUCT));
	BOOST_CHECK(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 6 == 
				const_cast<Reaction&>(rxn1_clone2).getComponentsEnd(ReactionRole::PRODUCT));

	BOOST_CHECK(&*const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) == &rxn1_clone2.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) == &rxn1_clone2.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn1_clone2.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn1_clone2.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn1_clone2.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn1_clone2.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn1_clone2.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn1_clone2.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn1_clone2.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn1_clone2.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn1_clone2.getComponent(5, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn1_clone2).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn1_clone2.getComponent(5, ReactionRole::PRODUCT)); 

	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(0) == &rxn1_clone2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(0) == &rxn1_clone2.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(1) == &rxn1_clone2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(1) == &rxn1_clone2.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(2) == &rxn1_clone2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(2) == &rxn1_clone2.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(3) == &rxn1_clone2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(3) == &rxn1_clone2.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(4) == &rxn1_clone2.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(4) == &rxn1_clone2.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(5) == &rxn1_clone2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(5) == &rxn1_clone2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(6) == &rxn1_clone2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(6) == &rxn1_clone2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(7) == &rxn1_clone2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(7) == &rxn1_clone2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(8) == &rxn1_clone2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(8) == &rxn1_clone2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(9) == &rxn1_clone2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(9) == &rxn1_clone2.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(10) == &rxn1_clone2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(10) == &rxn1_clone2.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(11) == &rxn1_clone2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(11) == &rxn1_clone2.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(12) == &rxn1_clone2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(12) == &rxn1_clone2.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(13) == &rxn1_clone2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(13) == &rxn1_clone2.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn1_clone2).getComponent(14) == &rxn1_clone2.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn1_clone2).getComponent(14) == &rxn1_clone2.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn1_clone2).getComponent(15), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn1_clone2).getComponent(15), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn1_clone2).getComponent(5, ReactionRole::REACTANT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn1_clone2).getComponent(5, ReactionRole::REACTANT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn1_clone2).getComponent(4, ReactionRole::AGENT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn1_clone2).getComponent(4, ReactionRole::AGENT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn1_clone2).getComponent(6, ReactionRole::PRODUCT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn1_clone2).getComponent(6, ReactionRole::PRODUCT), IndexError);
...
//-----
	...
	Reaction::SharedPointer rxn3_ptr(new BasicReaction());
	Reaction& rxn3 = *rxn3_ptr;
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn3).getComponentsBegin() == &rxn3.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*const_cast<Reaction&>(rxn3).getComponentsBegin() == &rxn3.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 1) == &rxn3.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 1) == &rxn3.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 2) == &rxn3.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 2) == &rxn3.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 3) == &rxn3.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 3) == &rxn3.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 4) == &rxn3.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 4) == &rxn3.getComponent(4, ReactionRole::REACTANT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 5) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 5) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 6) == &rxn3.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 6) == &rxn3.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 7) == &rxn3.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 7) == &rxn3.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 8) == &rxn3.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 8) == &rxn3.getComponent(3, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 9) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 9) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 10) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 10) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 11) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 11) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 12) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 12) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 13) == &rxn3.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 13) == &rxn3.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 14) == &rxn3.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 14) == &rxn3.getComponent(5, ReactionRole::PRODUCT));
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) == &rxn3.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) == &rxn3.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn3.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn3.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn3.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 2) == &rxn3.getComponent(2, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn3.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 3) == &rxn3.getComponent(3, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn3.getComponent(4, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::REACTANT) + 4) == &rxn3.getComponent(4, ReactionRole::REACTANT)); 
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) == &rxn3.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) == &rxn3.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn3.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn3.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn3.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) + 2) == &rxn3.getComponent(2, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn3.getComponent(3, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::AGENT) + 3) == &rxn3.getComponent(3, ReactionRole::AGENT)); 
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) == &rxn3.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) == &rxn3.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn3.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn3.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn3.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn3.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn3.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn3.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn3.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 4) == &rxn3.getComponent(4, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn3.getComponent(5, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin(ReactionRole::PRODUCT) + 5) == &rxn3.getComponent(5, ReactionRole::PRODUCT)); 

	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(0) == &rxn3.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(0) == &rxn3.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(1) == &rxn3.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(1) == &rxn3.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(2) == &rxn3.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(2) == &rxn3.getComponent(2, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(3) == &rxn3.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(3) == &rxn3.getComponent(3, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(4) == &rxn3.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(4) == &rxn3.getComponent(4, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(5) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(5) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(6) == &rxn3.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(6) == &rxn3.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(7) == &rxn3.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(7) == &rxn3.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(8) == &rxn3.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(8) == &rxn3.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(9) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(9) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(10) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(10) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(11) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(11) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(12) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(12) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(13) == &rxn3.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(13) == &rxn3.getComponent(4, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(14) == &rxn3.getComponent(5, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(14) == &rxn3.getComponent(5, ReactionRole::PRODUCT));
...
//-----
	...
	Molecule& rxn3_comp0 = rxn3.getComponent(0);
...
//-----
	...
	Molecule& rxn2_prod0 = rxn2.getComponent(0, ReactionRole::PRODUCT);
...
//-----
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn2).getComponentsBegin() == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*const_cast<Reaction&>(rxn2).getComponentsBegin() == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 1) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 1) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 2) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 2) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn2).getComponentsBegin() + 3) == &rxn2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn2).getComponentsBegin() + 3) == &rxn2.getComponent(3, ReactionRole::AGENT));
	...
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(0) == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(0) == &rxn2.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(1) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(1) == &rxn2.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(2) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(2) == &rxn2.getComponent(2, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn2).getComponent(3) == &rxn2.getComponent(3, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn2).getComponent(3) == &rxn2.getComponent(3, ReactionRole::AGENT));
...
//-----
	...
	Reaction::SharedPointer rxn4_ptr(new BasicReaction(rxn1));
	Reaction& rxn4 = *rxn4_ptr;
...
//-----
	...
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 2) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 2) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 3) == &rxn3.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 3) == &rxn3.getComponent(1, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 4) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 4) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 5) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 5) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 6) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 6) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn3).getComponentsBegin() + 7) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn3).getComponentsBegin() + 7) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
	...
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(1) == &rxn3.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(1) == &rxn3.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(2) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(2) == &rxn3.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(3) == &rxn3.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(3) == &rxn3.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(4) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(4) == &rxn3.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(5) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(5) == &rxn3.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(6) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(6) == &rxn3.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn3).getComponent(7) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn3).getComponent(7) == &rxn3.getComponent(3, ReactionRole::PRODUCT));
...
//-----
	...
	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 8 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd());
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin() + 8 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd());
	...
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 2) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 2) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 3) == &rxn7.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 3) == &rxn7.getComponent(1, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 4) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 4) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 5) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 5) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 6) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 6) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn7).getComponentsBegin() + 7) == &rxn7.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn7).getComponentsBegin() + 7) == &rxn7.getComponent(3, ReactionRole::PRODUCT));

	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 2 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::REACTANT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) + 2 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::REACTANT));
	...
	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 2 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::AGENT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) + 2 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::AGENT));
	...
	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 4 == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::PRODUCT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) + 4 == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::PRODUCT));
	...
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(1) == &rxn7.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(1) == &rxn7.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(2) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(2) == &rxn7.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(3) == &rxn7.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(3) == &rxn7.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(4) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(4) == &rxn7.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(5) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(5) == &rxn7.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(6) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(6) == &rxn7.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn7).getComponent(7) == &rxn7.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn7).getComponent(7) == &rxn7.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(8), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(8), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(2, ReactionRole::REACTANT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(2, ReactionRole::REACTANT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(2, ReactionRole::AGENT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(2, ReactionRole::AGENT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(4, ReactionRole::PRODUCT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(4, ReactionRole::PRODUCT), IndexError);
...
//-----
	...
	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin() == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd());
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin()  == 
				const_cast<Reaction&>(rxn7).getComponentsEnd());

	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT) == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::REACTANT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::REACTANT)  == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::REACTANT));

	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::AGENT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::AGENT) == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::AGENT));

	BOOST_CHECK(const_cast<const Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) == 
				const_cast<const Reaction&>(rxn7).getComponentsEnd(ReactionRole::PRODUCT));
	BOOST_CHECK(const_cast<Reaction&>(rxn7).getComponentsBegin(ReactionRole::PRODUCT) == 
				const_cast<Reaction&>(rxn7).getComponentsEnd(ReactionRole::PRODUCT));

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(0), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(0), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(0, ReactionRole::REACTANT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(0, ReactionRole::REACTANT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(0, ReactionRole::AGENT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(0, ReactionRole::AGENT), IndexError);

	BOOST_CHECK_THROW(const_cast<const Reaction&>(rxn7).getComponent(0, ReactionRole::PRODUCT), IndexError);
	BOOST_CHECK_THROW(const_cast<Reaction&>(rxn7).getComponent(0, ReactionRole::PRODUCT), IndexError);
...
//-----
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn4).getComponentsBegin() == &rxn4.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*const_cast<Reaction&>(rxn4).getComponentsBegin() == &rxn4.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin() + 1) == &rxn4.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin() + 1) == &rxn4.getComponent(1, ReactionRole::REACTANT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin() + 2) == &rxn4.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin() + 2) == &rxn4.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin() + 3) == &rxn4.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin() + 3) == &rxn4.getComponent(1, ReactionRole::AGENT));

	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin() + 4) == &rxn4.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin() + 4) == &rxn4.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin() + 5) == &rxn4.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin() + 5) == &rxn4.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin() + 6) == &rxn4.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin() + 6) == &rxn4.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin() + 7) == &rxn4.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin() + 7) == &rxn4.getComponent(3, ReactionRole::PRODUCT));
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::REACTANT) == &rxn4.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::REACTANT) == &rxn4.getComponent(0, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn4.getComponent(1, ReactionRole::REACTANT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::REACTANT) + 1) == &rxn4.getComponent(1, ReactionRole::REACTANT)); 
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::AGENT) == &rxn4.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::AGENT) == &rxn4.getComponent(0, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn4.getComponent(1, ReactionRole::AGENT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::AGENT) + 1) == &rxn4.getComponent(1, ReactionRole::AGENT)); 
	...
	BOOST_CHECK(&*const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) == &rxn4.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) == &rxn4.getComponent(0, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn4.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) + 1) == &rxn4.getComponent(1, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn4.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) + 2) == &rxn4.getComponent(2, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<const Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn4.getComponent(3, ReactionRole::PRODUCT)); 
	BOOST_CHECK(&*(const_cast<Reaction&>(rxn4).getComponentsBegin(ReactionRole::PRODUCT) + 3) == &rxn4.getComponent(3, ReactionRole::PRODUCT)); 

	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(0) == &rxn4.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(0) == &rxn4.getComponent(0, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(1) == &rxn4.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(1) == &rxn4.getComponent(1, ReactionRole::REACTANT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(2) == &rxn4.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(2) == &rxn4.getComponent(0, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(3) == &rxn4.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(3) == &rxn4.getComponent(1, ReactionRole::AGENT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(4) == &rxn4.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(4) == &rxn4.getComponent(0, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(5) == &rxn4.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(5) == &rxn4.getComponent(1, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(6) == &rxn4.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(6) == &rxn4.getComponent(2, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<const Reaction&>(rxn4).getComponent(7) == &rxn4.getComponent(3, ReactionRole::PRODUCT));
	BOOST_CHECK(&const_cast<Reaction&>(rxn4).getComponent(7) == &rxn4.getComponent(3, ReactionRole::PRODUCT));
...
//-----
	...
	Reaction::SharedPointer rxn5_ptr(new BasicReaction());
	Reaction& rxn5 = *rxn5_ptr;
