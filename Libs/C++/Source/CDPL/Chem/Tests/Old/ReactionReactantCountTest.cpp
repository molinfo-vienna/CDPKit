...
BOOST_AUTO_TEST_CASE(ReactionReactantCountTest)
{
	...
	BOOST_CHECK(rxn1.getProperty(ReactionProperty::REACTANT_COUNT, false, false).isEmpty());

	BOOST_CHECK(rxn1.getNumReactants() == 0);
...
//-----
	...
	BOOST_CHECK(rxn1.getNumReactants() == 1);
...
//-----
	...
	BOOST_CHECK(rxn1.getNumReactants() == 2);
...
//-----
	...
	BOOST_CHECK(rxn2.getProperty(ReactionProperty::REACTANT_COUNT, false, false).isEmpty());

	BOOST_CHECK(rxn2.getNumReactants() == 0);
...
//-----
	...
	BOOST_CHECK(rxn2.getNumReactants() == 2);
	BOOST_CHECK(rxn2.getProperty<std::size_t>(ReactionProperty::REACTANT_COUNT) == 2);
...
//-----
	...
	rxn1.removeComponent(1, ReactionRole::AGENT);
