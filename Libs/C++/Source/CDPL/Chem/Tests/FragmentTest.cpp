...
namespace
{
	...
	void checkAtomIndices(const CDPL::Chem::Fragment& frag)
	{
		for (std::size_t i = 0; i < frag.getNumAtoms(); i++)
			BOOST_CHECK(frag.getAtomIndex(frag.getAtom(i)) == i);
	}

	void checkBondIndices(const CDPL::Chem::Fragment& frag)
	{
		for (std::size_t i = 0; i < frag.getNumBonds(); i++)
			BOOST_CHECK(frag.getBondIndex(frag.getBond(i)) == i);
	}
}
...
//-----
	...
	LookupKey prop_key = LookupKey::create("key1");

	frag2.setProperty(prop_key, std::string("test 2"));

	BOOST_CHECK(frag2.getProperty<std::string>(prop_key) == "test 2");
	BOOST_CHECK(frag2.getNumProperties() == 1);

	frag2.clear();

	BOOST_CHECK_THROW(frag2.getProperty<std::string>(prop_key), ItemNotFound);
...
//-----
	...
	mol1.setProperty(prop_key, std::string("test 1"));
	frag1.setProperty(prop_key, std::string("test 2"));

	BOOST_CHECK(mol1.getProperty<std::string>(prop_key) == "test 1");
	BOOST_CHECK(frag1.getProperty<std::string>(prop_key) == "test 2");
	...
	BOOST_CHECK(frag1.getProperty<std::string>(prop_key) == "test 1");
...
//-----
	...
	BOOST_CHECK(frag3.getProperty<std::string>(prop_key) == "test 2");
...
//-----
	...
	BOOST_CHECK_THROW(frag4.getProperty<std::string>(prop_key), ItemNotFound);
...
//-----
	...
	BOOST_CHECK_THROW(frag5.getProperty<std::string>(prop_key), ItemNotFound);
...
//-----
	...
	BOOST_CHECK_THROW(frag6.getProperty<std::string>(prop_key), ItemNotFound);
