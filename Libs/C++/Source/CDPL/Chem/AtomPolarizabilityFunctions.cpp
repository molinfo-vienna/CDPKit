...
double Chem::getHybridPolarizability(const Atom& atom, const MolecularGraph& molgraph)
{
...
double Chem::calcEffectivePolarizability(const Atom& atom, const MolecularGraph& molgraph, double damping)
{
