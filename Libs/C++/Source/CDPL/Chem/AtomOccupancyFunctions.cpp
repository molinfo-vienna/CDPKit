...
double Chem::getOccupancy(const Atom& atom)
{
...
void Chem::setOccupancy(Atom& atom, double occupancy)
{
    atom.setProperty(AtomProperty::OCCUPANCY, occupancy);
}

void Chem::clearOccupancy(Atom& atom)
{
    atom.removeProperty(AtomProperty::OCCUPANCY);
}

bool Chem::hasOccupancy(const Atom& atom)
{
