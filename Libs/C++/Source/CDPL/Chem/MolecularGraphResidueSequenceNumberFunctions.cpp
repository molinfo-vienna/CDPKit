...
std::size_t Chem::getResidueSequenceNumber(const MolecularGraph& molgraph)
{
    return molgraph.getProperty<std::size_t>(MolecularGraphProperty::RESIDUE_SEQUENCE_NUMBER);
}

void Chem::setResidueSequenceNumber(MolecularGraph& molgraph, std::size_t seq_no)
{
    molgraph.setProperty(MolecularGraphProperty::RESIDUE_SEQUENCE_NUMBER, seq_no);
}

void Chem::clearResidueSequenceNumber(MolecularGraph& molgraph)
{
    molgraph.removeProperty(MolecularGraphProperty::RESIDUE_SEQUENCE_NUMBER);
}

bool Chem::hasResidueSequenceNumber(const MolecularGraph& molgraph)
{
