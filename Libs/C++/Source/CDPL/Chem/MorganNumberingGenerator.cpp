...
void Chem::MorganNumberingGenerator::NumberingState::perceiveSymClasses()
{
...
void Chem::MorganNumberingGenerator::NumberingState::distributeNumbers(std::size_t atom_idx)
{
...
void Chem::MorganNumberingGenerator::NumberingState::getNextAtomIndices(STArray& indices)
{
...
void Chem::MorganNumberingGenerator::NumberingState::addListEntriesForAtom(std::size_t from_idx, std::size_t atom_idx)
{
...
void Chem::MorganNumberingGenerator::NumberingState::copy(NumberingState& state)
{
