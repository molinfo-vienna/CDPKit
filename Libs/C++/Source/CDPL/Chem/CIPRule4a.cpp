...
int Chem::CIPRule4a::compare(const CIPDigraph::Edge& a, const CIPDigraph::Edge& b)
{
    auto ord_a = ordinal(getBondLabel(a));
    auto ord_b = ordinal(getBondLabel(b));
...
unsigned int Chem::CIPRule4a::ordinal(unsigned int descr)
{
    switch (descr) {
