...
bool Chem::getStereoCenterFlag(const Bond& bond)
{
    return bond.getProperty<bool>(BondProperty::STEREO_CENTER_FLAG);
}

void Chem::setStereoCenterFlag(Bond& bond, bool flag)
{
    bond.setProperty(BondProperty::STEREO_CENTER_FLAG, flag);
}

void Chem::clearStereoCenterFlag(Bond& bond)
{
    bond.removeProperty(BondProperty::STEREO_CENTER_FLAG);
}

bool Chem::hasStereoCenterFlag(const Bond& bond)
{
    return bond.isPropertySet(BondProperty::STEREO_CENTER_FLAG);
}
