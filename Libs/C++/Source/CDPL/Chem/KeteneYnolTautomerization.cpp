...
Chem::KeteneYnolTautomerization::KeteneYnolTautomerization(): 
	PatternBasedTautomerizationRule(TautomerizationType::KETENE_YNOL)
{
	...
	addTransformationPattern(parseSMARTS("[#8,#16,#34:1]=[#6:2]=[#6:3]-[#1:4]"), 
