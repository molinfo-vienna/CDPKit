...
Chem::AtomHydrophobicityCalculator& Chem::AtomHydrophobicityCalculator::operator=(const AtomHydrophobicityCalculator& calc)
{
    return *this;
}

void Chem::AtomHydrophobicityCalculator::setAtom3DCoordinatesFunction(const Atom3DCoordinatesFunction& func)
{
    coordsFunc = func;
}

const Chem::Atom3DCoordinatesFunction& Chem::AtomHydrophobicityCalculator::getAtom3DCoordinatesFunction() const
{
    return coordsFunc;
}

void Chem::AtomHydrophobicityCalculator::calculate(const MolecularGraph& molgraph, Util::DArray& hyd_table)
{
    init(molgraph);
...
void Chem::AtomHydrophobicityCalculator::init(const Chem::MolecularGraph& molgraph)
{
    molGraph = &molgraph;
...
void Chem::AtomHydrophobicityCalculator::calcHydrophobicities(Util::DArray& hyd_table)
{
