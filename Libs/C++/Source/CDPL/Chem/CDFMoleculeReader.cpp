...
Chem::CDFMoleculeReader::CDFMoleculeReader(std::istream& is): 
	Util::StreamDataReader<Molecule, CDFMoleculeReader>(is), reader(new CDFDataReader(*this)) {}
...
bool Chem::CDFMoleculeReader::skipData(std::istream& is)
{
	try {
