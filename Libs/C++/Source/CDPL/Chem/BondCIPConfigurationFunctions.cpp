...
unsigned int Chem::getCIPConfiguration(const Bond& bond)
{
    return bond.getProperty<unsigned int>(BondProperty::CIP_CONFIGURATION);
}

void Chem::setCIPConfiguration(Bond& bond, unsigned int config)
{
    bond.setProperty(BondProperty::CIP_CONFIGURATION, config);
}

void Chem::clearCIPConfiguration(Bond& bond)
{
    bond.removeProperty(BondProperty::CIP_CONFIGURATION);
}

bool Chem::hasCIPConfiguration(const Bond& bond)
{
    return bond.isPropertySet(BondProperty::CIP_CONFIGURATION);
}
