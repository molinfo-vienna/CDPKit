...
void Chem::PEOEChargeCalculator::setDampingFactor(double factor)
{
	dampingFactor = factor;
}

std::size_t Chem::PEOEChargeCalculator::getNumIterations() const
{
	return numIterations;
}

double Chem::PEOEChargeCalculator::getDampingFactor() const
{
...
Chem::PEOEChargeCalculator::PEOEAtomState::PEOEAtomState(const Atom& atom, const MolecularGraph& molgraph): 
	charge(0.0) 
{
	switch (getType(atom)) {
...
Chem::PEOEChargeCalculator::PEOEAtomState::PEOEAtomState(): // Implicit H
	a(7.17), b(6.24), c(-0.56), enegativity(7.17), enegativityP1(HYDROGEN_ENEGATIVITY_P1), charge(0.0) 
{}

void Chem::PEOEChargeCalculator::PEOEAtomState::linkTo(PEOEAtomState* nbr_state)
{
	nbrAtomStates.push_back(nbr_state);
}

double Chem::PEOEChargeCalculator::PEOEAtomState::getCharge() const
{
	return charge;
}

double Chem::PEOEChargeCalculator::PEOEAtomState::getElectronegativity() const
{
	return enegativity;
}

void Chem::PEOEChargeCalculator::PEOEAtomState::shiftCharges(double attenuation_fact)
{
	double q_i = 0.0;
...
void Chem::PEOEChargeCalculator::PEOEAtomState::updateElectronegativity()
{
