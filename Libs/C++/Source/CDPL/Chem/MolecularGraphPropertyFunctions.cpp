...
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(TIMESTAMP, std::time_t, Timestamp)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS_WITH_DEF(COMMENT, const std::string&, Comment)
...
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(CONFORMER_ENERGIES, const Util::DArray::SharedPointer&, ConformerEnergies)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(STRUCTURE_DATA, const Chem::StringDataBlock::SharedPointer&, StructureData)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(HASH_CODE, std::uint64_t, HashCode)
