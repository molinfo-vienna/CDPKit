...
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(CONFORMATION_ENERGIES, const Math::DVector::SharedPointer&, ConformationEnergies)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(STRUCTURE_DATA, const Chem::StringDataBlock::SharedPointer&, StructureData)
MAKE_MOLGRAPH_PROPERTY_FUNCTIONS(HASH_CODE, Base::uint64, HashCode)
