...
void Chem::setStereoDescriptor(Bond& bond, const StereoDescriptor& descr)
{
    bond.setProperty(BondProperty::STEREO_DESCRIPTOR, descr);
}

void Chem::clearStereoDescriptor(Bond& bond)
{
    bond.removeProperty(BondProperty::STEREO_DESCRIPTOR);
}

bool Chem::hasStereoDescriptor(const Bond& bond)
{
    return bond.isPropertySet(BondProperty::STEREO_DESCRIPTOR);
}
