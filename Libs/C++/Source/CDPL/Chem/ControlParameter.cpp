...
namespace CDPL 
{
    ...
    namespace Chem
    {
        ...
        namespace ControlParameter
        {
            ...
            CDPL_DEFINE_LOOKUP_KEY(MDL_ENABLE_AROMATIC_BOND_TYPES);
            ...
            CDPL_DEFINE_LOOKUP_KEY(SMILES_OUTPUT_HYDROGEN_COUNT);
            ...
            CDPL_DEFINE_LOOKUP_KEY(MOL2_READ_PARTIAL_AS_FORMAL_CHARGES);
            ...
            CDPL_DEFINE_LOOKUP_KEY(MOL2_OUTPUT_FORMAL_CHARGES);
            ...
            CDPL_DEFINE_LOOKUP_KEY(CML_ENABLE_AROMATIC_BOND_TYPES);
