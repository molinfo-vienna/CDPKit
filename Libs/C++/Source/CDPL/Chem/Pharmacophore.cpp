...
const Chem::Feature& Chem::Pharmacophore::ConstFeatureAccessor::operator()(std::size_t idx) const
{
...
Chem::Feature& Chem::Pharmacophore::FeatureAccessor::operator()(std::size_t idx) const
{
    return container.get().getFeature(idx);
}
