...
double Chem::getBFactor(const Atom& atom)
{
...
void Chem::setBFactor(Atom& atom, double factor)
{
    atom.setProperty(AtomProperty::B_FACTOR, factor);
}

void Chem::clearBFactor(Atom& atom)
{
    atom.removeProperty(AtomProperty::B_FACTOR);
}

bool Chem::hasBFactor(const Atom& atom)
{
