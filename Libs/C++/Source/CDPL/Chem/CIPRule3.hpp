...
/**
 * \file
 * \brief Definition of the class CDPL::Chem::CIPRule3.
 */

#ifndef CDPL_CHEM_CIPRULE3_HPP
#define CDPL_CHEM_CIPRULE3_HPP
...
namespace CDPL
{
    ...
    namespace Chem
    {
         ...
         */
        class CIPRule3 : public CIPSequenceRule
        {
