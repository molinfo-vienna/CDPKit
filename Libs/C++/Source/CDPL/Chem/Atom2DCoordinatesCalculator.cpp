...
Chem::Atom2DCoordinatesCalculator::Atom2DCoordinatesCalculator():
...
Chem::Atom2DCoordinatesCalculator::Atom2DCoordinatesCalculator(const MolecularGraph& molgraph, Math::Vector2DArray& coords):
    ringInfoCache(MAX_RING_INFO_CACHE_SIZE), ringSysNodeCache(MAX_RING_SYS_NODE_CACHE_SIZE), 
    atomNodeCache(MAX_ATOM_NODE_CACHE_SIZE), edgeCache(MAX_EDGE_CACHE_SIZE)
{
...
void Chem::Atom2DCoordinatesCalculator::calculate(const MolecularGraph& molgraph, Math::Vector2DArray& coords)
{
...
void Chem::Atom2DCoordinatesCalculator::init(const MolecularGraph& molgraph, Math::Vector2DArray& coords)
{
    molGraph = &molgraph;
...
void Chem::Atom2DCoordinatesCalculator::extractRingInformation()
{
    freeAllocRingInfos();
...
void Chem::Atom2DCoordinatesCalculator::calcAtomPriorities()
{
...
void Chem::Atom2DCoordinatesCalculator::calcRingPriorities()
{
...
void Chem::Atom2DCoordinatesCalculator::layoutComponents(Math::Vector2DArray& coords)
{
...
void Chem::Atom2DCoordinatesCalculator::addPoint(BoundingBox& bbox, const Math::Vector2D& pt) const
{
...
void Chem::Atom2DCoordinatesCalculator::layoutComponent(const Fragment& comp, Math::Vector2DArray& coords)
{
...
void Chem::Atom2DCoordinatesCalculator::createLayoutTree(const Fragment& comp, Math::Vector2DArray& coords)
{
...
void Chem::Atom2DCoordinatesCalculator::createRingSysNodes(const Fragment& comp, Math::Vector2DArray& coords)
{
...
void Chem::Atom2DCoordinatesCalculator::createAtomNodes(const Fragment& comp, Math::Vector2DArray& coords)
{
    freeAllocAtomNodes();
...
void Chem::Atom2DCoordinatesCalculator::createSpiroEdges(const Fragment& comp)
{
    RingSysNodeList::iterator rsys_list_end = ringSysNodeList.end();
...
void Chem::Atom2DCoordinatesCalculator::setAtomNodeChainIDs()
{
...
bool Chem::Atom2DCoordinatesCalculator::layoutChildNodes(std::size_t depth)
{
...
void Chem::Atom2DCoordinatesCalculator::freeAllocEdges()
{
    edgeList.clear();
    edgeCache.putAll();
}
...
void Chem::Atom2DCoordinatesCalculator::freeAllocRingSysNodes()
{
    ringSysNodeList.clear();
    ringSysNodeCache.putAll();
}

void Chem::Atom2DCoordinatesCalculator::freeAllocAtomNodes()
{
    atomNodeList.clear();
...
const Util::BitSet& Chem::Atom2DCoordinatesCalculator::RingInfo::getAtomMask() const
{
    return atomMask;
}

const Util::BitSet& Chem::Atom2DCoordinatesCalculator::RingInfo::getBondMask() const
{
    return bondMask;
}

double Chem::Atom2DCoordinatesCalculator::RingInfo::getPriority() const
{
    return priority;
}

void Chem::Atom2DCoordinatesCalculator::RingInfo::setPriority(double p)
{
    priority = p;
}

std::size_t Chem::Atom2DCoordinatesCalculator::RingInfo::getSize() const
{
...
const Chem::Bond* Chem::Atom2DCoordinatesCalculator::LGEdge::getBond() const
{
    return bond;
}

Chem::Atom2DCoordinatesCalculator::LGNode* Chem::Atom2DCoordinatesCalculator::LGEdge::otherNode(const LGNode* node) const
{
...
Chem::Atom2DCoordinatesCalculator::LGEdge::Type Chem::Atom2DCoordinatesCalculator::LGEdge::getType() const
{
    return type;
}    

bool Chem::Atom2DCoordinatesCalculator::LGEdge::hasConfigConstraint() const
{
    return hasConfig;
}

bool Chem::Atom2DCoordinatesCalculator::LGEdge::configConstraintFulfilled(const Math::Vector2DArray& coords) const
{
    if (!hasConfig)
        return true;
...
bool Chem::Atom2DCoordinatesCalculator::LGEdge::initConfigInfo()
{
...
void Chem::Atom2DCoordinatesCalculator::LGNode::init(const MolecularGraph* molgraph)
{
    molGraph = molgraph;
}

double Chem::Atom2DCoordinatesCalculator::LGNode::getAngularDemand(const Atom*) const
{
    return 0.0;
}
...
{
    dgCoordsGenerator.setNumCycles(75);
    dgCoordsGenerator.setLearningRateDecrement(0.99 / 75);
    dgCoordsGenerator.setCycleStepCountFactor(15.0);
}
...
const Util::BitSet& Chem::Atom2DCoordinatesCalculator::RingSysNode::getAtomMask() const
{
    return atomMask;
}

const Util::BitSet& Chem::Atom2DCoordinatesCalculator::RingSysNode::getBondMask() const
{
    return bondMask;
}

bool Chem::Atom2DCoordinatesCalculator::RingSysNode::containsAtom(std::size_t idx) const
{
    return atomMask.test(idx);
}

bool Chem::Atom2DCoordinatesCalculator::RingSysNode::addRing(const RingInfo* ring_info)
{
    tmpBitMask = bondMask;
...
double Chem::Atom2DCoordinatesCalculator::RingSysNode::getPriority() const
{
    return priority;
}

std::size_t Chem::Atom2DCoordinatesCalculator::RingSysNode::getChainID() const
{
    return (std::numeric_limits<std::size_t>::max() - 1);
}

void Chem::Atom2DCoordinatesCalculator::RingSysNode::getChildNodes(NodeList& child_nodes) const
{
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::layout(double edge_angle, const Math::Vector2D& parent_pos, 
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::layoutChildNodes(std::size_t& num_colls, std::size_t max_num_colls, bool strict)
{
    if (!parentEdge)
...
Chem::Atom2DCoordinatesCalculator::LGNode::Type Chem::Atom2DCoordinatesCalculator::RingSysNode::getType() const
{
    return RING_SYS;
}

double Chem::Atom2DCoordinatesCalculator::RingSysNode::getAngularDemand(const Atom* atom) const
{
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::setParentEdge(const LGEdge* parent_edge, Direction)
{
    assert(!parentEdge);
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::layout(std::size_t ctr_atom_idx, const Math::Vector2D& final_ctr_atom_pos, 
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::layoutChildNodes(double parent_edge_angle, double bond_length, 
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::layoutChildNodes(std::size_t depth, std::size_t& num_colls,
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::createChildLayouts()
{
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::transformCoords(std::size_t ctr_atom_idx, 
...
double Chem::Atom2DCoordinatesCalculator::RingSysNode::transformEdgeAngle(double edge_angle) const
{
    if (flipped) 
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::copyCoords()
{
    rsysRotAngle = 0.0;
    flipped = false;
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::commitAtomAndBondList() const
{
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::calcCoordsForRing(const RingInfo* ring_info)
{
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::calcCoordsForRingSegment(const RingInfo* ring_info)
{    
    std::size_t ring_size = ring_info->getSize();
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::getNextRingSegment(const RingInfo* ring_info)
{
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::performDistGeomLayout()
{
    ...
    for (auto ri : ringList) {
        ...
        addBondAngleDGConstraints(ri);
    }

    addDefaultDGConstraints();

    dgCoordsGenerator.generate(molGraph->getNumAtoms(), localCoords);
}

bool Chem::Atom2DCoordinatesCalculator::RingSysNode::needDistGeomLayout() const
{
    for (auto ri : ringList) {
...
const Chem::Atom* Chem::Atom2DCoordinatesCalculator::RingSysNode::getExoBondAtom(const RingInfo* ring_info, const Atom& atom, std::size_t rings_nbrs[2]) const
{
    ...
    auto& frag = ring_info->getFragment();
...
bool Chem::Atom2DCoordinatesCalculator::RingSysNode::addBondStereoDGConstraints(const RingInfo* ring_info)
{
    constexpr double    MC_BOND_ANGLE      = M_PI / 180.0 * 120.0;
    static const double MC_ATOM_13_DIST    = std::sin(MC_BOND_ANGLE * 0.5) * DEF_BOND_LENGTH * 2.0;
    static const double MC_CIS_ATOM_DIST   = DEF_BOND_LENGTH * (1.0 - 2.0 * std::cos(MC_BOND_ANGLE));
    static const double MC_TRANS_ATOM_DIST = std::sqrt(MC_CIS_ATOM_DIST * MC_CIS_ATOM_DIST + DEF_BOND_LENGTH * DEF_BOND_LENGTH *
                                                       4.0 * std::sin(MC_BOND_ANGLE) * std::sin(MC_BOND_ANGLE));
    bool has_trans_bond     = false;

    auto& frag = ring_info->getFragment();
    
    for (auto& bond : ring_info->getFragment().getBonds()) {
        const StereoDescriptor& descr = getStereoDescriptor(bond);
        ...
        if (config == BondConfiguration::TRANS) {
            ...
            bool flip_2nd_ctr = getExoBondAtom(ring_info, *ref_atoms[1], rings_nbrs);
           
            std::size_t flip_atom = (flip_2nd_ctr ? ctr_atom2_idx : ctr_atom1_idx);
            std::size_t flip_nbr1 = (flip_2nd_ctr ? ctr_atom1_idx : ref_atom1_idx);
            std::size_t flip_nbr2 = (flip_2nd_ctr ? ref_atom2_idx : ctr_atom2_idx);

            localCoords[flip_atom] = -localCoords[flip_atom] + localCoords[flip_nbr1] + localCoords[flip_nbr2];
        }

        double ref_atom_dist = 0.0;
        double atom_13_dist = 0.0;
        
        if (rsize < DG_MC_MIN_RING_SIZE) {
            double bond_angle = ((rsize - 2) * M_PI) / rsize;

            if (config == BondConfiguration::CIS)
                ref_atom_dist = DEF_BOND_LENGTH * (1.0 - 2.0 * std::cos(bond_angle));

            else {
                double cis_atom_dist = DEF_BOND_LENGTH * (1.0 - 2.0 * std::cos(bond_angle));

                ref_atom_dist = std::sqrt(cis_atom_dist * cis_atom_dist + DEF_BOND_LENGTH * DEF_BOND_LENGTH *
                                          4.0 * std::sin(bond_angle) * std::sin(bond_angle));
            }

            atom_13_dist = std::sin(bond_angle * 0.5) * DEF_BOND_LENGTH * 2.0;

        } else {
            ref_atom_dist = (config == BondConfiguration::CIS ? MC_CIS_ATOM_DIST : MC_TRANS_ATOM_DIST);
            atom_13_dist = MC_ATOM_13_DIST;
        }
        ...
        has_trans_bond |= (config == BondConfiguration::TRANS);
    }

    return has_trans_bond;
}           

void Chem::Atom2DCoordinatesCalculator::RingSysNode::addBondAngleDGConstraints(const RingInfo* ring_info)
{
    auto& frag = ring_info->getFragment();
    auto rsize = ring_info->getSize();    
    ...
    for (std::size_t i = 0; i < rsize; i++) {
        ...
        if (rsize < DG_MC_MIN_RING_SIZE) {
            /*
            double angle = M_PI / rsize;
            double r = DEF_BOND_LENGTH * 0.5 / std::sin(angle);

            for (std::size_t j = 3; j < rsize / 2; j++) {
                double dist_ij = r * std::sin(j * angle) * 2.0;
                auto atomj_idx = molGraph->getAtomIndex(frag.getAtom((i + j) % rsize));

                DistConstraintKey key_ij(std::min(atom1_idx, atomj_idx), std::max(atom1_idx, atomj_idx));

                if (setDistConstraints.find(key_ij) == setDistConstraints.end()) {
                    setDistConstraints.insert(key_ij);
                    dgCoordsGenerator.addDistanceConstraint(atom1_idx, atomj_idx, dist_ij * 0.0, dist_ij * 1.1);
                }
            }
            */
            continue;
        ...
        std::size_t rings_nbrs[2];
        const Atom* exo_nbr = getExoBondAtom(ring_info, atom, rings_nbrs);
        ...
        if (!atomMask.test(exo_nbr_idx)) {
            Math::Vector2D tmp = localCoords[atom1_idx] * 2 - localCoords[rings_nbrs[0]] - localCoords[rings_nbrs[1]];

            tmp *= DEF_BOND_LENGTH / length(tmp);

            localCoords[exo_nbr_idx] = localCoords[atom1_idx] + tmp;
        }
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::addDefaultDGConstraints()
{
...
{
    constexpr double SPRING_CONSTANT                 = 100.0 * DEF_BOND_LENGTH;
    constexpr double SPRING_LAYOUT_MIN_WEIGHT_FACTOR = 0.1;
    constexpr std::size_t REFERENCE_RING_SIZE        = 4;
...
Math::Vector2D Chem::Atom2DCoordinatesCalculator::RingSysNode::computePartialDerivatives(std::size_t m) const
{
...
Math::Vector2D Chem::Atom2DCoordinatesCalculator::RingSysNode::computePartialDerivative(std::size_t m, std::size_t i) const
{
    Math::Vector2D result;
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::distributeWeightFactors(std::size_t ctr_atom_idx, double factor, 
...
void Chem::Atom2DCoordinatesCalculator::RingSysNode::calcFreeSweeps()
{
...
double Chem::Atom2DCoordinatesCalculator::RingSysNode::calcCongestionFactor(const Math::Vector2D& pos) const
{
    double cf = 0.0;
...
double Chem::Atom2DCoordinatesCalculator::RingSysNode::calcCongestionFactor(const Math::Vector2D& pos, 
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::addEdge(const Atom*, const LGEdge* edge)
{
    edges.push_back(edge);
}

const Chem::Atom* Chem::Atom2DCoordinatesCalculator::AtomNode::getAtom() const
{
    return atom;
}

std::size_t Chem::Atom2DCoordinatesCalculator::AtomNode::getAtomIndex() const
{
    return atomIndex;
}

void Chem::Atom2DCoordinatesCalculator::AtomNode::getChildNodes(NodeList& child_nodes) const
{
    std::size_t num_edges = edges.size();
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::init() {}    

double Chem::Atom2DCoordinatesCalculator::AtomNode::getPriority() const
{
    return priority;
}

std::size_t Chem::Atom2DCoordinatesCalculator::AtomNode::getChainID() const
{
    return chainID;
}

void Chem::Atom2DCoordinatesCalculator::AtomNode::setChainID(std::size_t id)
{
    chainID = id;
}

void Chem::Atom2DCoordinatesCalculator::AtomNode::layout()
{
...
bool Chem::Atom2DCoordinatesCalculator::AtomNode::layout(double edge_angle, const Math::Vector2D& parent_pos, std::size_t& num_colls,
                                                        std::size_t max_num_colls, bool strict)
{
    assert(parentEdge);
...
bool Chem::Atom2DCoordinatesCalculator::AtomNode::layoutChildNodes(std::size_t& num_colls, std::size_t max_num_colls, bool strict)
{
    if (childLayouts.empty())
        return true;
...
Chem::Atom2DCoordinatesCalculator::LGNode::Type Chem::Atom2DCoordinatesCalculator::AtomNode::getType() const
{
    return type;
}        

bool Chem::Atom2DCoordinatesCalculator::AtomNode::setParentEdge(const LGEdge* parent_edge, Direction chain_dir)
{
    assert(!parentEdge);
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::layout(double edge_angle, double bond_length, const Math::Vector2D& parent_pos,
                                                        std::size_t num_colls, std::size_t max_num_colls, 
...
std::size_t Chem::Atom2DCoordinatesCalculator::AtomNode::getChildNodeTypePattern() const
{
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::createChildLayouts()
{
    switch (edges.size()) {
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::createChildLayoutsD1()
{
    if (parentEdge) {
        removeParentEdge();
        return;
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::createChildLayoutsD2()
{
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::createChildLayoutsD3()
{
    if (parentEdge) {
        removeParentEdge();
        sortChildEdges();
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::createChildLayoutsD4()
{
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::createChildLayoutsDN()
{
    EdgeList::iterator edges_beg = edges.begin();
    EdgeList::iterator edges_end = edges.end();
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::removeChildLayoutSymmetryDuplicates()
{
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::removeParentEdge()
{
    assert(parentEdge);
...
void Chem::Atom2DCoordinatesCalculator::AtomNode::sortChildEdges()
{
