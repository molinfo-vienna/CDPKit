...
MAKE_ATOM_PROPERTY_FUNCTIONS_WITH_DEF(MOL2_NAME, const std::string&, MOL2Name)
MAKE_ATOM_PROPERTY_FUNCTIONS_WITH_DEF(MOL2_CHARGE, double, MOL2Charge)
MAKE_ATOM_PROPERTY_FUNCTIONS(MOL2_SUBSTRUCTURE_ID, std::size_t, MOL2SubstructureID)
MAKE_ATOM_PROPERTY_FUNCTIONS(MOL2_SUBSTRUCTURE_NAME, const std::string&, MOL2SubstructureName)
MAKE_ATOM_PROPERTY_FUNCTIONS(MOL2_SUBSTRUCTURE_SUBTYPE, const std::string&, MOL2SubstructureSubtype)
MAKE_ATOM_PROPERTY_FUNCTIONS(MOL2_SUBSTRUCTURE_CHAIN, const std::string&, MOL2SubstructureChain)
...
MAKE_ATOM_PROPERTY_FUNCTIONS_WITH_DEF(ATOM_MAPPING_ID, std::size_t, AtomMappingID)
