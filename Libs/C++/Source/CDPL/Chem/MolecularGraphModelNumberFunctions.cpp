...
std::size_t Chem::getModelNumber(const MolecularGraph& molgraph)
{
...
void Chem::setModelNumber(MolecularGraph& molgraph, std::size_t model_no)
{
    molgraph.setProperty(MolecularGraphProperty::MODEL_NUMBER, model_no);
}

void Chem::clearModelNumber(MolecularGraph& molgraph)
{
    molgraph.removeProperty(MolecularGraphProperty::MODEL_NUMBER);
}

bool Chem::hasModelNumber(const MolecularGraph& molgraph)
{
