...
const std::size_t Chem::LogSCalculator::FEATURE_VECTOR_SIZE;
...
void Chem::LogSCalculator::countHydrophicCarbons(const MolecularGraph& molgraph)
{
...
void Chem::LogSCalculator::calcLogS(const MolecularGraph& molgraph)
{
