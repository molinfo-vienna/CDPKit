...
namespace 
{
    ...
    { Chem::AtomType::Be, 0, "Be", "Beryllium",    9,   9.012182,   2,  2, true,  false, { 2, -1 },                   1.7,  { 1.02, 0.90, 0.85 }, 1.5,  Be_IsoData }, 
    { Chem::AtomType::B,  0, "B",  "Boron",        11,  10.811,     13, 2, true,  true,  { 3, -1 },                   2.08, { 0.85, 0.78, 0.73 }, 2.0,  B_IsoData  }, 
    ...
    { Chem::AtomType::Al, 0, "Al", "Aluminium",    27,  26.981538,  13, 3, true,  false, { 3, -1 },                   2.05, { 1.26, 1.13, 1.11 }, 1.5,  Al_IsoData },
    ...
    { Chem::AtomType::Ca, 0, "Ca", "Calcium",      40,  40.078,     2,  4, true,  false, { 2, -1 },                   1.97, { 1.71, 1.47, 1.33 }, 1.0,  Ca_IsoData },  
    ...
    { Chem::AtomType::Ge, 0, "Ge", "Germanium",    74,  72.64,      14, 4, true,  true,  { 4, 2, -1 },                1.7,  { 1.21, 1.11, 1.14 }, 2.0,  Ge_IsoData },
    ...
    { Chem::AtomType::Rb, 0, "Rb", "Rubidium",     85,  85.4678,    1,  5, true,  false, { 1, -1 },                   1.7,  { 2.10, 2.02, 0 },    0.9,  Rb_IsoData },
    { Chem::AtomType::Sr, 0, "Sr", "Strontium",    88,  87.62,      2,  5, true,  false, { 2, -1 },                   1.7,  { 1.85, 1.57, 1.39 }, 1.0,  Sr_IsoData },
    ...
    { Chem::AtomType::Sb, 0, "Sb", "Antimony",     121, 121.760,    15, 5, true,  true,  { 3, 5, 4, -1 },             2.2,  { 1.40, 1.33, 1.27 }, 1.8,  Sb_IsoData },
    ...
    { Chem::AtomType::Cs, 0, "Cs", "Caesium",      133, 132.90545,  1,  6, true,  false, { 1, -1 },                   1.7,  { 2.32, 2.09, 0 },    0.9,  Cs_IsoData },
    { Chem::AtomType::Ba, 0, "Ba", "Barium",       138, 137.327,    2,  6, true,  false, { 2, -1 },                   1.7,  { 1.96, 1.61, 1.49 }, 1.0,  Ba_IsoData },
    ...
    { Chem::AtomType::Au, 0, "Au", "Gold",         197, 196.96655,  11, 6, true,  false, { 1, 3, 2, -1 },             1.44, { 1.24, 1.21, 1.23 }, 1.4,  Au_IsoData },
    { Chem::AtomType::Hg, 0, "Hg", "Mercury",      202, 200.59,     12, 6, true,  false, { 1, 2, -1 },                1.49, { 1.33, 1.42, 0 },    1.4,  Hg_IsoData },
    { Chem::AtomType::Tl, 0, "Tl", "Thallium",     205, 204.3833,   13, 6, true,  false, { 1, 3, 2, -1 },             1.69, { 1.44, 1.42, 1.50 }, 1.4,  Tl_IsoData },
    { Chem::AtomType::Pb, 0, "Pb", "Lead",         208, 207.2,      14, 6, true,  false, { 2, 4, -1 },                2.02, { 1.44, 1.35, 1.37 }, 1.6,  Pb_IsoData },
    { Chem::AtomType::Bi, 0, "Bi", "Bismuth",      209, 208.98038,  15, 6, true,  false, { 3, 2, 4, 5, -1 },          1.7,  { 1.51, 1.41, 1.35 }, 1.7,  Bi_IsoData },
    { Chem::AtomType::Po, 0, "Po", "Polonium",     209, 209.0,      16, 6, true,  true,  { 2, 4, 6, -1 },             1.7,  { 1.45, 1.35, 1.29 }, 1.8,  0          },
    { Chem::AtomType::At, 0, "At", "Astatine",     219, 210.0,      17, 6, true,  true,  { -1 },                      1.7,  { 1.47, 1.38, 1.38 }, 2.0,  0          },
    { Chem::AtomType::Rn, 0, "Rn", "Radon",        222, 222.0,      18, 6, false, true,  { -1 },                      1.7,  { 1.42, 1.45, 1.33 }, 0,    0          },
    { Chem::AtomType::Fr, 0, "Fr", "Francium",     223, 223.0,      1,  7, true,  false, { -1 },                      1.7,  { 2.23, 2.18, 0 },    0.9,  0          },
    { Chem::AtomType::Ra, 0, "Ra", "Radium",       226, 226.0,      2,  7, true,  false, { 2, -1 },                   1.7,  { 2.01, 1.73, 1.59 }, 1.0,  0          },
