...
namespace 
{
    ...
    { Chem::AtomType::H,  0, "H",  "Hydrogen",     1,   1.00794,    1,  false, true,  { 1, -1 },                   1.2,  { 0.32, 0,    0 },    2.2,  H_IsoData  },
    { Chem::AtomType::H,  1, "H",  "Hydrogen",     1,   1.00794,    1,  false, true,  { 1, -1 },                   1.2,  { 0.32, 0,    0 },    2.2,  H_IsoData  },
    { Chem::AtomType::H,  2, "D",  "Deuterium",    1,   1.00794,    1,  false, true,  { 1, -1 },                   1.2,  { 0.32, 0,    0 },    2.2,  H_IsoData  },
    { Chem::AtomType::H,  3, "T",  "Tritium",      1,   1.00794,    1,  false, true,  { 1, -1 },                   1.2,  { 0.32, 0,    0 },    2.2,  H_IsoData  },
    { Chem::AtomType::He, 0, "He", "Helium",       4,   4.002602,   18, false, true,  { -1 },                      1.4,  { 0.46, 0,    0 },    0,    He_IsoData }, 
    { Chem::AtomType::Li, 0, "Li", "Lithium",      7,   6.941,      1,  true,  false, { 1, -1 },                   1.82, { 1.33, 1.24, 0 },    1.0,  Li_IsoData }, 
    { Chem::AtomType::Be, 0, "Be", "Beryllium",    9,   9.012182,   2,  true,  false, { 2, -1 },                   1.7,  { 1.02, 0.90, 0.85 }, 1.5,  Be_IsoData }, 
    { Chem::AtomType::B,  0, "B",  "Boron",        11,  10.811,     13, true,  true,  { 3, -1 },                   2.08, { 0.85, 0.78, 0.73 }, 2.0,  B_IsoData  }, 
    { Chem::AtomType::C,  0, "C",  "Carbon",       12,  12.0107,    14, false, true,  { 4, 2, -1 },                1.7,  { 0.75, 0.67, 0.60 }, 2.5,  C_IsoData  },
    { Chem::AtomType::N,  0, "N",  "Nitrogen",     14,  14.0067,    15, false, true,  { 3, 2, 1, -1 },             1.55, { 0.71, 0.60, 0.54 }, 3.1,  N_IsoData  }, 
    { Chem::AtomType::O,  0, "O",  "Oxygen",       16,  15.9994,    16, false, true,  { 2, -1 },                   1.52, { 0.63, 0.57, 0.53 }, 3.5,  O_IsoData  }, 
    { Chem::AtomType::F,  0, "F",  "Fluorine",     19,  18.9984032, 17, false, true,  { 1, -1 },                   1.47, { 0.64, 0.59, 0.53 }, 4.1,  F_IsoData  }, 
    { Chem::AtomType::Ne, 0, "Ne", "Neon",         20,  20.1797,    18, false, true,  { -1 },                      1.54, { 0.67, 0.96, 0 },    0,    Ne_IsoData },
    { Chem::AtomType::Na, 0, "Na", "Sodium",       23,  22.98977,   1,  true,  false, { 1, -1 },                   2.27, { 1.55, 1.60, 0 },    1.0,  Na_IsoData },
    { Chem::AtomType::Mg, 0, "Mg", "Magnesium",    24,  24.3050,    2,  true,  false, { 2, -1 },                   1.73, { 1.39, 1.32, 1.27 }, 1.2,  Mg_IsoData },
    { Chem::AtomType::Al, 0, "Al", "Aluminium",    27,  26.981538,  13, true,  false, { 3, -1 },                   2.05, { 1.26, 1.13, 1.11 }, 1.5,  Al_IsoData },
    { Chem::AtomType::Si, 0, "Si", "Silicon",      28,  28.0855,    14, true,  true,  { 4, 2, -1 },                2.1,  { 1.16, 1.07, 1.02 }, 1.7,  Si_IsoData },
    { Chem::AtomType::P,  0, "P",  "Phosphorus",   31,  30.973761,  15, false, true,  { 3, 5, -1 },                1.8,  { 1.11, 1.02, 0.94 }, 2.1,  P_IsoData  },
    { Chem::AtomType::S,  0, "S",  "Sulfur",       32,  32.065,     16, false, true,  { 2, 4, 6, -1 },             1.8,  { 1.03, 0.94, 0.95 }, 2.4,  S_IsoData  },
    { Chem::AtomType::Cl, 0, "Cl", "Chlorine",     35,  35.453,     17, false, true,  { 1, 3, 5, 7, 2, 4, -1 },    1.75, { 0.99, 0.95, 0.93 }, 2.8,  Cl_IsoData },
    { Chem::AtomType::Ar, 0, "Ar", "Argon",        40,  39.948,     18, false, true,  { -1 },                      1.88, { 0.96, 1.07, 0.96 }, 0,    Ar_IsoData },
    { Chem::AtomType::K,  0, "K",  "Potassium",    39,  39.0983,    1,  true,  false, { 1, -1 },                   2.75, { 1.96, 1.93, 0 },    0.9,  K_IsoData  },  
    { Chem::AtomType::Ca, 0, "Ca", "Calcium",      40,  40.078,     2,  true,  false, { 2, -1 },                   1.97, { 1.71, 1.47, 1.33 }, 1.0,  Ca_IsoData },  
    { Chem::AtomType::Sc, 0, "Sc", "Scandium",     45,  44.95591,   3,  true,  false, { 3, -1 },                   1.7,  { 1.48, 1.16, 1.14 }, 1.2,  Sc_IsoData },
    { Chem::AtomType::Ti, 0, "Ti", "Titanium",     48,  47.867,     4,  true,  false, { 2, 3, 4, -1 },             1.7,  { 1.36, 1.17, 1.08 }, 1.3,  Ti_IsoData },
    { Chem::AtomType::V,  0, "V",  "Vanadium",     51,  50.9415,    5,  true,  false, { 2, 3, 4, 5, -1 },          1.7,  { 1.34, 1.12, 1.06 }, 1.5,  V_IsoData  },
    { Chem::AtomType::Cr, 0, "Cr", "Chromium",     52,  51.9961,    6,  true,  false, { 2, 3, 6, -1 },             1.7,  { 1.22, 1.11, 1.03 }, 1.6,  Cr_IsoData },
    { Chem::AtomType::Mn, 0, "Mn", "Manganese",    55,  54.938049,  7,  true,  false, { 2, 4, 7, 3, 6, -1 },       1.7,  { 1.19, 1.05, 1.03 }, 1.6,  Mn_IsoData },
    { Chem::AtomType::Fe, 0, "Fe", "Iron",         56,  55.845,     8,  true,  false, { 2, 3, 4, 6, -1 },          1.7,  { 1.16, 1.09, 1.02 }, 1.6,  Fe_IsoData },
    { Chem::AtomType::Co, 0, "Co", "Cobalt",       59,  58.9332,    9,  true,  false, { 2, 3, 4, -1 },             1.7,  { 1.11, 1.03, 0.96 }, 1.7,  Co_IsoData },
    { Chem::AtomType::Ni, 0, "Ni", "Nickel",       58,  58.6934,    10, true,  false, { 2, 1, 3, 4, -1 },          1.63, { 1.10, 1.01, 1.01 }, 1.8,  Ni_IsoData },
    { Chem::AtomType::Cu, 0, "Cu", "Copper",       63,  63.546,     11, true,  false, { 1, 2, 3, -1 },             1.4,  { 1.12, 1.15, 1.20 }, 1.8,  Cu_IsoData },
    { Chem::AtomType::Zn, 0, "Zn", "Zinc",         64,  65.409,     12, true,  false, { 2, -1 },                   1.39, { 1.18, 1.20, 0 },    1.7,  Zn_IsoData },
    { Chem::AtomType::Ga, 0, "Ga", "Gallium",      69,  69.723,     13, true,  false, { 3, 2, -1 },                1.87, { 1.24, 1.17, 1.21 }, 1.8,  Ga_IsoData },
    { Chem::AtomType::Ge, 0, "Ge", "Germanium",    74,  72.64,      14, true,  true,  { 4, 2, -1 },                1.7,  { 1.21, 1.11, 1.14 }, 2.0,  Ge_IsoData },
    { Chem::AtomType::As, 0, "As", "Arsenic",      75,  74.9216,    15, true,  true,  { 3, 5, 2, -1 },             1.85, { 1.21, 1.14, 1.06 }, 2.2,  As_IsoData },
    { Chem::AtomType::Se, 0, "Se", "Selenium",     80,  78.96,      16, true,  true,  { 2, 4, 6, -1 },             1.9,  { 1.16, 1.07, 1.07 }, 2.5,  Se_IsoData },
    { Chem::AtomType::Br, 0, "Br", "Bromine",      79,  79.904,     17, false, true,  { 1, 5, 3, 4, -1 },          1.85, { 1.14, 1.09, 1.10 }, 2.7,  Br_IsoData },
    { Chem::AtomType::Kr, 0, "Kr", "Krypton",      84,  83.798,     18, false, true,  { -1 },                      2.02, { 1.17, 1.21, 1.08 }, 0,    Kr_IsoData },
    { Chem::AtomType::Rb, 0, "Rb", "Rubidium",     85,  85.4678,    1,  true,  false, { 1, -1 },                   1.7,  { 2.10, 2.02, 0 },    0.9,  Rb_IsoData },
    { Chem::AtomType::Sr, 0, "Sr", "Strontium",    88,  87.62,      2,  true,  false, { 2, -1 },                   1.7,  { 1.85, 1.57, 1.39 }, 1.0,  Sr_IsoData },
    { Chem::AtomType::Y,  0, "Y" , "Yttrium",      89,  88.90585,   3,  true,  false, { 3, -1 },                   1.7,  { 1.63, 1.30, 1.24 }, 1.1,  Y_IsoData  },
    { Chem::AtomType::Zr, 0, "Zr", "Zirconium",    90,  91.224,     4,  true,  false, { 4, 2, 3, -1 },             1.7,  { 1.54, 1.27, 1.21 }, 1.2,  Zr_IsoData },
    { Chem::AtomType::Nb, 0, "Nb", "Niobium",      93,  92.90638,   5,  true,  false, { 3, 5, 2, 4, -1 },          1.7,  { 1.47, 1.25, 1.16 }, 1.2,  Nb_IsoData },
    { Chem::AtomType::Mo, 0, "Mo", "Molybdenum",   98,  95.94,      6,  true,  false, { 3, 6, 2, 4, 5, -1 },       1.7,  { 1.38, 1.21, 1.13 }, 1.3,  Mo_IsoData },
    { Chem::AtomType::Tc, 0, "Tc", "Technetium",   98,  98.0,       7,  true,  false, { 6, -1 },                   1.7,  { 1.28, 1.20, 1.10 }, 1.4,  0          },
    { Chem::AtomType::Ru, 0, "Ru", "Ruthenium",    102, 101.07,     8,  true,  false, { 3, 4, 8, 2, 6, 7, -1 },    1.7,  { 1.25, 1.14, 1.03 }, 1.4,  Ru_IsoData },
    { Chem::AtomType::Rh, 0, "Rh", "Rhodium",      103, 102.9055,   9,  true,  false, { 4, 2, 3, 6, -1 },          1.7,  { 1.25, 1.10, 1.06 }, 1.5,  Rh_IsoData },
    { Chem::AtomType::Pd, 0, "Pd", "Palladium",    106, 106.42,     10, true,  false, { 2, 4, 6, -1 },             1.63, { 1.20, 1.17, 1.12 }, 1.4,  Pd_IsoData },
    { Chem::AtomType::Ag, 0, "Ag", "Silver",       107, 107.8682,   11, true,  false, { 1, 2, 3, -1 },             1.72, { 1.28, 1.39, 1.37 }, 1.4,  Ag_IsoData },
    { Chem::AtomType::Cd, 0, "Cd", "Cadmium",      114, 112.411,    12, true,  false, { 2, 1, -1 },                1.58, { 1.36, 1.44, 0 },    1.5,  Cd_IsoData },
    { Chem::AtomType::In, 0, "In", "Indium",       115, 114.818,    13, true,  false, { 3, 1, 2, -1 },             1.93, { 1.42, 1.36, 1.46 }, 1.5,  In_IsoData },
    { Chem::AtomType::Sn, 0, "Sn", "Tin",          120, 118.710,    14, true,  false, { 4, 2, -1 },                2.17, { 1.40, 1.30, 1.32 }, 1.7,  Sn_IsoData },
    { Chem::AtomType::Sb, 0, "Sb", "Antimony",     121, 121.760,    15, true,  true,  { 3, 5, 4, -1 },             2.2,  { 1.40, 1.33, 1.27 }, 1.8,  Sb_IsoData },
    { Chem::AtomType::Te, 0, "Te", "Tellurium",    130, 127.60,     16, true,  true,  { 2, 4, 6, -1 },             2.06, { 1.36, 1.28, 1.21 }, 2.0,  Te_IsoData },
    { Chem::AtomType::I,  0, "I" , "Iodine",       127, 126.90447,  17, false, true,  { 1, 5, 7, 3, 4, -1 },       1.98, { 1.33, 1.29, 1.25 }, 2.2,  I_IsoData  },
    { Chem::AtomType::Xe, 0, "Xe", "Xenon",        132, 131.293,    18, false, true,  { -1 },                      2.16, { 1.31, 1.35, 1.22 }, 0,    Xe_IsoData },
    { Chem::AtomType::Cs, 0, "Cs", "Caesium",      133, 132.90545,  1,  true,  false, { 1, -1 },                   1.7,  { 2.32, 2.09, 0 },    0.9,  Cs_IsoData },
    { Chem::AtomType::Ba, 0, "Ba", "Barium",       138, 137.327,    2,  true,  false, { 2, -1 },                   1.7,  { 1.96, 1.61, 1.49 }, 1.0,  Ba_IsoData },
    { Chem::AtomType::La, 0, "La", "Lanthanum",    139, 138.9055,   3,  true,  false, { 3, -1 },                   1.7,  { 1.80, 1.39, 1.39 }, 1.1,  La_IsoData },
    { Chem::AtomType::Ce, 0, "Ce", "Cerium",       140, 140.116,    3,  true,  false, { 3, 4, -1 },                1.7,  { 1.63, 1.37, 1.31 }, 1.1,  Ce_IsoData },
    { Chem::AtomType::Pr, 0, "Pr", "Praseodymium", 141, 140.90765,  3,  true,  false, { 3, -1 },                   1.7,  { 1.76, 1.38, 1.28 }, 1.1,  Pr_IsoData },
    { Chem::AtomType::Nd, 0, "Nd", "Neodymium",    144, 144.24,     3,  true,  false, { 3, 4, -1 },                1.7,  { 1.74, 1.37, 0 },    1.1,  Nd_IsoData },
    { Chem::AtomType::Pm, 0, "Pm", "Promethium",   147, 145.0,      3,  true,  false, { 3, -1 },                   1.7,  { 1.73, 1.35, 0 },    1.1,  0          },
    { Chem::AtomType::Sm, 0, "Sm", "Samarium",     152, 150.36,     3,  true,  false, { 3, 2, -1 },                1.7,  { 1.72, 1.34, 0 },    1.1,  Sm_IsoData },
    { Chem::AtomType::Eu, 0, "Eu", "Europium",     153, 151.964,    3,  true,  false, { 3, 2, -1 },                1.7,  { 1.68, 1.34, 0 },    1.0,  Eu_IsoData },
    { Chem::AtomType::Gd, 0, "Gd", "Gadolinium",   158, 157.25,     3,  true,  false, { 3, -1 },                   1.7,  { 1.69, 1.35, 1.32 }, 1.1,  Gd_IsoData },
    { Chem::AtomType::Tb, 0, "Tb", "Terbium",      159, 158.92534,  3,  true,  false, { 3, 4, -1 },                1.7,  { 1.68, 1.35, 0 },    1.1,  Tb_IsoData },
    { Chem::AtomType::Dy, 0, "Dy", "Dysprosium",   164, 162.50,     3,  true,  false, { 3, -1 },                   1.7,  { 1.67, 1.33, 0 },    1.1,  Dy_IsoData },
    { Chem::AtomType::Ho, 0, "Ho", "Holmium",      165, 164.93032,  3,  true,  false, { 3, -1 },                   1.7,  { 1.66, 1.33, 0 },    1.1,  Ho_IsoData },
    { Chem::AtomType::Er, 0, "Er", "Erbium",       166, 167.259,    3,  true,  false, { 3, -1 },                   1.7,  { 1.65, 1.33, 0 },    1.1,  Er_IsoData },
    { Chem::AtomType::Tm, 0, "Tm", "Thulium",      169, 168.93421,  3,  true,  false, { 3, 2, -1 },                1.7,  { 1.64, 1.31, 0 },    1.1,  Tm_IsoData },
    { Chem::AtomType::Yb, 0, "Yb", "Ytterbium",    174, 173.04,     3,  true,  false, { 3, 2, -1 },                1.7,  { 1.70, 1.29, 0 },    1.1,  Yb_IsoData },
    { Chem::AtomType::Lu, 0, "Lu", "Lutetium",     175, 174.967,    3,  true,  false, { 3, -1 },                   1.7,  { 1.62, 1.31, 1.31 }, 1.1,  Lu_IsoData },
    { Chem::AtomType::Hf, 0, "Hf", "Hafnium",      178, 178.49,     4,  true,  false, { 4, -1 },                   1.7,  { 1.52, 1.28, 1.22 }, 1.2,  Hf_IsoData },
    { Chem::AtomType::Ta, 0, "Ta", "Tantalum",     181, 180.9479,   5,  true,  false, { 5, 3, 4, -1 },             1.7,  { 1.46, 1.26, 1.19 }, 1.3,  Ta_IsoData },
    { Chem::AtomType::W,  0, "W" , "Tungsten",     184, 183.84,     6,  true,  false, { 6, 2, 3, 4, 5, -1 },       1.7,  { 1.37, 1.20, 1.15 }, 1.4,  W_IsoData  },
    { Chem::AtomType::Re, 0, "Re", "Rhenium",      187, 186.207,    7,  true,  false, { 2, 4, 6, 7, 1, 3, 5, -1 }, 1.7,  { 1.31, 1.19, 1.10 }, 1.5,  Re_IsoData },
    { Chem::AtomType::Os, 0, "Os", "Osmium",       192, 190.23,     8,  true,  false, { 3, 4, 6, 8, 2, -1 },       1.7,  { 1.29, 1.16, 1.09 }, 1.5,  Os_IsoData },
    { Chem::AtomType::Ir, 0, "Ir", "Iridium",      193, 192.217,    9,  true,  false, { 3, 4, 6, 1, 2, -1 },       1.7,  { 1.22, 1.15, 1.07 }, 1.6,  Ir_IsoData },
    { Chem::AtomType::Pt, 0, "Pt", "Platinum",     195, 195.078,    10, true,  false, { 2, 4, 6, 1, 3, -1 },       1.75, { 1.23, 1.12, 1.10 }, 1.4,  Pt_IsoData },
    { Chem::AtomType::Au, 0, "Au", "Gold",         197, 196.96655,  11, true,  false, { 1, 3, 2, -1 },             1.44, { 1.24, 1.21, 1.23 }, 1.4,  Au_IsoData },
    { Chem::AtomType::Hg, 0, "Hg", "Mercury",      202, 200.59,     12, true,  false, { 1, 2, -1 },                1.49, { 1.33, 1.42, 0 },    1.4,  Hg_IsoData },
    { Chem::AtomType::Tl, 0, "Tl", "Thallium",     205, 204.3833,   13, true,  false, { 1, 3, 2, -1 },             1.69, { 1.44, 1.42, 1.50 }, 1.4,  Tl_IsoData },
    { Chem::AtomType::Pb, 0, "Pb", "Lead",         208, 207.2,      14, true,  false, { 2, 4, -1 },                2.02, { 1.44, 1.35, 1.37 }, 1.6,  Pb_IsoData },
    { Chem::AtomType::Bi, 0, "Bi", "Bismuth",      209, 208.98038,  15, true,  false, { 3, 2, 4, 5, -1 },          1.7,  { 1.51, 1.41, 1.35 }, 1.7,  Bi_IsoData },
    ...
    { Chem::AtomType::Th, 0, "Th", "Thorium",      232, 232.0381,   3,  true,  false, { 4, -1 },                   1.7,  { 1.75, 1.43, 1.36 }, 1.1,  Th_IsoData },
    { Chem::AtomType::Pa, 0, "Pa", "Protactinium", 231, 231.03588,  3,  true,  false, { 5, -1 },                   1.7,  { 1.69, 1.38, 1.29 }, 1.1,  0          },
    { Chem::AtomType::U,  0, "U",  "Uranium",      298, 238.02891,  3,  true,  false, { 3, 4, 6, 2, 5, -1 },       1.86, { 1.70, 1.34, 1.18 }, 1.2,  U_IsoData  },
