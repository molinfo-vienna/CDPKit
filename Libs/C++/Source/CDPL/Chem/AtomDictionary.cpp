...
namespace
{
    ...
    const AtomDictData builtinDictData[] = {
        ...
        {Chem::AtomType::Ds,  0, "Ds", "Darmstadtium",  281, 281.165,    10, 7, true,  false, {-1},                      1.7,  {1.28, 0, 0},       0,   0         },
        {Chem::AtomType::Rg,  0, "Rg", "Roentgenium",   280, 280.165,    11, 7, true,  false, {-1},                      1.7,  {1.21, 0, 0},       0,   0         },
        {Chem::AtomType::Cn,  0, "Cn", "Copernicium",   285, 285.177,    12, 7, true,  false, {-1},                      1.7,  {1.22, 0, 0},       0,   0         },
        {Chem::AtomType::Nh,  0, "Nh", "Nihonium",      286, 286.182,    13, 7, true,  false, {-1},                      1.7,  {1.36, 0, 0},       0,   0         },
...
std::size_t Chem::AtomDictionary::getNumValenceElectrons(unsigned int type)
{
    ...
    return (iupac_group < 3 ? iupac_group : iupac_group > 12 ? iupac_group - 10 :
                                                               iupac_group);
}
