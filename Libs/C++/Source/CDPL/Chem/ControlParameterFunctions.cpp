...
MAKE_CONTROL_PARAM_FUNCTIONS(MDL_ENABLE_AROMATIC_BOND_TYPES, bool, MDLEnableAromaticBondTypes)
...
MAKE_CONTROL_PARAM_FUNCTIONS(CML_ENABLE_AROMATIC_BOND_TYPES, bool, CMLEnableAromaticBondTypes);
