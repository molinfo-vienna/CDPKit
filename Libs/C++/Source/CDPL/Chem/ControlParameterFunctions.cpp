...
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_CANONICAL_FORM, bool, SMILESWriteCanonicalForm)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_KEKULE_FORM, bool, SMILESWriteKekuleForm)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_ATOM_STEREO, bool, SMILESWriteAtomStereo)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_BOND_STEREO, bool, SMILESWriteBondStereo)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_RING_BOND_STEREO, bool, SMILESWriteRingBondStereo)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_MIN_STEREO_BOND_RING_SIZE, std::size_t, SMILESMinStereoBondRingSize)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_ISOTOPE, bool, SMILESWriteIsotope)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_MOL_OUTPUT_ATOM_MAPPING_ID, bool, SMILESMolWriteAtomMappingID)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_RXN_OUTPUT_ATOM_MAPPING_ID, bool, SMILESRxnWriteAtomMappingID)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_SINGLE_BONDS, bool, SMILESWriteSingleBonds)
MAKE_CONTROL_PARAM_FUNCTIONS(SMILES_OUTPUT_AROMATIC_BONDS, bool, SMILESWriteAromaticBonds)
