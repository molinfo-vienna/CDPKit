...
const Chem::MatchExpression<Chem::Bond, Chem::MolecularGraph>::SharedPointer& Chem::getMatchExpression(const Bond& bond)
{
    return bond.getProperty<MatchExpression<Bond, MolecularGraph>::SharedPointer>(BondProperty::MATCH_EXPRESSION);
}

void Chem::setMatchExpression(Bond& bond, const MatchExpression<Bond, MolecularGraph>::SharedPointer& expr)
{
    bond.setProperty(BondProperty::MATCH_EXPRESSION, expr);
}

void Chem::clearMatchExpression(Bond& bond)
{
    bond.removeProperty(BondProperty::MATCH_EXPRESSION);
}

bool Chem::hasMatchExpression(const Bond& bond)
{
    return bond.isPropertySet(BondProperty::MATCH_EXPRESSION);
}
