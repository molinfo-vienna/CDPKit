...
namespace
{
	...
	const unsigned int UNKNOWN_ATOM_TYPE          = 101;	
...
/*
atomTypePatterns.push_back(Chem::parseSMARTS("[CH3:1]-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH3:2]-[R;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH3:3]-[X]"));
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:4](-[R;!u])-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:5](-[R;u])-[R;!u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:6](-[R;u])-[R;u]")); // (π=2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:7](-[X;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:7](-[R;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:8](-[X;!u])-[X;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:8](-[R;u])-[X;!u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:8](-[R;!u])-[X;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:9](-[X;u])-[X;u]")); // (π=2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH2:9](-[R;u])-[X;u]")); // (π=2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:10](-[R;!u])(-[R;!u])-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:11](-[R;u])(-[R;!u])-[R;!u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:12](-[R;u])(-[R;u])-[R]")); // (π≥2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[R;!u])(-[R;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[R;!u])(-[X;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[X;!u])(-[X;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[R;!u])(-[R;!u])-[X;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[R;!u])(-[R;u])-[X;!u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[R;u])(-[X;!u])-[X;!u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[R;!u])(-[X;!u])-[X;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:13](-[X;!u])(-[X;!u])-[X;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:14](-[R;u])(-[R;u])-[X]")); // (π≥2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:14](-[R;u])(-[R])-[X;u]")); // (π≥2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:14](-[R])(-[X;u])-[X;u]")); // (π≥2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:14](-[R;u])(-[X;u])-[X]")); // (π≥2)
atomTypePatterns.push_back(Chem::parseSMARTS("[CH:14](-[X;u])(-[X;u])-[X]")); // (π≥2)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:16](-[R;!u])(-[R;!u])(-[R;!u])-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:17](-[R;!u])(-[R;!u])(-[R;!u])-[R;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:18](-[R])(-[R])(-[R;u])-[R;u]")); // (π≥2)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:19](-[R;!u])(-[R;!u])(-[R;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:19](-[R;!u])(-[R;!u])(-[X;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:19](-[R;!u])(-[X;!u])(-[X;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:19](-[X;!u])(-[X;!u])(-[X;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:20](-[R])(-[R])(-[R])-[X;u]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:20](-[R])(-[R])(-[R;u])-[X]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:20](-[R])(-[R])(-[X])-[X;u]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:20](-[R])(-[R;u])(-[X])-[X]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:20](-[R])(-[X])(-[X])-[X;u]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:20](-[R;u])(-[X])(-[X])-[X]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[C:20](-[X])(-[X])(-[X])-[X;u]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[CH2:21]"));
atomTypePatterns.push_back(Chem::parseSMARTS("*=[CH:22]-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[CH:23]-[R;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[CH:24]-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[CH:25]-[X;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:26](-[R;!u])-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:27](-[R])-[R;u]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:28](-[R;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:29](-[R;u])-[X]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:29](-[R])-[X;u]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:30](-[X;!u])-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:31](-[X;u])-[X]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("c:[cH:32]:c")); // arom
atomTypePatterns.push_back(Chem::parseSMARTS("*:[cH:33]:n"));
atomTypePatterns.push_back(Chem::parseSMARTS("c:[c:34](~[R]):c"));
atomTypePatterns.push_back(Chem::parseSMARTS("c:[c:35](~[X]):c"));
atomTypePatterns.push_back(Chem::parseSMARTS("*:[c:36](~[R]):n"));
atomTypePatterns.push_back(Chem::parseSMARTS("*:[c:37](~[X]):n"));
atomTypePatterns.push_back(Chem::parseSMARTS("[R]#[CH:38]"));
atomTypePatterns.push_back(Chem::parseSMARTS("*#[C:39]-*"));
atomTypePatterns.push_back(Chem::parseSMARTS("*=[C:40]=*"));
atomTypePatterns.push_back(Chem::parseSMARTS("[R;!u]-[NH2:41]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[R;u]-[NH2:42]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[X]-[NH2:43]"));
atomTypePatterns.push_back(Chem::parseSMARTS("[R;!u]-[NH:44]-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[R;u]-[NH:45]-[R]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[R;R;u]-[NH;R:46]-[R;R;u]")); // (ring)c
atomTypePatterns.push_back(Chem::parseSMARTS("*-[NH:47]-[X]"));
atomTypePatterns.push_back(Chem::parseSMARTS("*-[NH;R:48]-[X]")); // (ring)
atomTypePatterns.push_back(Chem::parseSMARTS("[N:49](-[R;!u])(-[R;!u])-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[N:50](-[R])(-[R])-[R;u]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[N;R:51](-[R])(-[R])-[R]")); // (ring)
atomTypePatterns.push_back(Chem::parseSMARTS("[N:52](-[R])(-[R])-[X]"));
atomTypePatterns.push_back(Chem::parseSMARTS("[N:52](-[R])(-[X])-[X]"));
atomTypePatterns.push_back(Chem::parseSMARTS("[N:52](-[X])(-[X])-[X]"));
atomTypePatterns.push_back(Chem::parseSMARTS("[N;R:53](-[R])(-[R])-[X]")); // (ring)
atomTypePatterns.push_back(Chem::parseSMARTS("[N;R:53](-[R])(-[X])-[X]")); // (ring)
atomTypePatterns.push_back(Chem::parseSMARTS("[N;R:53](-[X])(-[X])-[X]")); // (ring)
atomTypePatterns.push_back(Chem::parseSMARTS("O=C(-[*,#1])-[NH2:54]"));  // amide
atomTypePatterns.push_back(Chem::parseSMARTS("O=C(-[*,#1])-[NH:55]-[R]"));
atomTypePatterns.push_back(Chem::parseSMARTS("O=C(-[*,#1])-[NH:56]-[X]"));
atomTypePatterns.push_back(Chem::parseSMARTS("O=C(-[*,#1])-[N:57](-[R])-[R]"));
atomTypePatterns.push_back(Chem::parseSMARTS("O=C(-[*,#1])-[N:58](-[R])-[X]"));
atomTypePatterns.push_back(Chem::parseSMARTS("C=[N:59]-[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("C=[N:60]-[R;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("C=[N:61]-[X;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("C=[N:62]-[X;u]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("N=[N:63]-[R]"));
atomTypePatterns.push_back(Chem::parseSMARTS("N=[N:64]-[X]"));
...
atomTypePatterns.push_back(Chem::parseSMARTS("[R;!u]–[OH:69]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[R;u]–[OH:70]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[X]–[OH:71]"));
atomTypePatterns.push_back(Chem::parseSMARTS("[R;!u]–[O:72]–[R;!u]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[R;u]–[O:73]–[R]")); // (π>0)
atomTypePatterns.push_back(Chem::parseSMARTS("[R]–[O:74]–[X]"));
...
atomTypePatterns.push_back(Chem::parseSMARTS("[*;!u]–[F:83]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[*;u]–[F:84]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[*;!u]–[Cl:85]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[*;u]–[Cl:86]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[*;!u]–[Br:87]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[*;u]–[Br:88]")); // (π=1)
atomTypePatterns.push_back(Chem::parseSMARTS("[*;!u]–[I:89]")); // (π=0)
atomTypePatterns.push_back(Chem::parseSMARTS("[*;u]–[I:90]")); // (π=1)
*/ 
...
{
	atomInfos.clear();
	atomInfos.reserve(molgraph.getNumAtoms());
...
void Chem::XLogPCalculator::calcLogP(const MolecularGraph& molgraph)
{
	std::for_each(atomInfos.begin(), atomInfos.end(),
				  boost::bind(&AtomInfo::classifyAtom, _1, boost::ref(molgraph), boost::ref(atomInfos)));
...
void Chem::XLogPCalculator::AtomInfo::classifyAtom(const MolecularGraph& molgraph, AtomInfoTable& atom_infos)
{
	analyzeAtom(molgraph, atom_infos);
...
void Chem::XLogPCalculator::AtomInfo::analyzeAtom(const MolecularGraph& molgraph, AtomInfoTable& atom_infos)
{
	if (analyzed)
		return;
				...
				if (nbr_atom_info.isClassXAtom) {
					...
					if (nbr_atom_info.atomicNo == AtomType::C) {
						if (atomicNo == AtomType::N)
							hasAmideCNbr |= nbr_atom_info.isAmideCarbon(molgraph, atom_infos);
...
bool Chem::XLogPCalculator::AtomInfo::isAmideCarbon(const MolecularGraph& molgraph, AtomInfoTable& atom_infos)
{
	analyzeAtom(molgraph, atom_infos);
