...
void Chem::clearMatchConstraints(Atom& atom)
{
    atom.removeProperty(AtomProperty::MATCH_CONSTRAINTS);
}

bool Chem::hasMatchConstraints(const Atom& atom)
{
    return atom.isPropertySet(AtomProperty::MATCH_CONSTRAINTS);
}
