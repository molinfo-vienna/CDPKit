...
bool Chem::getStereoCenterFlag(const Atom& atom)
{
    return atom.getProperty<bool>(AtomProperty::STEREO_CENTER_FLAG);
}

void Chem::setStereoCenterFlag(Atom& atom, bool flag)
{
    atom.setProperty(AtomProperty::STEREO_CENTER_FLAG, flag);
}

void Chem::clearStereoCenterFlag(Atom& atom)
{
    atom.removeProperty(AtomProperty::STEREO_CENTER_FLAG);
}

bool Chem::hasStereoCenterFlag(const Atom& atom)
{
    return atom.isPropertySet(AtomProperty::STEREO_CENTER_FLAG);
}
