...
const std::string& Chem::getMatchExpressionString(const Bond& bond)
{
    return bond.getProperty<std::string>(BondProperty::MATCH_EXPRESSION_STRING);
}

void Chem::setMatchExpressionString(Bond& bond, const std::string& expr_str)
{
    bond.setProperty(BondProperty::MATCH_EXPRESSION_STRING, expr_str);
}

void Chem::clearMatchExpressionString(Bond& bond)
{
    bond.removeProperty(BondProperty::MATCH_EXPRESSION_STRING);
}

bool Chem::hasMatchExpressionString(const Bond& bond)
{
    return bond.isPropertySet(BondProperty::MATCH_EXPRESSION_STRING);
}
