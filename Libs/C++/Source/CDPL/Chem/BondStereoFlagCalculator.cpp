...
Chem::BondStereoFlagCalculator::BondStereoFlagCalculator(): coordsFunc(&get2DCoordinates) {}

Chem::BondStereoFlagCalculator::BondStereoFlagCalculator(const MolecularGraph& molgraph, Util::UIArray& flags): coordsFunc(&get2DCoordinates)
{
    calculate(molgraph, flags);
}

void Chem::BondStereoFlagCalculator::setAtom2DCoordinatesFunction(const Atom2DCoordinatesFunction& func)
{
    coordsFunc = func;
}

const Chem::BondStereoFlagCalculator::Atom2DCoordinatesFunction& Chem::BondStereoFlagCalculator::getAtom2DCoordinatesFunction() const
{
    return coordsFunc;
}

void Chem::BondStereoFlagCalculator::calculate(const MolecularGraph& molgraph, Util::UIArray& flags)
{
    init(molgraph, flags);
...
void Chem::BondStereoFlagCalculator::assignFlagsForEitherDoubleBonds(Util::UIArray& flags)
{
    MolecularGraph::ConstBondIterator bonds_end = molGraph->getBondsEnd();
...
void Chem::BondStereoFlagCalculator::assignFlagsForIsolatedCenter(const StereoAtomInfo* stereo_atom, Util::UIArray& flags)
{
...
bool Chem::BondStereoFlagCalculator::assignFlagsForNonIsolatedCenters(std::size_t list_idx, std::size_t max_idx, Util::UIArray& flags)
{
...
void Chem::BondStereoFlagCalculator::switchStereoFlag(std::size_t bond_idx)
{
...
Chem::BondStereoFlagCalculator::StereoAtomInfo::StereoAtomInfo(const MolecularGraph* molgraph, 
...
unsigned int Chem::BondStereoFlagCalculator::StereoAtomInfo::getConfiguration() const
{
...
bool Chem::BondStereoFlagCalculator::StereoAtomInfo::hasStereoAtomNbrs() const
{
    return hasStereoNbrs;
}

bool Chem::BondStereoFlagCalculator::StereoAtomInfo::configMatches(const Util::UIArray& stereo_flags) const
{
...
std::size_t Chem::BondStereoFlagCalculator::StereoAtomInfo::getNumBonds() const
{
    return numBonds;
}

std::size_t Chem::BondStereoFlagCalculator::StereoAtomInfo::getBondIndex(std::size_t list_idx) const
{
    return orderedLigands[list_idx].second;
}

std::size_t Chem::BondStereoFlagCalculator::StereoAtomInfo::getNbrAtomIndex(std::size_t list_idx) const
{
    return molGraph->getAtomIndex(*orderedLigands[list_idx].first);
}

std::size_t Chem::BondStereoFlagCalculator::StereoAtomInfo::getAtomIndex() const
{
