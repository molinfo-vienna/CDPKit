...
/* 
 * AtomContainerGeometricalDistanceFunctions.cpp 
 *
...
double Chem::calcGeometricalRadius(const AtomContainer& cntnr)
{
...
double Chem::calcGeometricalDiameter(const AtomContainer& cntnr)
{
	double diameter = 0.0;
