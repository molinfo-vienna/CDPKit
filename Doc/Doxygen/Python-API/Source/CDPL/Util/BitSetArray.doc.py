...
class BitSetArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %BitSetArray instance \a array.
    # \param array The \c %BitSetArray instance to copy.
    # 
    ...
    # 
    # Different Python \c %BitSetArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %BitSetArray instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %BitSetArray instance \a array.
    # \param array The \c %BitSetArray instance to copy.
    # \return \a self
    # 
    ...
    # \param array The \c %BitSetArray instance to be compared with.
