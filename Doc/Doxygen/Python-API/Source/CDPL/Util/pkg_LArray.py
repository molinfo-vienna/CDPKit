...
class LArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %LArray instance.
    #
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %LArray instance \a num_elem.
    # \param num_elem The \e %LArray instance to copy.
    # \return The assignment target \a self.
    #
    ...
    # \param values 
    #
    def addElements(values: LArray) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: LArray) -> None: pass
