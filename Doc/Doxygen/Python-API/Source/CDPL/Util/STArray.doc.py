...
class STArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %STArray instance \a array.
    # \param array The \c %STArray instance to copy.
    # 
    ...
    # 
    # Different Python \c %STArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %STArray instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %STArray instance \a array.
    # \param array The \c %STArray instance to copy.
    # \return \a self
    # 
    def assign(array: STArray) -> STArray: pass
    ...
    # \param values 
    #
    def addElements(values: STArray) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: STArray) -> None: pass
    ...
    # \param array The \c %STArray instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(array: STArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(array: STArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __le__(array: STArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ge__(array: STArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __lt__(array: STArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __gt__(array: STArray) -> bool: pass
