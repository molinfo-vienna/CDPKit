...
class SArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %SArray instance \a array.
    # \param array The \e %SArray instance to copy.
    # 
    def __init__(array: SArray) -> None: pass

    ##
    # \brief Returns the numeric identifier (ID) of the wrapped C++ class instance.
    # 
    # Different Python \c %SArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %SArray instances \e a and \e b reference different C++ objects. 
    ...
    # 
    def resize(num_elem: int, value: str) -> None: pass
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %SArray instance \a array.
    # \param array The \c %SArray instance to copy.
    # \return \a self
    # 
    def assign(array: SArray) -> SArray: pass
    ...
    # 
    def assign(num_elem: int, value: str) -> None: pass
    ...
    # 
    def addElement(value: str) -> None: pass

    ##
    # \brief 
    # \param values 
    #
    def addElements(values: SArray) -> None: pass
    ...
    # 
    def insertElement(idx: int, value: str) -> None: pass
    ...
    # 
    def insertElements(idx: int, num_elem: int, value: str) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: SArray) -> None: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def getElement(idx: int) -> str: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def setElement(idx: int, value: str) -> None: pass
    ...
    # \param array The \c %SArray instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(array: SArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(array: SArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __le__(array: SArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ge__(array: SArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __lt__(array: SArray) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __gt__(array: SArray) -> bool: pass
