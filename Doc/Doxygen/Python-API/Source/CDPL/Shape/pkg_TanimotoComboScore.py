...
class TanimotoComboScore(Boost.Python.instance):
    ...
    # \param score 
    #
    def __init__(self: object, score: TanimotoComboScore) -> None: pass
    ...
    #
    def getObjectID(self: TanimotoComboScore) -> int: pass
    ...
    #
    def assign(self: TanimotoComboScore, score: TanimotoComboScore) -> TanimotoComboScore: pass
    ...
    # \return 
    #
    def __call__(self: TanimotoComboScore, res: AlignmentResult) -> float: pass
