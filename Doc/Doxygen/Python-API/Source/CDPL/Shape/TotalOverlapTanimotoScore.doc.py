...
class TotalOverlapTanimotoScore(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %TotalOverlapTanimotoScore instance \a score.
    ...
    # 
    # Different Python \c %TotalOverlapTanimotoScore instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %TotalOverlapTanimotoScore instances \e a and \e b reference different C++ objects. 
