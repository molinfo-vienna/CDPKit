...
class AlignedTotalOverlapTverskyScore(Boost.Python.instance):
    ...
    # \param self The \e %AlignedTotalOverlapTverskyScore instance to initialize.
    # \param beta 
    #
    ...
    # \param score 
    #
    def __init__(self: object, score: AlignedTotalOverlapTverskyScore) -> None: pass

    ##
    # \brief Returns the numeric identifier (ID) of the wrapped C++ class instance.
    # \param self The \e %AlignedTotalOverlapTverskyScore instance this method is called upon.
    #
    ...
    #
    def getObjectID(self: AlignedTotalOverlapTverskyScore) -> int: pass
    ...
    #
    def assign(self: AlignedTotalOverlapTverskyScore, score: AlignedTotalOverlapTverskyScore) -> AlignedTotalOverlapTverskyScore: pass
    ...
    # \return 
    #
    def __call__(self: AlignedTotalOverlapTverskyScore, res: AlignmentResult) -> float: pass
