...
class MMFF94NumericAtomTypeFunction(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94NumericAtomTypeFunction instance with a copy of the state of the \e %MMFF94NumericAtomTypeFunction instance \a func.
    # \param func The \e %MMFF94NumericAtomTypeFunction instance to copy.
    # 
