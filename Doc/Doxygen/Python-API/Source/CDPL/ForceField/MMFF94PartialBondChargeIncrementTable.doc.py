...
class MMFF94PartialBondChargeIncrementTable(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94PartialBondChargeIncrementTable instance with a copy of the state of the \e %MMFF94PartialBondChargeIncrementTable instance \a table.
