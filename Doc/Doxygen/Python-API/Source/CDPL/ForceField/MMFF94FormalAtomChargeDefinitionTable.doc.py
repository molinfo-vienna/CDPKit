...
class MMFF94FormalAtomChargeDefinitionTable(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94FormalAtomChargeDefinitionTable instance with a copy of the state of the \e %MMFF94FormalAtomChargeDefinitionTable instance \a table.
