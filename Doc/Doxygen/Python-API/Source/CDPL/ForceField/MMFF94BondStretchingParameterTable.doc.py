...
class MMFF94BondStretchingParameterTable(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94BondStretchingParameterTable instance with a copy of the state of the \e %MMFF94BondStretchingParameterTable instance \a table.
