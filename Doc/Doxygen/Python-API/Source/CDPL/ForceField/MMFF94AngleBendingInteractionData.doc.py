...
class MMFF94AngleBendingInteractionData(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94AngleBendingInteractionData instance with a copy of the state of the \e %MMFF94AngleBendingInteractionData instance \a ia_data.
    # \param ia_data The \e %MMFF94AngleBendingInteractionData instance to copy.
    # 
    def __init__(ia_data: MMFF94AngleBendingInteractionData) -> None: pass
    ...
    # \return \a self
    # 
    def assign(array: MMFF94AngleBendingInteractionData) -> MMFF94AngleBendingInteractionData: pass
    ...
    # \param values 
    #
    def addElements(values: MMFF94AngleBendingInteractionData) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: MMFF94AngleBendingInteractionData) -> None: pass
