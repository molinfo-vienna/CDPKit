...
class MMFF94VanDerWaalsInteractionParameterizer(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94VanDerWaalsInteractionParameterizer instance with a copy of the state of the \e %MMFF94VanDerWaalsInteractionParameterizer instance \a parameterizer.
    ...
    # \param strict 
    # 
    def __init__(molgraph: Chem.MolecularGraph, ia_data: MMFF94VanDerWaalsInteractionData, strict: bool) -> None: pass
    ...
    # \param strict 
    #
    def parameterize(molgraph: Chem.MolecularGraph, ia_data: MMFF94VanDerWaalsInteractionData, strict: bool) -> None: pass
