...
class MMFF94StretchBendInteractionList(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94StretchBendInteractionList instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \e %MMFF94StretchBendInteractionList instance \a ia_list.
    # \param ia_list The \e %MMFF94StretchBendInteractionList instance to copy.
    # 
