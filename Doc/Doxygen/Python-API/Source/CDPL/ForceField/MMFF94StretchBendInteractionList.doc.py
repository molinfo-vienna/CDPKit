...
##
# \brief Data structure for the storage of MMFF94 stretch-bend coupling interaction parameter records.
# 
# \see [\ref MMFF94]
# 
class MMFF94StretchBendInteractionList(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %MMFF94StretchBendInteractionList instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %MMFF94StretchBendInteractionList instance \a ia_list.
    # \param ia_list The \c %MMFF94StretchBendInteractionList instance to copy.
    # 
    def __init__(ia_list: MMFF94StretchBendInteractionList) -> None: pass

    ##
    # \brief Returns the numeric identifier (ID) of the wrapped C++ class instance.
    # 
    # Different Python \c %MMFF94StretchBendInteractionList instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %MMFF94StretchBendInteractionList instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %MMFF94StretchBendInteractionList instance \a array.
    # \param array The \c %MMFF94StretchBendInteractionList instance to copy.
    # \return \a self
    # 
