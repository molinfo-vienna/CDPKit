...
class MMFF94StretchBendInteractionList(Boost.Python.instance):
    ...
    # 
    # Different Python \e %MMFF94StretchBendInteractionList instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %MMFF94StretchBendInteractionList instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %MMFF94StretchBendInteractionList instance \a array.
    # \param array The \e %MMFF94StretchBendInteractionList instance to copy.
    # \return \a self
    # 
