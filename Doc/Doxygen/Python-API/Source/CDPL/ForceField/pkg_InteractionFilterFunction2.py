...
# \brief 
#
class InteractionFilterFunction2(Boost.Python.instance):
    ...
    # \param func 
    #
    def __init__(self: object, func: InteractionFilterFunction2) -> None: pass
    ...
    ##
    # \brief 
    # \param self The \e %InteractionFilterFunction2 instance this method is called upon.
    # \param arg1 
    # \param arg2 
    # \return 
    #
    def __call__(self: InteractionFilterFunction2, arg1: CDPL.Chem.Atom, arg2: CDPL.Chem.Atom) -> bool: pass
