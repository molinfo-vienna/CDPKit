...
class ElasticPotential(Boost.Python.instance):
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %ElasticPotential instance \a pot.
    # \param pot The \e %ElasticPotential instance to copy.
    # \return \a self
    # 
    ...
    # 
    # Different Python \e %ElasticPotential instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %ElasticPotential instances \e a and \e b reference different C++ objects. 
