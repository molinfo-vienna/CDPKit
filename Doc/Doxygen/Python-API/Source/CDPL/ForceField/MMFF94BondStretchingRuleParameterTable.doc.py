...
class MMFF94BondStretchingRuleParameterTable(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94BondStretchingRuleParameterTable instance with a copy of the state of the \e %MMFF94BondStretchingRuleParameterTable instance \a table.
