...
class MMFF94AngleBendingInteractionList(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94AngleBendingInteractionList instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \e %MMFF94AngleBendingInteractionList instance \a ia_list.
    # \param ia_list The \e %MMFF94AngleBendingInteractionList instance to copy.
    # 
    ...
    # 
    # Different Python \e %MMFF94AngleBendingInteractionList instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %MMFF94AngleBendingInteractionList instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %MMFF94AngleBendingInteractionList instance \a array.
    # \param array The \e %MMFF94AngleBendingInteractionList instance to copy.
    # \return \a self
    # 
