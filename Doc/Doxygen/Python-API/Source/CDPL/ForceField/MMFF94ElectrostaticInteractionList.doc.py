...
class MMFF94ElectrostaticInteractionList(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %MMFF94ElectrostaticInteractionList instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %MMFF94ElectrostaticInteractionList instance \a ia_list.
    # \param ia_list The \c %MMFF94ElectrostaticInteractionList instance to copy.
    # 
