...
class MMFF94StretchBendInteractionParameterizer(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94StretchBendInteractionParameterizer instance with a copy of the state of the \e %MMFF94StretchBendInteractionParameterizer instance \a parameterizer.
