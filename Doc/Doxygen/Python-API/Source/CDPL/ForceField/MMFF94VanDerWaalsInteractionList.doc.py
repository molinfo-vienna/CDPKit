...
##
# \brief Data structure for the storage of MMFF94 Van der Waals interaction parameter records.
# 
# \see [\ref MMFF94]
# 
class MMFF94VanDerWaalsInteractionList(Boost.Python.instance):
    ...
    # 
    # Different Python \c %MMFF94VanDerWaalsInteractionList instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %MMFF94VanDerWaalsInteractionList instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %MMFF94VanDerWaalsInteractionList instance \a array.
    # \param array The \c %MMFF94VanDerWaalsInteractionList instance to copy.
    # \return \a self
    # 
    def assign(array: MMFF94VanDerWaalsInteractionList) -> MMFF94VanDerWaalsInteractionList: pass
    ...
    # \param values 
    #
    def addElements(values: MMFF94VanDerWaalsInteractionList) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: MMFF94VanDerWaalsInteractionList) -> None: pass
