...
class MMFF94TorsionInteractionList(Boost.Python.instance):
    ...
    # 
    # Different Python \e %MMFF94TorsionInteractionList instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %MMFF94TorsionInteractionList instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %MMFF94TorsionInteractionList instance \a array.
    # \param array The \e %MMFF94TorsionInteractionList instance to copy.
    # \return \a self
    # 
