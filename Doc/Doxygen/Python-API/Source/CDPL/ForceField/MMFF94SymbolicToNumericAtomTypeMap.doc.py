...
class MMFF94SymbolicToNumericAtomTypeMap(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MMFF94SymbolicToNumericAtomTypeMap instance with a copy of the state of the \e %MMFF94SymbolicToNumericAtomTypeMap instance \a map.
