...
class BoolDoubleFunctor(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %BoolDoubleFunctor instance with a copy of the state of the \e %BoolDoubleFunctor instance \a func.
    ...
    # \return 
    #
    def __call__(arg1: float) -> bool: pass
