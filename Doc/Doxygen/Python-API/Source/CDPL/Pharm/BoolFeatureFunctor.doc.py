...
class BoolFeatureFunctor(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %BoolFeatureFunctor instance with a copy of the state of the \e %BoolFeatureFunctor instance \a func.
    ...
    # \return 
    #
    def __call__(arg1: Feature) -> bool: pass
