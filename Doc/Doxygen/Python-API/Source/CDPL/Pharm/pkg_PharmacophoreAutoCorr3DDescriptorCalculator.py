...
class PharmacophoreAutoCorr3DDescriptorCalculator(Boost.Python.instance):
    ...
    # \param descr 
    #
    def __init__(cntnr: FeatureContainer, descr: CDPL.Math.DVector) -> None: pass
    ...
    # \param func 
    #
    def setFeature3DCoordinatesFunction(func: Feature3DCoordinatesFunction) -> None: pass

    ##
    # \brief 
    # \param func 
    #
    def setFeaturePairWeightFunction(func: DoubleFeature2UIntFunctor) -> None: pass
    ...
    # \param descr 
    #
    def calculate(cntnr: FeatureContainer, descr: CDPL.Math.DVector) -> None: pass
