...
class DRegularGridOutputHandler(Boost.Python.instance):
    ...
    # 
    def createWriter(ios: CDPL.Base.IOStream) -> DRegularGridWriterBase: pass
    ...
    # \return A shared reference to the created Base.DataWriter instance.
    # 
    def createWriter(file_name: str, mode: OpenMode = CDPL.Base.OpenMode(60)) -> DRegularGridWriterBase: pass
