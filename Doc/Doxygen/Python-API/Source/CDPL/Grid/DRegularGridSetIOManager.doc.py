...
class DRegularGridSetIOManager(Boost.Python.instance):
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetInputHandler implementation instance registered for the specified data format, or <tt>None</tt> if not available.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetInputHandler implementation instance registered for the data format with the specified name, or <tt>None</tt> if not available. 
    # 
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetInputHandler implementation instance registered for the data format with the specified file extension, or <tt>None</tt> if not available. 
    # 
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetInputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetInputHandler implementation instance registered for the data format with the specified mime-type, or <tt>None</tt> if not available. 
    # 
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetOutputHandler implementation instance registered for the specified data format, or <tt>None</tt> if not available.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetOutputHandler implementation instance registered for the data format with the specified name, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the name is not case-sensitive.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetOutputHandler implementation instance registered for the data format with the specified file extension, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    ...
    # \param file_name Specifies the file name for which to search for a data format that matches its extension.
    # 
    # \return A reference to a Grid.DRegularGridSetOutputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Grid.DRegularGridSetOutputHandler implementation instance registered for the data format with the specified mime-type, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the mime-type is not case-sensitive.
    # 
    @staticmethod
