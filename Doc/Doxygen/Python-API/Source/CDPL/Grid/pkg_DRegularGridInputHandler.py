...
class DRegularGridInputHandler(Boost.Python.instance):
    ...
    #
    def getObjectID(self: DRegularGridInputHandler) -> int: pass
    ...
    # \return 
    #
    def getDataFormat(self: DRegularGridInputHandler) -> CDPL.Base.DataFormat: pass
    ...
    # \return 
    #
    def createReader(self: DRegularGridInputHandler, is: CDPL.Base.IStream) -> DRegularGridReader: pass
    ...
    # \return 
    #
    def createReader(self: DRegularGridInputHandler, file_name: str, mode: OpenMode = CDPL.Base.OpenMode12) -> DRegularGridReader: pass
