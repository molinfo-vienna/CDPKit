...
class DRegularGridInputHandler(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %DRegularGridInputHandler instance.
    # 
    ...
    # 
    # Different Python \c %DRegularGridInputHandler instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DRegularGridInputHandler instances \e a and \e b reference different C++ objects. 
