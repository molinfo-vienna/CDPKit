...
class HBondAcceptorAtomTyper(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %HBondAcceptorAtomTyper instance \a typer.
    # \param typer The \c %HBondAcceptorAtomTyper instance to copy.
    # 
    ...
    # 
    # Different Python \c %HBondAcceptorAtomTyper instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %HBondAcceptorAtomTyper instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %HBondAcceptorAtomTyper instance \a typer.
    # \param typer The \c %HBondAcceptorAtomTyper instance to copy.
    # \return \a self
    # 
