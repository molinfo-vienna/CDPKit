...
class BondProperty(Boost.Python.instance):
    ...
    # 
    # \valuetype  Vis.SizeSpecification \since 1.1
    # 
    ...
    # 
    # The brush specified by this property takes precedence over the brushes specified by Vis.ControlParameter.BOND_HIGHLIGHT_AREA_BRUSH and Vis.MolecularGraphProperty.BOND_HIGHLIGHT_AREA_BRUSH.
    # 
    ...
    # 
    # The pen specified by this property takes precedence over the pens specified by Vis.ControlParameter.BOND_HIGHLIGHT_AREA_OUTLINE_PEN and Vis.MolecularGraphProperty.BOND_HIGHLIGHT_AREA_OUTLINE_PEN.
    # 
