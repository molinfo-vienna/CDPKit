...
##
# \brief Implements the Vis.FontMetrics interface for the <em>Cairo</em> rendering backend.
# 
...
class CairoFontMetrics(Vis.FontMetrics):
    ...
    ##
    # \brief Constructs a <tt>CairoFontMetrics</tt> instance that operates on the <em>Cairo</em> drawing context specified by <em>cairo_ctxt</em>.
    # 
