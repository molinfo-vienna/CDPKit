...
##
# \brief Implements the Vis.Renderer2D interface on top of the <em>Cairo 2D Graphics Library</em>.
# 
# \see [\ref CAIRO] for more information about the <em>Cairo 2D Graphics Library</em>.
# 
class CairoRenderer2D(Vis.Renderer2D):

    ##
    # \brief Constructs a <tt>CairoRenderer2D</tt> instance that operates on the <em>Cairo</em> drawing context specified by <em>cairo_ctxt</em>.
    # 
