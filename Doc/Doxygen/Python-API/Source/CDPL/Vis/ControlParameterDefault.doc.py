...
class ControlParameterDefault(Boost.Python.instance):
    ...
    ##
    # \brief Default value (= <tt>1.0</tt>) of the control-parameter Vis.ControlParameter.OUTPUT_SCALING_FACTOR.
    # 
    ...
    ##
    # \brief Default value (= <tt>SizeAdjustment.IF_REQUIRED</tt>) of the control-parameter Vis.ControlParameter.SIZE_ADJUSTMENT.
    # 
    SIZE_ADJUSTMENT = 2

    ##
    # \brief Default value (= <tt>Alignment.CENTER</tt>) of the control-parameter Vis.ControlParameter.ALIGNMENT.
    # 
    ALIGNMENT = 15
    ...
    ##
    # \brief Default value (= <tt>ArrowStyle.REACTION_SOLID</tt>) of the control-parameter Vis.ControlParameter.REACTION_ARROW_STYLE.
    # 
    REACTION_ARROW_STYLE = 1

    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.REACTION_ARROW_COLOR.
    # 
    ...
    ##
    # \brief Default value (= <tt>LayoutStyle.PACKED</tt>) of the control-parameter Vis.ControlParameter.REACTION_COMPONENT_LAYOUT.
    # 
    REACTION_COMPONENT_LAYOUT = 2

    ##
    # \brief Default value (= <tt>LayoutDirection.HORIZONTAL</tt>) of the control-parameter Vis.ControlParameter.REACTION_COMPONENT_LAYOUT_DIRECTION.
    # 
    ...
    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_REACTION_REACTANTS.
    # 
    SHOW_REACTION_REACTANTS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_REACTION_AGENTS.
    # 
    SHOW_REACTION_AGENTS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_REACTION_PRODUCTS.
    # 
    SHOW_REACTION_PRODUCTS = True

    ##
    # \brief Default value (= <tt>Alignment.V_CENTER</tt>) of the control-parameter Vis.ControlParameter.REACTION_AGENT_ALIGNMENT.
    # 
    REACTION_AGENT_ALIGNMENT = 12

    ##
    # \brief Default value (= <tt>LayoutStyle.LINEAR</tt>) of the control-parameter Vis.ControlParameter.REACTION_AGENT_LAYOUT.
    # 
    REACTION_AGENT_LAYOUT = 1

    ##
    # \brief Default value (= <tt>LayoutDirection.HORIZONTAL</tt>) of the control-parameter Vis.ControlParameter.REACTION_AGENT_LAYOUT_DIRECTION.
    # 
    REACTION_AGENT_LAYOUT_DIRECTION = 0

    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.REACTION_PLUS_SIGN_COLOR.
    # 
    ...
    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_REACTION_PLUS_SIGNS.
    # 
    SHOW_REACTION_PLUS_SIGNS = True

    ##
    # \brief Default value (= <tt>False</tt>) of the control-parameter Vis.ControlParameter.USE_CALCULATED_ATOM_COORDINATES.
    # 
    ...
    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.ATOM_COLOR.
    # 
    ...
    ##
    # \brief Default value (= <tt>False</tt>) of the control-parameter Vis.ControlParameter.BREAK_ATOM_HIGHLIGHT_AREA_OUTLINE.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>False</tt>) of the control-parameter Vis.ControlParameter.SHOW_CARBONS.
    # 
    SHOW_CARBONS = False

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_EXPLICIT_HYDROGENS.
    # 
    SHOW_EXPLICIT_HYDROGENS = False

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_CHARGES.
    # 
    SHOW_CHARGES = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_ISOTOPES.
    # 
    SHOW_ISOTOPES = True

    ##
    # \brief Default value (= <tt>False</tt>) of the control-parameter Vis.ControlParameter.SHOW_HYDROGEN_COUNTS.
    # 
    SHOW_HYDROGEN_COUNTS = False

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_NON_CARBON_HYDROGEN_COUNTS.
    # 
    SHOW_NON_CARBON_HYDROGEN_COUNTS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_ATOM_QUERY_INFOS.
    # 
    SHOW_ATOM_QUERY_INFOS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_ATOM_REACTION_INFOS.
    # 
    SHOW_ATOM_REACTION_INFOS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_RADICAL_ELECTRONS.
    # 
    SHOW_RADICAL_ELECTRONS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_BOND_REACTION_INFOS.
    # 
    SHOW_BOND_REACTION_INFOS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_BOND_QUERY_INFOS.
    # 
    SHOW_BOND_QUERY_INFOS = True

    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_STEREO_BONDS.
    # 
    SHOW_STEREO_BONDS = True

    ##
    # \brief Default value (= <tt>False</tt>) of the control-parameter Vis.ControlParameter.SHOW_ATOM_CONFIGURATION_LABELS.
    # 
    # \since 1.1
    # 
    ...
    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_ATOM_CUSTOM_LABELS.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>False</tt>) of the control-parameter Vis.ControlParameter.SHOW_BOND_CONFIGURATION_LABELS.
    # 
    # \since 1.1
    # 
    ...
    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_BOND_CUSTOM_LABELS.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.ENABLE_ATOM_HIGHLIGHTING.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.ENABLE_BOND_HIGHLIGHTING.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.BOND_COLOR.
    # 
    ...
    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.ATOM_CONFIGURATION_LABEL_COLOR.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.ATOM_CUSTOM_LABEL_COLOR.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.BOND_CONFIGURATION_LABEL_COLOR.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.BOND_CUSTOM_LABEL_COLOR.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>0.0</tt>) of the control-parameter Vis.ControlParameter.GRID_VIEW_MARGIN.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>5.0</tt>) of the control-parameter Vis.ControlParameter.GRID_VIEW_CELL_PADDING.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>Color.BLACK</tt>) of the control-parameter Vis.ControlParameter.GRID_VIEW_TEXT_COLOR.
    # 
    # \since 1.2
    # 
    ...
    ##
    # \brief Default value (= <tt>True</tt>) of the control-parameter Vis.ControlParameter.SHOW_FEATURE_CENTERS.
    # 
    # \since 1.3
    # 
