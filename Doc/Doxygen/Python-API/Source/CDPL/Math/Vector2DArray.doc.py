...
class Vector2DArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %Vector2DArray instance \a array.
    # \param array The \c %Vector2DArray instance to copy.
    # 
    def __init__(array: Vector2DArray) -> None: pass

    ##
    # \brief Initializes the \c %Vector2DArray instance.
    # \param a 
    # 
    ...
    # 
    # Different Python \c %Vector2DArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector2DArray instances \e a and \e b reference different C++ objects. 
    ...
    # 
    def resize(num_elem: int, value: Vector2D) -> None: pass
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector2DArray instance \a array.
    # \param array The \c %Vector2DArray instance to copy.
    # \return \a self
    # 
    ...
    # 
    def addElement(value: Vector2D) -> None: pass

    ##
    # \brief 
    # \param values 
    #
    def addElements(values: Vector2DArray) -> None: pass
    ...
    # 
    def insertElement(idx: int, value: Vector2D) -> None: pass
    ...
    # \throw Base.IndexError if <em>idx</em> is not in the range [0, getSize()].
    # 
    def insertElements(idx: int, num_elem: int, value: Vector2D) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: Vector2DArray) -> None: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getFirstElement() -> Vector2D: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getLastElement() -> Vector2D: pass
    ...
    # \throw Base.IndexError if <em>idx</em> is not in the range [0, getSize()).
    # 
    def getElement(idx: int) -> Vector2D: pass
    ...
    # \throw Base.IndexError if <em>idx</em> is not in the range [0, getSize()).
    # 
    def setElement(idx: int, value: Vector2D) -> None: pass
    ...
    # \return 
    #
    def __getitem__(idx: int) -> Vector2D: pass
    ...
    # \param value 
    #
    def __setitem__(index: int, value: Vector2D) -> None: pass
