...
class FScalarMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %FScalarMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FScalarMatrix instances \e a and \e b reference different C++ objects. 
    ...
    # \return \a self
    # 
    def assign(m: FScalarMatrix) -> FScalarMatrix: pass

    ##
    # \brief 
    # \param m 
    #
    def swap(m: FScalarMatrix) -> None: pass
    ...
    # \param m The \c %FScalarMatrix instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(m: FScalarMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(m: FScalarMatrix) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> FScalarMatrix: pass
    ...
    # \return A \c %FScalarMatrix instance holding the result of the subtraction.
    # 
