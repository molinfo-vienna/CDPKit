...
class ConstUpperTriangularDMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstUpperTriangularDMatrixAdapter instance \a a.
    ...
    # 
    # Different Python \c %ConstUpperTriangularDMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUpperTriangularDMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUpperTriangularDMatrixAdapter instance to be compared with.
    ...
    # \return A \c %ConstUpperTriangularDMatrixAdapter instance holding the result of the subtraction.
    # 
