...
class ConstDMatrixSlice(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %ConstDMatrixSlice instance \a s.
    # \param s The \c %ConstDMatrixSlice instance to copy.
    # 
    def __init__(s: ConstDMatrixSlice) -> None: pass

    ##
    # \brief Initializes the \c %ConstDMatrixSlice instance.
    # \param e 
    # \param s1 
    # \param s2 
    # 
    ...
    # 
    # Different Python \c %ConstDMatrixSlice instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstDMatrixSlice instances \e a and \e b reference different C++ objects. 
    ...
    # \param s The \c %ConstDMatrixSlice instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstDMatrixSlice instance.
    ...
    # \return A \c %ConstDMatrixSlice instance holding the result of the subtraction.
    # 
