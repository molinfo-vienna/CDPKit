...
class Vector2F(Boost.Python.instance):
    ...
    # \param v 
    # 
    def __init__(v: Vector2F) -> None: pass
    ...
    # 
    def __eq__(v: Vector2F) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(v: Vector2F) -> bool: pass
    ...
    # \return The updated \e %Vector2F instance \a self.
    # 
    def __idiv__(t: float) -> Vector2F: pass
    ...
    # \return 
    #
    def __itruediv__(t: float) -> Vector2F: pass
