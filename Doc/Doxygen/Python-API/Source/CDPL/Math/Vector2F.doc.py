...
class Vector2F(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %Vector2F instance \a v.
    ...
    # 
    # Different Python \c %Vector2F instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector2F instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector2F instance \a v.
    # \param v The \c %Vector2F instance to copy.
    # \return \a self
    # 
    ...
    # \param v The \c %Vector2F instance to be compared with.
    ...
    # \return A \c %Vector2F instance holding the result of the subtraction.
    # 
