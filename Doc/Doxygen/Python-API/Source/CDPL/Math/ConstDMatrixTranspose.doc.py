...
class ConstDMatrixTranspose(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstDMatrixTranspose instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstDMatrixTranspose instances \e a and \e b reference different C++ objects. 
    ...
    # \param mt The \c %ConstDMatrixTranspose instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(mt: ConstDMatrixTranspose) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(mt: ConstDMatrixTranspose) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ConstDMatrixTranspose: pass
    ...
    # \return A \c %ConstDMatrixTranspose instance holding the result of the subtraction.
    # 
