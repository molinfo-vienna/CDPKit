...
class ConstUnitUpperTriangularULMatrixAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstUnitUpperTriangularULMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUnitUpperTriangularULMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUnitUpperTriangularULMatrixAdapter instance to be compared with.
    ...
    # \return A \c %ConstUnitUpperTriangularULMatrixAdapter instance holding the result of the subtraction.
    # 
