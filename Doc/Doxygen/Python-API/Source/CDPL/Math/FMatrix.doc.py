...
class FMatrix(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %FMatrix instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %FMatrix instance \a m.
    # \param m The \c %FMatrix instance to copy.
    # 
    ...
    # 
    # Different Python \c %FMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %FMatrix instance \a m.
    # \param m The \c %FMatrix instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %FMatrix instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %FMatrix instance.
    ...
    # \return A \c %FMatrix instance holding the result of the subtraction.
    # 
