...
class FIdentityMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %FIdentityMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FIdentityMatrix instances \e a and \e b reference different C++ objects. 
    ...
    # \param m The \c %FIdentityMatrix instance to be compared with.
    ...
    # \return A \c %FIdentityMatrix instance holding the result of the subtraction.
    # 
