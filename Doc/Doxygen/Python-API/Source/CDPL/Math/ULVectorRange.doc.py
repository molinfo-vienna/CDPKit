...
class ULVectorRange(Boost.Python.instance):
    ...
    # \param r 
    # 
    def __init__(e: ULVectorExpression, r: Range) -> None: pass
    ...
    # 
    # Different Python \c %ULVectorRange instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ULVectorRange instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %ULVectorRange instance \a r.
    ...
    # \param r 
    #
    def swap(r: ULVectorRange) -> None: pass
    ...
    # \param r The \c %ULVectorRange instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(r: ULVectorRange) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(r: ULVectorRange) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ULVectorRange: pass
    ...
    # \return A \c %ULVectorRange instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %ULVectorRange instance \a self.
    # 
    def __iadd__(r: ULVectorRange) -> ULVectorRange: pass
    ...
    # \return The updated \c %ULVectorRange instance \a self.
    # 
    def __isub__(r: ULVectorRange) -> ULVectorRange: pass
    ...
    # \return 
    #
    def __itruediv__(t: int) -> ULVectorRange: pass
