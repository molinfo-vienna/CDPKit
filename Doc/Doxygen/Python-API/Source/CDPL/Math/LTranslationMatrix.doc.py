...
class LTranslationMatrix(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %LTranslationMatrix instance \a m.
    # \param m The \c %LTranslationMatrix instance to copy.
    # 
    def __init__(m: LTranslationMatrix) -> None: pass

    ##
    # \brief Initializes the \c %LTranslationMatrix instance.
    # \param n 
    # \param tx 
    # \param ty 
    # \param tz 
    ...
    # 
    # Different Python \c %LTranslationMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LTranslationMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LTranslationMatrix instance \a m.
    # \param m The \c %LTranslationMatrix instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %LTranslationMatrix instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %LTranslationMatrix instance.
    ...
    # \return A \c %LTranslationMatrix instance holding the result of the subtraction.
    # 
