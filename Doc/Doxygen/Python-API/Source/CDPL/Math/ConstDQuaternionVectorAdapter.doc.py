...
class ConstDQuaternionVectorAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstDQuaternionVectorAdapter instance \a a.
    # \param a The \e %ConstDQuaternionVectorAdapter instance to copy.
    # 
    ...
    # 
    # Different Python \c %ConstDQuaternionVectorAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstDQuaternionVectorAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstDQuaternionVectorAdapter instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(a: ConstDQuaternionVectorAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstDQuaternionVectorAdapter) -> bool: pass
    ...
    # \return A \c %ConstDQuaternionVectorAdapter instance holding the result of the subtraction.
    # 
