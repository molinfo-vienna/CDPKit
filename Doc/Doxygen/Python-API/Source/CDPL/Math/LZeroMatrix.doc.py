...
class LZeroMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %LZeroMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LZeroMatrix instances \e a and \e b reference different C++ objects. 
    ...
    # \param m The \c %LZeroMatrix instance to be compared with.
    ...
    # \return A \c %LZeroMatrix instance holding the result of the subtraction.
    # 
