...
class LRotationMatrix(Boost.Python.instance):
    ...
    # \param m 
    #
    def __init__(self: object, m: LRotationMatrix) -> None: pass
    ...
    # \param uz 
    #
    def set(self: LRotationMatrix, w: int, ux: int, uy: int, uz: int) -> None: pass
    ...
    # \param n 
    #
    def resize(arg1: LRotationMatrix, n: int) -> None: pass
    ...
    #
    def getObjectID(self: LRotationMatrix) -> int: pass
    ...
    # \return 
    #
    def getSize1(self: LRotationMatrix) -> int: pass
    ...
    # \return 
    #
    def getSize2(self: LRotationMatrix) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: LRotationMatrix) -> bool: pass
    ...
    # \return 
    #
    def getElement(self: LRotationMatrix, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def toArray(self: LRotationMatrix) -> object: pass
    ...
    #
    def assign(self: LRotationMatrix, m: LRotationMatrix) -> LRotationMatrix: pass
    ...
    # \param m 
    #
    def swap(self: LRotationMatrix, m: LRotationMatrix) -> None: pass
    ...
    # \return 
    #
    def __call__(self: LRotationMatrix, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def __getitem__(self: LRotationMatrix, ij: tuple) -> int: pass
    ...
    # \return 
    #
    def __len__(self: LRotationMatrix) -> int: pass
    ...
    #
    def __eq__(self: LRotationMatrix, m: LRotationMatrix) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %LRotationMatrix instance this method is called upon.
    # \param e The \e %LRotationMatrix instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: LRotationMatrix, e: ConstLMatrixExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: LRotationMatrix, m: LRotationMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: LRotationMatrix, e: ConstLMatrixExpression) -> bool: pass
    ...
    #
    def __str__(self: LRotationMatrix) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: LRotationMatrix) -> LRotationMatrix: pass
    ...
    # \return A \e %LRotationMatrix instance holding the result of the addition.
    #
    ...
    # \return A \e %LRotationMatrix instance holding the result of the multiplication.
    #
    ...
    # \return A \e %LRotationMatrix instance holding the result of the division.
    #
