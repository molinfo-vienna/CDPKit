...
class ConstUpperTriangularFMatrixAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstUpperTriangularFMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUpperTriangularFMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUpperTriangularFMatrixAdapter instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(a: ConstUpperTriangularFMatrixAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstUpperTriangularFMatrixAdapter) -> bool: pass
    ...
    # \return A \c %ConstUpperTriangularFMatrixAdapter instance holding the result of the subtraction.
    # 
