...
class ConstLowerTriangularLMatrixAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstLowerTriangularLMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLowerTriangularLMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstLowerTriangularLMatrixAdapter instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstLowerTriangularLMatrixAdapter instance.
    ...
    # \return A \c %ConstLowerTriangularLMatrixAdapter instance holding the result of the subtraction.
    # 
