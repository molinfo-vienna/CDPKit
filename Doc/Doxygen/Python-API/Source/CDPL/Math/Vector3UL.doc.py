...
##
# \brief Bounded <em>3</em> element vector holding unsigned integers of type <tt>unsigned long</tt>.
# 
class Vector3UL(Boost.Python.instance):
    ...
    ##
    # \brief Returns a string representation of the \c %Vector3UL instance.
