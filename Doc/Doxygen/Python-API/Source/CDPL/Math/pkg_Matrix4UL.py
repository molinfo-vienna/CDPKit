...
class Matrix4UL(Boost.Python.instance):
    ...
    # \param m 
    #
    def __init__(self: object, m: Matrix4UL) -> None: pass
    ...
    # \param v 
    #
    def clear(self: Matrix4UL, v: int = 0) -> None: pass
    ...
    #
    def getObjectID(self: Matrix4UL) -> int: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %Matrix4UL instance \a e.
    # \param self The \e %Matrix4UL instance this method is called upon.
    # \param e The \e %Matrix4UL instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4UL, e: ConstFMatrixExpression) -> Matrix4UL: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4UL, e: ConstDMatrixExpression) -> Matrix4UL: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4UL, e: ConstLMatrixExpression) -> Matrix4UL: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4UL, e: ConstULMatrixExpression) -> Matrix4UL: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %Matrix4UL instance \a m.
    # \param self The \e %Matrix4UL instance this method is called upon.
    # \param m The \e %Matrix4UL instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4UL, m: Matrix4UL) -> Matrix4UL: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %Matrix4UL instance \a a.
    # \param self The \e %Matrix4UL instance this method is called upon.
    # \param a The \e %Matrix4UL instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4UL, a: object) -> None: pass
    ...
    # \return 
    #
    def getSize1(self: Matrix4UL) -> int: pass
    ...
    # \return 
    #
    def getSize2(self: Matrix4UL) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: Matrix4UL) -> bool: pass
    ...
    # \return 
    #
    def getElement(self: Matrix4UL, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def toArray(self: Matrix4UL) -> object: pass
    ...
    # \param m 
    #
    def swap(self: Matrix4UL, m: Matrix4UL) -> None: pass
    ...
    # \param v 
    #
    def setElement(self: Matrix4UL, i: int, j: int, v: int) -> None: pass
    ...
    # \return 
    #
    def __call__(self: Matrix4UL, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def __getitem__(self: Matrix4UL, ij: tuple) -> int: pass
    ...
    # \return 
    #
    def __len__(self: Matrix4UL) -> int: pass
    ...
    #
    def __eq__(self: Matrix4UL, m: Matrix4UL) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %Matrix4UL instance this method is called upon.
    # \param e The \e %Matrix4UL instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: Matrix4UL, e: ConstULMatrixExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Matrix4UL, m: Matrix4UL) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Matrix4UL, e: ConstULMatrixExpression) -> bool: pass
    ...
    #
    def __str__(self: Matrix4UL) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: Matrix4UL) -> Matrix4UL: pass
    ...
    # \return A \e %Matrix4UL instance holding the result of the addition.
    #
    ...
    # \return A \e %Matrix4UL instance holding the result of the multiplication.
    #
    ...
    # \return A \e %Matrix4UL instance holding the result of the division.
    #
    ...
    # \param v 
    #
    def __setitem__(self: Matrix4UL, ij: tuple, v: int) -> None: pass
    ...
    #
    def __iadd__(self: Matrix4UL, m: Matrix4UL) -> Matrix4UL: pass
    ...
    # \return The updated \e %Matrix4UL instance \a self.
    #
    def __iadd__(self: Matrix4UL, e: ConstULMatrixExpression) -> Matrix4UL: pass
    ...
    # \return The updated \e %Matrix4UL instance \a self.
    #
    def __isub__(self: Matrix4UL, m: Matrix4UL) -> Matrix4UL: pass
    ...
    # \return The updated \e %Matrix4UL instance \a self.
    #
    def __isub__(self: Matrix4UL, e: ConstULMatrixExpression) -> Matrix4UL: pass
    ...
    # \return The updated \e %Matrix4UL instance \a self.
    #
    def __imul__(self: Matrix4UL, t: int) -> Matrix4UL: pass
    ...
    # \return The updated \e %Matrix4UL instance \a self.
    #
    def __idiv__(self: Matrix4UL, t: int) -> Matrix4UL: pass
    ...
    # \return 
    #
    def __itruediv__(self: Matrix4UL, t: int) -> Matrix4UL: pass
