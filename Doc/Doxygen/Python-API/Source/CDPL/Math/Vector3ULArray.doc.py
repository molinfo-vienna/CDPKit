...
class Vector3ULArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %Vector3ULArray instance \a array.
    # \param array The \c %Vector3ULArray instance to copy.
    # 
    def __init__(array: Vector3ULArray) -> None: pass

    ##
    # \brief Initializes the \c %Vector3ULArray instance.
    # \param a 
    # 
    ...
    # 
    # Different Python \c %Vector3ULArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector3ULArray instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector3ULArray instance \a array.
    # \param array The \c %Vector3ULArray instance to copy.
    # \return \a self
    # 
