...
class ULRotationMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ULRotationMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ULRotationMatrix instances \e a and \e b reference different C++ objects. 
    ...
    # \param m The \c %ULRotationMatrix instance to be compared with.
    ...
    # \return A \c %ULRotationMatrix instance holding the result of the subtraction.
    # 
