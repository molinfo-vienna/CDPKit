...
##
# \brief A Math.ZeroMatrix specialization with double-precision <tt>double</tt> elements.
# 
class DZeroMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %DZeroMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DZeroMatrix instances \e a and \e b reference different C++ objects. 
    ...
    # \param m 
    #
    def swap(m: DZeroMatrix) -> None: pass
    ...
    # \param m The \c %DZeroMatrix instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(m: DZeroMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(m: DZeroMatrix) -> bool: pass
    ...
    # \return A \c %DZeroMatrix instance holding the result of the subtraction.
    # 
