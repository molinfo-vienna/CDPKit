...
class LScalingMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %LScalingMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LScalingMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LScalingMatrix instance \a m.
    ...
    # \param m The \c %LScalingMatrix instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(m: LScalingMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(m: LScalingMatrix) -> bool: pass
    ...
    # \return A \c %LScalingMatrix instance holding the result of the subtraction.
    # 
