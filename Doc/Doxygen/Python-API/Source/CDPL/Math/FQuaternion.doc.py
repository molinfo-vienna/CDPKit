...
class FQuaternion(Boost.Python.instance):
    ...
    # 
    # Different Python \c %FQuaternion instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FQuaternion instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %FQuaternion instance \a q.
    ...
    # \param q The \c %FQuaternion instance to be compared with.
    ...
    # \return A \c %FQuaternion instance holding the result of the subtraction.
    # 
