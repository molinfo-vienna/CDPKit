...
class FZeroGrid(Boost.Python.instance):
    ...
    # 
    # Different Python \c %FZeroGrid instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FZeroGrid instances \e a and \e b reference different C++ objects. 
    ...
    # \param g The \c %FZeroGrid instance to be compared with.
    ...
    # \return A \c %FZeroGrid instance holding the result of the subtraction.
    # 
