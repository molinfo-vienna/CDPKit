...
class ConstLMatrixRange(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %ConstLMatrixRange instance \a r.
    # \param r The \c %ConstLMatrixRange instance to copy.
    # 
    def __init__(r: ConstLMatrixRange) -> None: pass

    ##
    # \brief Initializes the \c %ConstLMatrixRange instance.
    # \param e 
    # \param r1 
    # \param r2 
    # 
    ...
    # 
    # Different Python \c %ConstLMatrixRange instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLMatrixRange instances \e a and \e b reference different C++ objects. 
    ...
    # \param r The \c %ConstLMatrixRange instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstLMatrixRange instance.
    ...
    # \return 
    #
    def __pos__() -> ConstLMatrixRange: pass
    ...
    # \return A \c %ConstLMatrixRange instance holding the result of the subtraction.
    # 
