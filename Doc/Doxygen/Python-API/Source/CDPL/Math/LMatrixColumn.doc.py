...
class LMatrixColumn(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %LMatrixColumn instance \a mc.
    # \param mc The \c %LMatrixColumn instance to copy.
    # 
    def __init__(mc: LMatrixColumn) -> None: pass

    ##
    # \brief Initializes the \c %LMatrixColumn instance.
    # \param e 
    # \param i 
    # 
    ...
    # 
    # Different Python \c %LMatrixColumn instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LMatrixColumn instances \e a and \e b reference different C++ objects. 
    ...
    # \param c The \c %LMatrixColumn instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %LMatrixColumn instance.
    ...
    # \return A \c %LMatrixColumn instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %LMatrixColumn instance \a self.
    # 
    def __iadd__(c: LMatrixColumn) -> LMatrixColumn: pass

    ##
    # \brief Adds the elements of the vector expression <em>e</em> to this column (via a temporary to handle aliasing).
    # 
    # \param e The source vector expression.
    # 
    # \return \a self
    ...
    ##
    # \brief Subtracts the elements of the vector expression <em>e</em> from this column (via a temporary to handle aliasing).
    # 
    # \param e The source vector expression.
    # 
    # \return \a self
    ...
    ##
    # \brief Multiplies every element of this column by the scalar <em>t</em>.
    # 
