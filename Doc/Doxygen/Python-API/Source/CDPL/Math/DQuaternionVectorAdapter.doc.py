...
class DQuaternionVectorAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %DQuaternionVectorAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DQuaternionVectorAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %DQuaternionVectorAdapter instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(a: DQuaternionVectorAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: DQuaternionVectorAdapter) -> bool: pass
    ...
    # \return A \c %DQuaternionVectorAdapter instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %DQuaternionVectorAdapter instance \a self.
    # 
    def __iadd__(a: DQuaternionVectorAdapter) -> DQuaternionVectorAdapter: pass
    ...
    # \return The updated \c %DQuaternionVectorAdapter instance \a self.
    # 
    def __isub__(a: DQuaternionVectorAdapter) -> DQuaternionVectorAdapter: pass
