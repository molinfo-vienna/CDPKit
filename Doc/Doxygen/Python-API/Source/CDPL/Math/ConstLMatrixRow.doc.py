...
class ConstLMatrixRow(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstLMatrixRow instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLMatrixRow instances \e a and \e b reference different C++ objects. 
    ...
    # \param r The \c %ConstLMatrixRow instance to be compared with.
    ...
    # \return A \c %ConstLMatrixRow instance holding the result of the subtraction.
    # 
