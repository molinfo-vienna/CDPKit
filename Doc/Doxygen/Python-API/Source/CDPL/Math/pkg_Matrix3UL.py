...
class Matrix3UL(Boost.Python.instance):
    ...
    # \param m 
    # 
    def __init__(m: Matrix3UL) -> None: pass
    ...
    # \return \a self
    # 
    def assign(e: ConstFMatrixExpression) -> Matrix3UL: pass
    ...
    # \return \a self
    # 
    def assign(e: ConstDMatrixExpression) -> Matrix3UL: pass
    ...
    # \return \a self
    # 
    def assign(e: ConstLMatrixExpression) -> Matrix3UL: pass
    ...
    # \return \a self
    # 
    def assign(e: ConstULMatrixExpression) -> Matrix3UL: pass
    ...
    # \return \a self
    # 
    def assign(m: Matrix3UL) -> Matrix3UL: pass
    ...
    # \param m 
    #
    def swap(m: Matrix3UL) -> None: pass
    ...
    # 
    def __eq__(m: Matrix3UL) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(m: Matrix3UL) -> bool: pass
    ...
    # 
    def __iadd__(m: Matrix3UL) -> Matrix3UL: pass
    ...
    # \return The updated \e %Matrix3UL instance \a self.
    # 
    def __iadd__(e: ConstULMatrixExpression) -> Matrix3UL: pass
    ...
    # \return The updated \e %Matrix3UL instance \a self.
    # 
    def __isub__(m: Matrix3UL) -> Matrix3UL: pass
    ...
    # \return The updated \e %Matrix3UL instance \a self.
    # 
    def __isub__(e: ConstULMatrixExpression) -> Matrix3UL: pass
    ...
    # \return 
    #
    def __itruediv__(t: int) -> Matrix3UL: pass
