...
class ULUnitVector(Boost.Python.instance):
    ...
    # \param v 
    #
    def __init__(self: object, v: ULUnitVector) -> None: pass
    ...
    # \param n 
    #
    def resize(self: ULUnitVector, n: int) -> None: pass
    ...
    # \return 
    #
    def getIndex(arg1: ULUnitVector) -> int: pass
    ...
    #
    def getObjectID(self: ULUnitVector) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: ULUnitVector) -> bool: pass
    ...
    # \return 
    #
    def getSize(self: ULUnitVector) -> int: pass
    ...
    # \return 
    #
    def getElement(self: ULUnitVector, i: int) -> int: pass
    ...
    # \return 
    #
    def toArray(self: ULUnitVector) -> object: pass
    ...
    #
    def assign(self: ULUnitVector, v: ULUnitVector) -> ULUnitVector: pass
    ...
    # \param v 
    #
    def swap(self: ULUnitVector, v: ULUnitVector) -> None: pass
    ...
    #
    def __eq__(self: ULUnitVector, v: ULUnitVector) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %ULUnitVector instance this method is called upon.
    # \param e The \e %ULUnitVector instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: ULUnitVector, e: ConstULVectorExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ULUnitVector, v: ULUnitVector) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ULUnitVector, e: ConstULVectorExpression) -> bool: pass
    ...
    # \return 
    #
    def __call__(self: ULUnitVector, i: int) -> int: pass
    ...
    # \return 
    #
    def __getitem__(self: ULUnitVector, i: int) -> int: pass
    ...
    # \return 
    #
    def __len__(self: ULUnitVector) -> int: pass
    ...
    #
    def __str__(self: ULUnitVector) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: ULUnitVector) -> ULUnitVector: pass
    ...
    # \return A \e %ULUnitVector instance holding the result of the addition.
    #
    ...
    # \return A \e %ULUnitVector instance holding the result of the multiplication.
    #
    ...
    # \return A \e %ULUnitVector instance holding the result of the division.
    #
