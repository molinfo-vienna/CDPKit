...
##
# \brief An unbounded sparse vector holding signed integers of type <tt>int</tt>.
# 
class SparseLVector(Boost.Python.instance):
    ...
    # 
    # Different Python \c %SparseLVector instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %SparseLVector instances \e a and \e b reference different C++ objects. 
    ...
    # \param v The \c %SparseLVector instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %SparseLVector instance.
    ...
    # \return A \c %SparseLVector instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %SparseLVector instance \a self.
    # 
