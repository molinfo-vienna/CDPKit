...
class FMatrix(Boost.Python.instance):
    ...
    # \param m 
    #
    def __init__(self: object, m: FMatrix) -> None: pass
    ...
    # \param v 
    #
    def resize(self: FMatrix, m: int, n: int, preserve: bool = True, v: float = 0.0) -> None: pass
    ...
    # \param v 
    #
    def clear(self: FMatrix, v: float = 0.0) -> None: pass
    ...
    #
    def getObjectID(self: FMatrix) -> int: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %FMatrix instance \a e.
    # \param self The \e %FMatrix instance this method is called upon.
    # \param e The \e %FMatrix instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: FMatrix, e: ConstFMatrixExpression) -> FMatrix: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: FMatrix, e: ConstDMatrixExpression) -> FMatrix: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: FMatrix, e: ConstLMatrixExpression) -> FMatrix: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: FMatrix, e: ConstULMatrixExpression) -> FMatrix: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %FMatrix instance \a m.
    # \param self The \e %FMatrix instance this method is called upon.
    # \param m The \e %FMatrix instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: FMatrix, m: FMatrix) -> FMatrix: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %FMatrix instance \a a.
    # \param self The \e %FMatrix instance this method is called upon.
    # \param a The \e %FMatrix instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: FMatrix, a: object) -> None: pass
    ...
    # \return 
    #
    def getSize1(self: FMatrix) -> int: pass
    ...
    # \return 
    #
    def getSize2(self: FMatrix) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: FMatrix) -> bool: pass
    ...
    # \return 
    #
    def getElement(self: FMatrix, i: int, j: int) -> float: pass
    ...
    # \return 
    #
    def toArray(self: FMatrix) -> object: pass
    ...
    # \param m 
    #
    def swap(self: FMatrix, m: FMatrix) -> None: pass
    ...
    # \param v 
    #
    def setElement(self: FMatrix, i: int, j: int, v: float) -> None: pass
    ...
    # \return 
    #
    def __call__(self: FMatrix, i: int, j: int) -> float: pass
    ...
    # \return 
    #
    def __getitem__(self: FMatrix, ij: tuple) -> float: pass
    ...
    # \return 
    #
    def __len__(self: FMatrix) -> int: pass
    ...
    #
    def __eq__(self: FMatrix, m: FMatrix) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %FMatrix instance this method is called upon.
    # \param e The \e %FMatrix instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: FMatrix, e: ConstFMatrixExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: FMatrix, m: FMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: FMatrix, e: ConstFMatrixExpression) -> bool: pass
    ...
    #
    def __str__(self: FMatrix) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: FMatrix) -> FMatrix: pass
    ...
    # \return A \e %FMatrix instance holding the result of the addition.
    #
    ...
    # \return A \e %FMatrix instance holding the result of the multiplication.
    #
    ...
    # \return A \e %FMatrix instance holding the result of the division.
    #
    ...
    # \param v 
    #
    def __setitem__(self: FMatrix, ij: tuple, v: float) -> None: pass
    ...
    #
    def __iadd__(self: FMatrix, m: FMatrix) -> FMatrix: pass
    ...
    # \return The updated \e %FMatrix instance \a self.
    #
    def __iadd__(self: FMatrix, e: ConstFMatrixExpression) -> FMatrix: pass
    ...
    # \return The updated \e %FMatrix instance \a self.
    #
    def __isub__(self: FMatrix, m: FMatrix) -> FMatrix: pass
    ...
    # \return The updated \e %FMatrix instance \a self.
    #
    def __isub__(self: FMatrix, e: ConstFMatrixExpression) -> FMatrix: pass
    ...
    # \return The updated \e %FMatrix instance \a self.
    #
    def __imul__(self: FMatrix, t: float) -> FMatrix: pass
    ...
    # \return The updated \e %FMatrix instance \a self.
    #
    def __idiv__(self: FMatrix, t: float) -> FMatrix: pass
    ...
    # \return 
    #
    def __itruediv__(self: FMatrix, t: float) -> FMatrix: pass
