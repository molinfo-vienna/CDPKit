...
##
# \brief An unbounded sparse vector holding integers of type <tt>int</tt>.
# 
class SparseULVector(Boost.Python.instance):

    ##
    # \brief Initializes the \c %SparseULVector instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %SparseULVector instance \a v.
    # \param v The \c %SparseULVector instance to copy.
    # 
    ...
    # 
    # Different Python \c %SparseULVector instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %SparseULVector instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %SparseULVector instance \a v.
    # \param v The \c %SparseULVector instance to copy.
    # \return \a self
    # 
    ...
    # \param v The \c %SparseULVector instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %SparseULVector instance.
    ...
    # \return A \c %SparseULVector instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %SparseULVector instance \a self.
    # 
