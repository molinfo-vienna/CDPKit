...
##
# \brief An unbounded sparse matrix holding signed integers of type <tt>int</tt>.
# 
class SparseLMatrix(Boost.Python.instance):

    ##
    # \brief Initializes the \c %SparseLMatrix instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %SparseLMatrix instance \a m.
    # \param m The \c %SparseLMatrix instance to copy.
    # 
    ...
    # 
    # Different Python \c %SparseLMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %SparseLMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %SparseLMatrix instance \a m.
    # \param m The \c %SparseLMatrix instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %SparseLMatrix instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %SparseLMatrix instance.
    ...
    # \return A \c %SparseLMatrix instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %SparseLMatrix instance \a self.
    # 
