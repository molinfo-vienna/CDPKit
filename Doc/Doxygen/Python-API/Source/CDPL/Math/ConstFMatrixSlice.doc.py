...
class ConstFMatrixSlice(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %ConstFMatrixSlice instance \a s.
    # \param s The \c %ConstFMatrixSlice instance to copy.
    # 
    def __init__(s: ConstFMatrixSlice) -> None: pass

    ##
    # \brief Initializes the \c %ConstFMatrixSlice instance.
    # \param e 
    # \param s1 
    # \param s2 
    # 
    ...
    # 
    # Different Python \c %ConstFMatrixSlice instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstFMatrixSlice instances \e a and \e b reference different C++ objects. 
    ...
    # \param s The \c %ConstFMatrixSlice instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstFMatrixSlice instance.
    ...
    # \return 
    #
    def __pos__() -> ConstFMatrixSlice: pass
    ...
    # \return A \c %ConstFMatrixSlice instance holding the result of the subtraction.
    # 
