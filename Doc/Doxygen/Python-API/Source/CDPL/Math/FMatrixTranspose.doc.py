...
class FMatrixTranspose(Boost.Python.instance):
    ...
    # 
    # Different Python \c %FMatrixTranspose instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FMatrixTranspose instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %FMatrixTranspose instance \a mt.
    ...
    # \param mt The \c %FMatrixTranspose instance to be compared with.
    ...
    # \return A \c %FMatrixTranspose instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %FMatrixTranspose instance \a self.
    # 
