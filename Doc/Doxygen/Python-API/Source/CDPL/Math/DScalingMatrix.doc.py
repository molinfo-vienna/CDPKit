...
class DScalingMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %DScalingMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DScalingMatrix instances \e a and \e b reference different C++ objects. 
    ...
    # \param m The \c %DScalingMatrix instance to be compared with.
    ...
    # \return A \c %DScalingMatrix instance holding the result of the subtraction.
    # 
