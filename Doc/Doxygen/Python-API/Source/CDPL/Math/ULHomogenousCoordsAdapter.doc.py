...
class ULHomogenousCoordsAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ULHomogenousCoordsAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ULHomogenousCoordsAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param r The \c %ULHomogenousCoordsAdapter instance to be compared with.
    ...
    # \return A \c %ULHomogenousCoordsAdapter instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %ULHomogenousCoordsAdapter instance \a self.
    # 
