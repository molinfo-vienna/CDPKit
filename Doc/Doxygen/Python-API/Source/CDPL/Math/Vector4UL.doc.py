...
##
# \brief A bounded 4 element vector holding integers of type <tt>int</tt>.
# 
class Vector4UL(Boost.Python.instance):

    ##
    # \brief Initializes the \c %Vector4UL instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %Vector4UL instance \a v.
    # \param v The \c %Vector4UL instance to copy.
    # 
    ...
    # 
    # Different Python \c %Vector4UL instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector4UL instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector4UL instance \a v.
    # \param v The \c %Vector4UL instance to copy.
    # \return \a self
    # 
    ...
    # \param v The \c %Vector4UL instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %Vector4UL instance.
    ...
    # \return A \c %Vector4UL instance holding the result of the subtraction.
    # 
