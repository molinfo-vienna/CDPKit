...
class ConstULMatrixSlice(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %ConstULMatrixSlice instance \a s.
    # \param s The \c %ConstULMatrixSlice instance to copy.
    # 
    def __init__(s: ConstULMatrixSlice) -> None: pass

    ##
    # \brief Initializes the \c %ConstULMatrixSlice instance.
    # \param e 
    # \param s1 
    # \param s2 
    # 
    def __init__(e: ConstULMatrixExpression, s1: Slice, s2: Slice) -> None: pass
    ...
    # 
    # Different Python \c %ConstULMatrixSlice instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstULMatrixSlice instances \e a and \e b reference different C++ objects. 
    ...
    # \param s The \c %ConstULMatrixSlice instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(s: ConstULMatrixSlice) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(s: ConstULMatrixSlice) -> bool: pass
    ...
    ##
    # \brief Returns a string representation of the \c %ConstULMatrixSlice instance.
    ...
    # \return 
    #
    def __pos__() -> ConstULMatrixSlice: pass
    ...
    # \return A \c %ConstULMatrixSlice instance holding the result of the subtraction.
    # 
