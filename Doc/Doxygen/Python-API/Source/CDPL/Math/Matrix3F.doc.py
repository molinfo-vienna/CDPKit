...
class Matrix3F(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %Matrix3F instance.
    # 
    ...
    ##
    # \brief Initializes a copy of the \c %Matrix3F instance \a m.
    # \param m The \c %Matrix3F instance to copy.
    # 
    def __init__(m: Matrix3F) -> None: pass
    ...
    # 
    # Different Python \c %Matrix3F instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Matrix3F instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Matrix3F instance \a m.
    # \param m The \c %Matrix3F instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %Matrix3F instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(m: Matrix3F) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(m: Matrix3F) -> bool: pass
    ...
    ##
    # \brief Returns a string representation of the \c %Matrix3F instance.
    ...
    # \return A \c %Matrix3F instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Matrix3F instance \a self.
    # 
    def __iadd__(m: Matrix3F) -> Matrix3F: pass
    ...
    # \return The updated \c %Matrix3F instance \a self.
    # 
    def __isub__(m: Matrix3F) -> Matrix3F: pass
    ...
    # \return 
    #
    def __itruediv__(t: float) -> Matrix3F: pass
