...
class Matrix3UL(Boost.Python.instance):
    ...
    # 
    # Different Python \c %Matrix3UL instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Matrix3UL instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Matrix3UL instance \a m.
    # \param m The \c %Matrix3UL instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %Matrix3UL instance to be compared with.
    ...
    # \return A \c %Matrix3UL instance holding the result of the subtraction.
    # 
