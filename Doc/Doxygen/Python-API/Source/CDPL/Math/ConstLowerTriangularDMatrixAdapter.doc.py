...
class ConstLowerTriangularDMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstLowerTriangularDMatrixAdapter instance \a a.
    # \param a The \e %ConstLowerTriangularDMatrixAdapter instance to copy.
    # 
    ...
    # 
    # Different Python \c %ConstLowerTriangularDMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLowerTriangularDMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstLowerTriangularDMatrixAdapter instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(a: ConstLowerTriangularDMatrixAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstLowerTriangularDMatrixAdapter) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ConstLowerTriangularDMatrixAdapter: pass
    ...
    # \return A \c %ConstLowerTriangularDMatrixAdapter instance holding the result of the subtraction.
    # 
