...
class ConstULMatrixExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstULMatrixExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstULMatrixExpression instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Returns a string representation of the \c %ConstULMatrixExpression instance.
    ...
    # \return 
    #
    def __pos__() -> ConstULMatrixExpression: pass
    ...
    # \return A \c %ConstULMatrixExpression instance holding the result of the subtraction.
    # 
