...
##
# \brief A bounded 3x3 matrix holding signed integers of type <tt>int</tt>.
# 
class Matrix3L(Boost.Python.instance):

    ##
    # \brief Initializes the \c %Matrix3L instance.
    # 
    ...
    ##
    # \brief Initializes a copy of the \c %Matrix3L instance \a m.
    # \param m The \c %Matrix3L instance to copy.
    # 
    ...
    # 
    # Different Python \c %Matrix3L instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Matrix3L instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Matrix3L instance \a m.
    # \param m The \c %Matrix3L instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %Matrix3L instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %Matrix3L instance.
    ...
    # \return A \c %Matrix3L instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Matrix3L instance \a self.
    # 
