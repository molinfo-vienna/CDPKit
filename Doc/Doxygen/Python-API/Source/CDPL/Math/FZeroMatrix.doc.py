...
class FZeroMatrix(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %FZeroMatrix instance \a m.
    ...
    # 
    # Different Python \c %FZeroMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FZeroMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %FZeroMatrix instance \a m.
    # \param m The \c %FZeroMatrix instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %FZeroMatrix instance to be compared with.
    ...
    # \return A \c %FZeroMatrix instance holding the result of the subtraction.
    # 
