...
class Matrix4F(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %Matrix4F instance.
    # 
    ...
    ##
    # \brief Initializes a copy of the \c %Matrix4F instance \a m.
    # \param m The \c %Matrix4F instance to copy.
    # 
    ...
    # 
    # Different Python \c %Matrix4F instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Matrix4F instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Matrix4F instance \a m.
    # \param m The \c %Matrix4F instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %Matrix4F instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %Matrix4F instance.
    ...
    # \return A \c %Matrix4F instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Matrix4F instance \a self.
    # 
