...
class LMatrixExpression(ConstLMatrixExpression):
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LMatrixExpression instance \a e.
    # \param e The \c %LMatrixExpression instance to copy.
    # \return \a self
    # 
    ...
    # \return The updated \c %LMatrixExpression instance \a self.
    # 
