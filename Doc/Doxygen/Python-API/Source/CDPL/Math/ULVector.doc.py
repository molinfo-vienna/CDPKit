...
class ULVector(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ULVector instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ULVector instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %ULVector instance \a v.
    ...
    # \param v The \c %ULVector instance to be compared with.
    ...
    # \return A \c %ULVector instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %ULVector instance \a self.
    # 
