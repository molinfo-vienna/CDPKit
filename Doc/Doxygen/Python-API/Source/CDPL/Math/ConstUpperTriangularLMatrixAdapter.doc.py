...
class ConstUpperTriangularLMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %ConstUpperTriangularLMatrixAdapter instance with a copy of the state of the \e %ConstUpperTriangularLMatrixAdapter instance \a a.
    # \param a The \e %ConstUpperTriangularLMatrixAdapter instance to copy.
    # 
