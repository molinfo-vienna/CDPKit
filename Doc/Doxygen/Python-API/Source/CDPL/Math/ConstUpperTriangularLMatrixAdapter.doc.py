...
class ConstUpperTriangularLMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstUpperTriangularLMatrixAdapter instance \a a.
    ...
    # 
    # Different Python \c %ConstUpperTriangularLMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUpperTriangularLMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUpperTriangularLMatrixAdapter instance to be compared with.
    ...
    # \return A \c %ConstUpperTriangularLMatrixAdapter instance holding the result of the subtraction.
    # 
