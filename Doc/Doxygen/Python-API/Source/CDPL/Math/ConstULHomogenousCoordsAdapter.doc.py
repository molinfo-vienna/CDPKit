...
class ConstULHomogenousCoordsAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstULHomogenousCoordsAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstULHomogenousCoordsAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstULHomogenousCoordsAdapter instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstULHomogenousCoordsAdapter instance.
    ...
    # \return 
    #
    def __pos__() -> ConstULHomogenousCoordsAdapter: pass
    ...
    # \return A \c %ConstULHomogenousCoordsAdapter instance holding the result of the subtraction.
    # 
