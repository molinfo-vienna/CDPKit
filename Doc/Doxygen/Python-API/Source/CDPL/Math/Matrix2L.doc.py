...
class Matrix2L(Boost.Python.instance):
    ...
    # 
    # Different Python \c %Matrix2L instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Matrix2L instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Matrix2L instance \a m.
    ...
    # \param m The \c %Matrix2L instance to be compared with.
    ...
    # \return A \c %Matrix2L instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Matrix2L instance \a self.
    # 
