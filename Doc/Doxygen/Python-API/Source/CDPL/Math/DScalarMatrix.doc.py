...
class DScalarMatrix(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %DScalarMatrix instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %DScalarMatrix instance \a m.
    # \param m The \c %DScalarMatrix instance to copy.
    # 
    ...
    # 
    # Different Python \c %DScalarMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DScalarMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %DScalarMatrix instance \a m.
    # \param m The \c %DScalarMatrix instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %DScalarMatrix instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %DScalarMatrix instance.
    ...
    # \return A \c %DScalarMatrix instance holding the result of the subtraction.
    # 
