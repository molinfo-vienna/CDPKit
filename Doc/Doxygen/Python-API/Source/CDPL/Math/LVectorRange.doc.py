...
class LVectorRange(Boost.Python.instance):
    ...
    # 
    # Different Python \c %LVectorRange instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LVectorRange instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LVectorRange instance \a r.
    ...
    # \param r The \c %LVectorRange instance to be compared with.
    ...
    # \return A \c %LVectorRange instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %LVectorRange instance \a self.
    # 
