...
class DMatrixColumn(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %DMatrixColumn instance \a mc.
    # \param mc The \c %DMatrixColumn instance to copy.
    # 
    def __init__(mc: DMatrixColumn) -> None: pass

    ##
    # \brief Initializes the \c %DMatrixColumn instance.
    # \param e 
    # \param i 
    # 
    ...
    # 
    # Different Python \c %DMatrixColumn instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DMatrixColumn instances \e a and \e b reference different C++ objects. 
    ...
    # \param c The \c %DMatrixColumn instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %DMatrixColumn instance.
    ...
    # \return A \c %DMatrixColumn instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %DMatrixColumn instance \a self.
    # 
