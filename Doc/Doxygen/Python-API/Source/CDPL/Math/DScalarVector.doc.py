...
class DScalarVector(Boost.Python.instance):
    ...
    # 
    # Different Python \c %DScalarVector instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DScalarVector instances \e a and \e b reference different C++ objects. 
    ...
    # \param v The \c %DScalarVector instance to be compared with.
    ...
    # \return A \c %DScalarVector instance holding the result of the subtraction.
    # 
