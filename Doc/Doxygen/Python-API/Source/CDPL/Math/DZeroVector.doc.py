...
class DZeroVector(Boost.Python.instance):
    ...
    # 
    # Different Python \c %DZeroVector instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DZeroVector instances \e a and \e b reference different C++ objects. 
    ...
    # \param v The \c %DZeroVector instance to be compared with.
    ...
    # \return A \c %DZeroVector instance holding the result of the subtraction.
    # 
