...
class ConstLowerTriangularFMatrixAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstLowerTriangularFMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLowerTriangularFMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstLowerTriangularFMatrixAdapter instance to be compared with.
    ...
    # \return A \c %ConstLowerTriangularFMatrixAdapter instance holding the result of the subtraction.
    # 
