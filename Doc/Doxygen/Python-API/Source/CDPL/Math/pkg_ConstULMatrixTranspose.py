...
class ConstULMatrixTranspose(Boost.Python.instance):
    ...
    # \param mt 
    #
    def __init__(self: object, mt: ConstULMatrixTranspose) -> None: pass
    ...
    #
    def getObjectID(self: ConstULMatrixTranspose) -> int: pass
    ...
    # \return 
    #
    def getSize1(self: ConstULMatrixTranspose) -> int: pass
    ...
    # \return 
    #
    def getSize2(self: ConstULMatrixTranspose) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: ConstULMatrixTranspose) -> bool: pass
    ...
    # \return 
    #
    def getElement(self: ConstULMatrixTranspose, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def toArray(self: ConstULMatrixTranspose) -> object: pass
    ...
    # \return 
    #
    def getData(self: ConstULMatrixTranspose) -> ConstULMatrixExpression: pass
    ...
    # \return 
    #
    def __call__(self: ConstULMatrixTranspose, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def __getitem__(self: ConstULMatrixTranspose, ij: tuple) -> int: pass
    ...
    # \return 
    #
    def __len__(self: ConstULMatrixTranspose) -> int: pass
    ...
    #
    def __eq__(self: ConstULMatrixTranspose, mt: ConstULMatrixTranspose) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %ConstULMatrixTranspose instance this method is called upon.
    # \param e The \e %ConstULMatrixTranspose instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: ConstULMatrixTranspose, e: ConstULMatrixExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstULMatrixTranspose, mt: ConstULMatrixTranspose) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstULMatrixTranspose, e: ConstULMatrixExpression) -> bool: pass
    ...
    #
    def __str__(self: ConstULMatrixTranspose) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: ConstULMatrixTranspose) -> ConstULMatrixTranspose: pass
    ...
    # \return A \e %ConstULMatrixTranspose instance holding the result of the addition.
    #
    ...
    # \return A \e %ConstULMatrixTranspose instance holding the result of the multiplication.
    #
    ...
    # \return A \e %ConstULMatrixTranspose instance holding the result of the division.
    #
