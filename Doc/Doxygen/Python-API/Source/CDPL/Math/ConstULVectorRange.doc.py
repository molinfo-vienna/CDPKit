...
class ConstULVectorRange(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstULVectorRange instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstULVectorRange instances \e a and \e b reference different C++ objects. 
    ...
    # \param r The \c %ConstULVectorRange instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(r: ConstULVectorRange) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(r: ConstULVectorRange) -> bool: pass
    ...
    # \return A \c %ConstULVectorRange instance holding the result of the subtraction.
    # 
