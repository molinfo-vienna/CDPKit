...
class ConstLVectorExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstLVectorExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLVectorExpression instances \e a and \e b reference different C++ objects. 
    ...
    # \return A \c %ConstLVectorExpression instance holding the result of the subtraction.
    # 
