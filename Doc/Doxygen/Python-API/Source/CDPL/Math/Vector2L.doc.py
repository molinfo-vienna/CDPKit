...
##
# \brief A bounded 2 element vector holding signed integers of type <tt>int</tt>.
# 
class Vector2L(Boost.Python.instance):

    ##
    # \brief Initializes the \c %Vector2L instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %Vector2L instance \a v.
    # \param v The \c %Vector2L instance to copy.
    # 
    ...
    # 
    # Different Python \c %Vector2L instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector2L instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector2L instance \a v.
    # \param v The \c %Vector2L instance to copy.
    # \return \a self
    # 
    ...
    # \param v The \c %Vector2L instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %Vector2L instance.
    ...
    # \return A \c %Vector2L instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Vector2L instance \a self.
    # 
