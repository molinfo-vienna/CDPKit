...
##
# \brief A bounded 3 element vector holding signed integers of type <tt>int</tt>.
# 
class Vector3L(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %Vector3L instance \a v.
    # \param v The \c %Vector3L instance to copy.
    # 
    ...
    # 
    # Different Python \c %Vector3L instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector3L instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector3L instance \a v.
    # \param v The \c %Vector3L instance to copy.
    # \return \a self
    # 
    ...
    # \param v The \c %Vector3L instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %Vector3L instance.
    ...
    # \return A \c %Vector3L instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Vector3L instance \a self.
    # 
