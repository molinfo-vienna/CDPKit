...
class Vector3LArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %Vector3LArray instance \a array.
    # \param array The \c %Vector3LArray instance to copy.
    # 
    def __init__(array: Vector3LArray) -> None: pass

    ##
    # \brief Initializes the \c %Vector3LArray instance.
    # \param a 
    # 
    ...
    # 
    # Different Python \c %Vector3LArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector3LArray instances \e a and \e b reference different C++ objects. 
    ...
    # 
    def resize(num_elem: int, value: Vector3L) -> None: pass
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector3LArray instance \a array.
    # \param array The \c %Vector3LArray instance to copy.
    # \return \a self
    # 
    ...
    # 
    def addElement(value: Vector3L) -> None: pass

    ##
    # \brief 
    # \param values 
    #
    def addElements(values: Vector3LArray) -> None: pass
    ...
    # 
    def insertElement(idx: int, value: Vector3L) -> None: pass
    ...
    # 
    def insertElements(idx: int, num_elem: int, value: Vector3L) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: Vector3LArray) -> None: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getFirstElement() -> Vector3L: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getLastElement() -> Vector3L: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def getElement(idx: int) -> Vector3L: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def setElement(idx: int, value: Vector3L) -> None: pass
    ...
    # \return 
    #
    def __getitem__(idx: int) -> Vector3L: pass
    ...
    # \param value 
    #
    def __setitem__(index: int, value: Vector3L) -> None: pass
