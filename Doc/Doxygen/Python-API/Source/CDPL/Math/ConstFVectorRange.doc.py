...
class ConstFVectorRange(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstFVectorRange instance \a r.
    # \param r The \e %ConstFVectorRange instance to copy.
    # 
    ...
    # 
    # Different Python \c %ConstFVectorRange instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstFVectorRange instances \e a and \e b reference different C++ objects. 
    ...
    # \param r The \c %ConstFVectorRange instance to be compared with.
    ...
    # \return A \c %ConstFVectorRange instance holding the result of the subtraction.
    # 
