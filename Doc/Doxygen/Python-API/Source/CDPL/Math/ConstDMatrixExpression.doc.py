...
class ConstDMatrixExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstDMatrixExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstDMatrixExpression instances \e a and \e b reference different C++ objects. 
    ...
    # \return A \c %ConstDMatrixExpression instance holding the result of the subtraction.
    # 
