...
class DMatrixRange(Boost.Python.instance):
    ...
    # 
    # Different Python \c %DMatrixRange instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %DMatrixRange instances \e a and \e b reference different C++ objects. 
    ...
    # \param r The \c %DMatrixRange instance to be compared with.
    ...
    # \return A \c %DMatrixRange instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %DMatrixRange instance \a self.
    # 
