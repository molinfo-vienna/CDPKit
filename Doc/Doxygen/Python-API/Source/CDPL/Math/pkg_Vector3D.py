...
class Vector3D(Boost.Python.instance):
    ...
    # \param v 
    #
    def __init__(self: object, v: Vector3D) -> None: pass
    ...
    # \param v 
    #
    def clear(self: Vector3D, v: float = 0.0) -> None: pass
    ...
    #
    def getObjectID(self: Vector3D) -> int: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %Vector3D instance \a e.
    # \param self The \e %Vector3D instance this method is called upon.
    # \param e The \e %Vector3D instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: Vector3D, e: ConstFVectorExpression) -> Vector3D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector3D, e: ConstDVectorExpression) -> Vector3D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector3D, e: ConstLVectorExpression) -> Vector3D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector3D, e: ConstULVectorExpression) -> Vector3D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector3D, v: Vector3D) -> Vector3D: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %Vector3D instance \a a.
    # \param self The \e %Vector3D instance this method is called upon.
    # \param a The \e %Vector3D instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: Vector3D, a: object) -> None: pass
    ...
    # \return 
    #
    def isEmpty(self: Vector3D) -> bool: pass
    ...
    # \return 
    #
    def getSize(self: Vector3D) -> int: pass
    ...
    # \return 
    #
    def getElement(self: Vector3D, i: int) -> float: pass
    ...
    # \return 
    #
    def toArray(self: Vector3D) -> object: pass
    ...
    # \param v 
    #
    def swap(self: Vector3D, v: Vector3D) -> None: pass
    ...
    # \param v 
    #
    def setElement(self: Vector3D, i: int, v: float) -> None: pass
    ...
    #
    def __eq__(self: Vector3D, v: Vector3D) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %Vector3D instance this method is called upon.
    # \param e The \e %Vector3D instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: Vector3D, e: ConstDVectorExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Vector3D, v: Vector3D) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Vector3D, e: ConstDVectorExpression) -> bool: pass
    ...
    # \return 
    #
    def __call__(self: Vector3D, i: int) -> float: pass
    ...
    # \return 
    #
    def __getitem__(self: Vector3D, i: int) -> float: pass
    ...
    # \return 
    #
    def __len__(self: Vector3D) -> int: pass
    ...
    #
    def __str__(self: Vector3D) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: Vector3D) -> Vector3D: pass
    ...
    # \return A \e %Vector3D instance holding the result of the addition.
    #
    ...
    # \return A \e %Vector3D instance holding the result of the multiplication.
    #
    ...
    # \return A \e %Vector3D instance holding the result of the division.
    #
    ...
    # \param v 
    #
    def __setitem__(self: Vector3D, i: int, v: float) -> None: pass
    ...
    #
    def __iadd__(self: Vector3D, v: Vector3D) -> Vector3D: pass
    ...
    # \return The updated \e %Vector3D instance \a self.
    #
    def __iadd__(self: Vector3D, e: ConstDVectorExpression) -> Vector3D: pass
    ...
    # \return The updated \e %Vector3D instance \a self.
    #
    def __isub__(self: Vector3D, v: Vector3D) -> Vector3D: pass
    ...
    # \return The updated \e %Vector3D instance \a self.
    #
    def __isub__(self: Vector3D, e: ConstDVectorExpression) -> Vector3D: pass
    ...
    # \return The updated \e %Vector3D instance \a self.
    #
    def __imul__(self: Vector3D, t: float) -> Vector3D: pass
    ...
    # \return The updated \e %Vector3D instance \a self.
    #
    def __idiv__(self: Vector3D, t: float) -> Vector3D: pass
    ...
    # \return 
    #
    def __itruediv__(self: Vector3D, t: float) -> Vector3D: pass
