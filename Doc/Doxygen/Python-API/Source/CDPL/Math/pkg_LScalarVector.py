...
class LScalarVector(Boost.Python.instance):
    ...
    # \param self The \e %LScalarVector instance to initialize.
    #
    ...
    # \param v 
    #
    def __init__(self: object, v: LScalarVector) -> None: pass
    ...
    ##
    # \brief 
    # \param self The \e %LScalarVector instance this method is called upon.
    # \param n 
    #
    def resize(self: LScalarVector, n: int) -> None: pass
    ...
    #
    def getObjectID(self: LScalarVector) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: LScalarVector) -> bool: pass
    ...
    # \return 
    #
    def getSize(self: LScalarVector) -> int: pass
    ...
    # \return 
    #
    def getElement(self: LScalarVector, i: int) -> int: pass
    ...
    # \return 
    #
    def toArray(self: LScalarVector) -> object: pass
    ...
    #
    def assign(self: LScalarVector, v: LScalarVector) -> LScalarVector: pass
    ...
    # \param v 
    #
    def swap(self: LScalarVector, v: LScalarVector) -> None: pass
    ...
    #
    def __eq__(self: LScalarVector, v: LScalarVector) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __eq__(self: LScalarVector, e: ConstLVectorExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: LScalarVector, v: LScalarVector) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: LScalarVector, e: ConstLVectorExpression) -> bool: pass
    ...
    # \return 
    #
    def __call__(self: LScalarVector, i: int) -> int: pass
    ...
    # \return 
    #
    def __getitem__(self: LScalarVector, i: int) -> int: pass
    ...
    # \return 
    #
    def __len__(self: LScalarVector) -> int: pass
    ...
    #
    def __str__(self: LScalarVector) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: LScalarVector) -> LScalarVector: pass
    ...
    # \param self The \e %LScalarVector instance representing the first addend.
    ...
    # \param self The \e %LScalarVector instance acting as minuend.
    ...
    # \param self The \e %LScalarVector instance acting as multiplicand.
    ...
    # \param self The \e %LScalarVector instance acting as dividend.
