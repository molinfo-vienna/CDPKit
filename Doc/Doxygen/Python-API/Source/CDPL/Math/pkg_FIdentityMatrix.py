...
class FIdentityMatrix(Boost.Python.instance):
    ...
    # \return \a self
    # 
    def assign(m: FIdentityMatrix) -> FIdentityMatrix: pass

    ##
    # \brief 
    # \param m 
    #
    def swap(m: FIdentityMatrix) -> None: pass
    ...
    # 
    def __eq__(m: FIdentityMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(m: FIdentityMatrix) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> FIdentityMatrix: pass
