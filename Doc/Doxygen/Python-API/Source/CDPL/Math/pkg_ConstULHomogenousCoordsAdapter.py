...
class ConstULHomogenousCoordsAdapter(Boost.Python.instance):
    ...
    # \param a 
    #
    def __init__(self: object, a: ConstULHomogenousCoordsAdapter) -> None: pass
    ...
    #
    def getObjectID(self: ConstULHomogenousCoordsAdapter) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: ConstULHomogenousCoordsAdapter) -> bool: pass
    ...
    # \return 
    #
    def getSize(self: ConstULHomogenousCoordsAdapter) -> int: pass
    ...
    # \return 
    #
    def getElement(self: ConstULHomogenousCoordsAdapter, i: int) -> int: pass
    ...
    # \return 
    #
    def toArray(self: ConstULHomogenousCoordsAdapter) -> object: pass
    ...
    # \return 
    #
    def getData(self: ConstULHomogenousCoordsAdapter) -> ConstULVectorExpression: pass
    ...
    #
    def __eq__(self: ConstULHomogenousCoordsAdapter, a: ConstULHomogenousCoordsAdapter) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %ConstULHomogenousCoordsAdapter instance this method is called upon.
    # \param e The \e %ConstULHomogenousCoordsAdapter instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: ConstULHomogenousCoordsAdapter, e: ConstULVectorExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstULHomogenousCoordsAdapter, a: ConstULHomogenousCoordsAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstULHomogenousCoordsAdapter, e: ConstULVectorExpression) -> bool: pass
    ...
    # \return 
    #
    def __call__(self: ConstULHomogenousCoordsAdapter, i: int) -> int: pass
    ...
    # \return 
    #
    def __getitem__(self: ConstULHomogenousCoordsAdapter, i: int) -> int: pass
    ...
    # \return 
    #
    def __len__(self: ConstULHomogenousCoordsAdapter) -> int: pass
    ...
    #
    def __str__(self: ConstULHomogenousCoordsAdapter) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: ConstULHomogenousCoordsAdapter) -> ConstULHomogenousCoordsAdapter: pass
    ...
    # \return A \e %ConstULHomogenousCoordsAdapter instance holding the result of the addition.
    #
    ...
    # \return A \e %ConstULHomogenousCoordsAdapter instance holding the result of the multiplication.
    #
    ...
    # \return A \e %ConstULHomogenousCoordsAdapter instance holding the result of the division.
    #
