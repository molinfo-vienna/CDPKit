...
class LIdentityMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %LIdentityMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LIdentityMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LIdentityMatrix instance \a m.
    ...
    # \param m 
    #
    def swap(m: LIdentityMatrix) -> None: pass
    ...
    # \param m The \c %LIdentityMatrix instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(m: LIdentityMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(m: LIdentityMatrix) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> LIdentityMatrix: pass
    ...
    # \return A \c %LIdentityMatrix instance holding the result of the subtraction.
    # 
