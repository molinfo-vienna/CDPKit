...
class Vector7D(Boost.Python.instance):
    ...
    # \param v 
    #
    def __init__(self: object, v: Vector7D) -> None: pass
    ...
    #
    def assign(self: Vector7D, e: ConstFVectorExpression) -> Vector7D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector7D, e: ConstDVectorExpression) -> Vector7D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector7D, e: ConstLVectorExpression) -> Vector7D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector7D, e: ConstULVectorExpression) -> Vector7D: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Vector7D, v: Vector7D) -> Vector7D: pass
    ...
    # \param v 
    #
    def swap(self: Vector7D, v: Vector7D) -> None: pass
    ...
    #
    def __eq__(self: Vector7D, v: Vector7D) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __eq__(self: Vector7D, e: ConstDVectorExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Vector7D, v: Vector7D) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Vector7D, e: ConstDVectorExpression) -> bool: pass
    ...
    # \return 
    #
    def __pos__(self: Vector7D) -> Vector7D: pass
    ...
    #
    def __iadd__(self: Vector7D, v: Vector7D) -> Vector7D: pass
    ...
    # \return The updated \e %Vector7D instance \a self.
    #
    def __iadd__(self: Vector7D, e: ConstDVectorExpression) -> Vector7D: pass
    ...
    # \return The updated \e %Vector7D instance \a self.
    #
    def __isub__(self: Vector7D, v: Vector7D) -> Vector7D: pass
    ...
    # \return The updated \e %Vector7D instance \a self.
    #
    def __isub__(self: Vector7D, e: ConstDVectorExpression) -> Vector7D: pass
    ...
    # \return The updated \e %Vector7D instance \a self.
    #
    def __imul__(self: Vector7D, t: float) -> Vector7D: pass
    ...
    # \return The updated \e %Vector7D instance \a self.
    #
    def __idiv__(self: Vector7D, t: float) -> Vector7D: pass
    ...
    # \return 
    #
    def __itruediv__(self: Vector7D, t: float) -> Vector7D: pass
