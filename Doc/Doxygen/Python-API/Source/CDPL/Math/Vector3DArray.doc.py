...
class Vector3DArray(Boost.Python.instance):
    ...
    # 
    # Different Python \c %Vector3DArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector3DArray instances \e a and \e b reference different C++ objects. 
    ...
    # 
    def resize(num_elem: int, value: Vector3D) -> None: pass
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector3DArray instance \a array.
    # \param array The \c %Vector3DArray instance to copy.
    # \return \a self
    # 
    def assign(array: Vector3DArray) -> Vector3DArray: pass
    ...
    # 
    def assign(num_elem: int, value: Vector3D) -> None: pass
    ...
    # 
    def addElement(value: Vector3D) -> None: pass

    ##
    # \brief 
    # \param values 
    #
    def addElements(values: Vector3DArray) -> None: pass
    ...
    # 
    def insertElement(idx: int, value: Vector3D) -> None: pass
    ...
    # 
    def insertElements(idx: int, num_elem: int, value: Vector3D) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: Vector3DArray) -> None: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getFirstElement() -> Vector3D: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getLastElement() -> Vector3D: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def getElement(idx: int) -> Vector3D: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def setElement(idx: int, value: Vector3D) -> None: pass
    ...
    # \return 
    #
    def __getitem__(idx: int) -> Vector3D: pass
    ...
    # \param value 
    #
    def __setitem__(index: int, value: Vector3D) -> None: pass
