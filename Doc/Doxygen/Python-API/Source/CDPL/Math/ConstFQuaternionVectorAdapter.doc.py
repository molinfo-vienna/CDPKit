...
class ConstFQuaternionVectorAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %ConstFQuaternionVectorAdapter instance \a a.
    # \param a The \c %ConstFQuaternionVectorAdapter instance to copy.
    # 
    def __init__(a: ConstFQuaternionVectorAdapter) -> None: pass

    ##
    # \brief Initializes the \c %ConstFQuaternionVectorAdapter instance.
    # \param e 
    # 
    ...
    # 
    # Different Python \c %ConstFQuaternionVectorAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstFQuaternionVectorAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstFQuaternionVectorAdapter instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstFQuaternionVectorAdapter instance.
    ...
    # \return A \c %ConstFQuaternionVectorAdapter instance holding the result of the subtraction.
    # 
