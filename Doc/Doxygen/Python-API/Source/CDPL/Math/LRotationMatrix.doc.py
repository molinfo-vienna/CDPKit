...
class LRotationMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %LRotationMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LRotationMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LRotationMatrix instance \a m.
    ...
    # \param m The \c %LRotationMatrix instance to be compared with.
    ...
    # \return A \c %LRotationMatrix instance holding the result of the subtraction.
    # 
