...
class ConstDVectorSlice(Boost.Python.instance):
    ...
    # \param s 
    #
    def __init__(self: object, s: ConstDVectorSlice) -> None: pass
    ...
    # \param s 
    #
    def __init__(self: object, e: ConstDVectorExpression, s: ast.Slice) -> None: pass
    ...
    # \return 
    #
    def getStart(self: ConstDVectorSlice) -> int: pass
    ...
    # \return 
    #
    def getStride(self: ConstDVectorSlice) -> int: pass
    ...
    #
    def getObjectID(self: ConstDVectorSlice) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: ConstDVectorSlice) -> bool: pass
    ...
    # \return 
    #
    def getSize(self: ConstDVectorSlice) -> int: pass
    ...
    # \return 
    #
    def getElement(self: ConstDVectorSlice, i: int) -> float: pass
    ...
    # \return 
    #
    def toArray(self: ConstDVectorSlice) -> object: pass
    ...
    # \return 
    #
    def getData(self: ConstDVectorSlice) -> ConstDVectorExpression: pass
    ...
    #
    def __eq__(self: ConstDVectorSlice, s: ConstDVectorSlice) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %ConstDVectorSlice instance this method is called upon.
    # \param e The \e %ConstDVectorSlice instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: ConstDVectorSlice, e: ConstDVectorExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstDVectorSlice, s: ConstDVectorSlice) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstDVectorSlice, e: ConstDVectorExpression) -> bool: pass
    ...
    # \return 
    #
    def __call__(self: ConstDVectorSlice, i: int) -> float: pass
    ...
    # \return 
    #
    def __getitem__(self: ConstDVectorSlice, i: int) -> float: pass
    ...
    # \return 
    #
    def __len__(self: ConstDVectorSlice) -> int: pass
    ...
    #
    def __str__(self: ConstDVectorSlice) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: ConstDVectorSlice) -> ConstDVectorSlice: pass
    ...
    # \return A \e %ConstDVectorSlice instance holding the result of the addition.
    #
    ...
    # \return A \e %ConstDVectorSlice instance holding the result of the multiplication.
    #
    ...
    # \return A \e %ConstDVectorSlice instance holding the result of the division.
    #
