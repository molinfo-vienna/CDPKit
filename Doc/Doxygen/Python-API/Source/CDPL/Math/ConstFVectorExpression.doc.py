...
class ConstFVectorExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstFVectorExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstFVectorExpression instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Returns a string representation of the \c %ConstFVectorExpression instance.
    ...
    # \return A \c %ConstFVectorExpression instance holding the result of the subtraction.
    # 
