...
class FMatrixColumn(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %FMatrixColumn instance \a mc.
    # \param mc The \c %FMatrixColumn instance to copy.
    # 
    def __init__(mc: FMatrixColumn) -> None: pass

    ##
    # \brief Initializes the \c %FMatrixColumn instance.
    # \param e 
    # \param i 
    # 
    ...
    # 
    # Different Python \c %FMatrixColumn instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %FMatrixColumn instances \e a and \e b reference different C++ objects. 
    ...
    # \param c The \c %FMatrixColumn instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %FMatrixColumn instance.
    ...
    # \return A \c %FMatrixColumn instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %FMatrixColumn instance \a self.
    # 
