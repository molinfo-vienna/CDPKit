...
class Vector2D(Boost.Python.instance):
    ...
    # 
    # Different Python \c %Vector2D instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector2D instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector2D instance \a v.
    ...
    # \param v The \c %Vector2D instance to be compared with.
    ...
    # \return A \c %Vector2D instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Vector2D instance \a self.
    # 
