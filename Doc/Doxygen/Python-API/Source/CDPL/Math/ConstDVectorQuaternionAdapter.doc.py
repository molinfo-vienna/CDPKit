...
class ConstDVectorQuaternionAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstDVectorQuaternionAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstDVectorQuaternionAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstDVectorQuaternionAdapter instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstDVectorQuaternionAdapter instance.
    ...
    # \return A \c %ConstDVectorQuaternionAdapter instance holding the result of the subtraction.
    # 
