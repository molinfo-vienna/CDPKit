...
class ConstFMatrixExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstFMatrixExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstFMatrixExpression instances \e a and \e b reference different C++ objects. 
    ...
    # \return 
    #
    def __pos__() -> ConstFMatrixExpression: pass
    ...
    # \return A \c %ConstFMatrixExpression instance holding the result of the subtraction.
    # 
