...
class ConstULVectorExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstULVectorExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstULVectorExpression instances \e a and \e b reference different C++ objects. 
    ...
    # \return 
    #
    def __pos__() -> ConstULVectorExpression: pass
    ...
    # \return A \c %ConstULVectorExpression instance holding the result of the subtraction.
    # 
