...
class ULRotationMatrix(Boost.Python.instance):
    ...
    # \param self The \e %ULRotationMatrix instance to initialize.
    # \param m 
    #
    def __init__(self: object, m: ULRotationMatrix) -> None: pass
    ...
    # \param uz 
    #
    def __init__(self: object, n: int, w: float, ux: int, uy: int, uz: int) -> None: pass
    ...
    # \param uz 
    #
    def set(self: ULRotationMatrix, w: int, ux: int, uy: int, uz: int) -> None: pass
    ...
    # \param n 
    #
    def resize(arg1: ULRotationMatrix, n: int) -> None: pass
    ...
    #
    def getObjectID(self: ULRotationMatrix) -> int: pass
    ...
    # \return 
    #
    def getSize1(self: ULRotationMatrix) -> int: pass
    ...
    # \return 
    #
    def getSize2(self: ULRotationMatrix) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: ULRotationMatrix) -> bool: pass
    ...
    # \return 
    #
    def getElement(self: ULRotationMatrix, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def toArray(self: ULRotationMatrix) -> object: pass
    ...
    #
    def assign(self: ULRotationMatrix, m: ULRotationMatrix) -> ULRotationMatrix: pass
    ...
    # \param m 
    #
    def swap(self: ULRotationMatrix, m: ULRotationMatrix) -> None: pass
    ...
    # \return 
    #
    def __call__(self: ULRotationMatrix, i: int, j: int) -> int: pass
    ...
    # \return 
    #
    def __getitem__(self: ULRotationMatrix, ij: tuple) -> int: pass
    ...
    # \return 
    #
    def __len__(self: ULRotationMatrix) -> int: pass
    ...
    #
    def __eq__(self: ULRotationMatrix, m: ULRotationMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __eq__(self: ULRotationMatrix, e: ConstULMatrixExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ULRotationMatrix, m: ULRotationMatrix) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ULRotationMatrix, e: ConstULMatrixExpression) -> bool: pass
    ...
    #
    def __str__(self: ULRotationMatrix) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: ULRotationMatrix) -> ULRotationMatrix: pass
    ...
    # \param self The \e %ULRotationMatrix instance representing the first addend.
    ...
    # \param self The \e %ULRotationMatrix instance acting as minuend.
    ...
    # \param self The \e %ULRotationMatrix instance acting as multiplicand.
    ...
    # \param self The \e %ULRotationMatrix instance acting as dividend.
