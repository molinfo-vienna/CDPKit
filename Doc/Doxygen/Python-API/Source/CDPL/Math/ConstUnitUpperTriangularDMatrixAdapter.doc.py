...
class ConstUnitUpperTriangularDMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %ConstUnitUpperTriangularDMatrixAdapter instance with a copy of the state of the \e %ConstUnitUpperTriangularDMatrixAdapter instance \a a.
    # \param a The \e %ConstUnitUpperTriangularDMatrixAdapter instance to copy.
    # 
