...
class ConstUnitUpperTriangularDMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstUnitUpperTriangularDMatrixAdapter instance \a a.
    ...
    # 
    # Different Python \c %ConstUnitUpperTriangularDMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUnitUpperTriangularDMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUnitUpperTriangularDMatrixAdapter instance to be compared with.
    ...
    # \return A \c %ConstUnitUpperTriangularDMatrixAdapter instance holding the result of the subtraction.
    # 
