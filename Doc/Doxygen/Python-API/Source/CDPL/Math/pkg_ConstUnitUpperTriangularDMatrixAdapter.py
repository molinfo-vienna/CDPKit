...
class ConstUnitUpperTriangularDMatrixAdapter(Boost.Python.instance):
    ...
    # 
    def __eq__(a: ConstUnitUpperTriangularDMatrixAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstUnitUpperTriangularDMatrixAdapter) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ConstUnitUpperTriangularDMatrixAdapter: pass
