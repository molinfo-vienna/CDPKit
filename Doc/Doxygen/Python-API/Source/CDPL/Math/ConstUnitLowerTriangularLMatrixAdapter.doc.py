...
class ConstUnitLowerTriangularLMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstUnitLowerTriangularLMatrixAdapter instance \a a.
    # \param a The \e %ConstUnitLowerTriangularLMatrixAdapter instance to copy.
    # 
    ...
    # 
    # Different Python \c %ConstUnitLowerTriangularLMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUnitLowerTriangularLMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUnitLowerTriangularLMatrixAdapter instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(a: ConstUnitLowerTriangularLMatrixAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstUnitLowerTriangularLMatrixAdapter) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ConstUnitLowerTriangularLMatrixAdapter: pass
    ...
    # \return A \c %ConstUnitLowerTriangularLMatrixAdapter instance holding the result of the subtraction.
    # 
