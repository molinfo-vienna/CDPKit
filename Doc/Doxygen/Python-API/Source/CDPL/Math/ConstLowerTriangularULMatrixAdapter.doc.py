...
class ConstLowerTriangularULMatrixAdapter(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstLowerTriangularULMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLowerTriangularULMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstLowerTriangularULMatrixAdapter instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstLowerTriangularULMatrixAdapter instance.
    ...
    # \return A \c %ConstLowerTriangularULMatrixAdapter instance holding the result of the subtraction.
    # 
