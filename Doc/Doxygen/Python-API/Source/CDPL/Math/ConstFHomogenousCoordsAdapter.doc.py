...
class ConstFHomogenousCoordsAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstFHomogenousCoordsAdapter instance \a a.
    # \param a The \e %ConstFHomogenousCoordsAdapter instance to copy.
    # 
    ...
    # 
    # Different Python \c %ConstFHomogenousCoordsAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstFHomogenousCoordsAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstFHomogenousCoordsAdapter instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(a: ConstFHomogenousCoordsAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstFHomogenousCoordsAdapter) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ConstFHomogenousCoordsAdapter: pass
    ...
    # \return A \c %ConstFHomogenousCoordsAdapter instance holding the result of the subtraction.
    # 
