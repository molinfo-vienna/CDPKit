...
class ConstFHomogenousCoordsAdapter(Boost.Python.instance):
    ...
    # \param a 
    #
    def __init__(self: object, a: ConstFHomogenousCoordsAdapter) -> None: pass
    ...
    #
    def getObjectID(self: ConstFHomogenousCoordsAdapter) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: ConstFHomogenousCoordsAdapter) -> bool: pass
    ...
    # \return 
    #
    def getSize(self: ConstFHomogenousCoordsAdapter) -> int: pass
    ...
    # \return 
    #
    def getElement(self: ConstFHomogenousCoordsAdapter, i: int) -> float: pass
    ...
    # \return 
    #
    def toArray(self: ConstFHomogenousCoordsAdapter) -> object: pass
    ...
    # \return 
    #
    def getData(self: ConstFHomogenousCoordsAdapter) -> ConstFVectorExpression: pass
    ...
    #
    def __eq__(self: ConstFHomogenousCoordsAdapter, a: ConstFHomogenousCoordsAdapter) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %ConstFHomogenousCoordsAdapter instance this method is called upon.
    # \param e The \e %ConstFHomogenousCoordsAdapter instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: ConstFHomogenousCoordsAdapter, e: ConstFVectorExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstFHomogenousCoordsAdapter, a: ConstFHomogenousCoordsAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: ConstFHomogenousCoordsAdapter, e: ConstFVectorExpression) -> bool: pass
    ...
    # \return 
    #
    def __call__(self: ConstFHomogenousCoordsAdapter, i: int) -> float: pass
    ...
    # \return 
    #
    def __getitem__(self: ConstFHomogenousCoordsAdapter, i: int) -> float: pass
    ...
    # \return 
    #
    def __len__(self: ConstFHomogenousCoordsAdapter) -> int: pass
    ...
    #
    def __str__(self: ConstFHomogenousCoordsAdapter) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: ConstFHomogenousCoordsAdapter) -> ConstFHomogenousCoordsAdapter: pass
    ...
    # \return A \e %ConstFHomogenousCoordsAdapter instance holding the result of the addition.
    #
    ...
    # \return A \e %ConstFHomogenousCoordsAdapter instance holding the result of the multiplication.
    #
    ...
    # \return A \e %ConstFHomogenousCoordsAdapter instance holding the result of the division.
    #
