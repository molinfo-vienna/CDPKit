...
class Vector2LArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %Vector2LArray instance with a copy of the state of the \e %Vector2LArray instance \a array.
    ...
    # 
    def resize(num_elem: int, value: Vector2L) -> None: pass
    ...
    # 
    def insertElement(idx: int, value: Vector2L) -> None: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getFirstElement() -> Vector2L: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getLastElement() -> Vector2L: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def getElement(idx: int) -> Vector2L: pass
