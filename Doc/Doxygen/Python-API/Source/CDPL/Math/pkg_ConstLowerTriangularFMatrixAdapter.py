...
class ConstLowerTriangularFMatrixAdapter(Boost.Python.instance):
    ...
    # 
    def __eq__(a: ConstLowerTriangularFMatrixAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstLowerTriangularFMatrixAdapter) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ConstLowerTriangularFMatrixAdapter: pass
