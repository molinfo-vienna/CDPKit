...
class Vector3FArrayBFGSMinimizer(Boost.Python.instance):
    ...
    # \param grad_func 
    # 
    def __init__(func: FloatVector3FArrayFunctor, grad_func: object) -> None: pass

    ##
    # \brief Returns the numeric identifier (ID) of the wrapped C++ class instance.
    # 
    # Different Python \c %Vector3FArrayBFGSMinimizer instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector3FArrayBFGSMinimizer instances \e a and \e b reference different C++ objects. 
