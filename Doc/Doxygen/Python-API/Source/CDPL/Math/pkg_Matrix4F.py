...
class Matrix4F(Boost.Python.instance):
    ...
    # \param m 
    #
    def __init__(self: object, m: Matrix4F) -> None: pass
    ...
    # \param v 
    #
    def clear(self: Matrix4F, v: float = 0.0) -> None: pass
    ...
    #
    def getObjectID(self: Matrix4F) -> int: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %Matrix4F instance \a e.
    # \param self The \e %Matrix4F instance this method is called upon.
    # \param e The \e %Matrix4F instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4F, e: ConstFMatrixExpression) -> Matrix4F: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4F, e: ConstDMatrixExpression) -> Matrix4F: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4F, e: ConstLMatrixExpression) -> Matrix4F: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4F, e: ConstULMatrixExpression) -> Matrix4F: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4F, m: Matrix4F) -> Matrix4F: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %Matrix4F instance \a a.
    # \param self The \e %Matrix4F instance this method is called upon.
    # \param a The \e %Matrix4F instance to copy.
    # \return The assignment target \a self.
    #
    def assign(self: Matrix4F, a: object) -> None: pass
    ...
    # \return 
    #
    def getSize1(self: Matrix4F) -> int: pass
    ...
    # \return 
    #
    def getSize2(self: Matrix4F) -> int: pass
    ...
    # \return 
    #
    def isEmpty(self: Matrix4F) -> bool: pass
    ...
    # \return 
    #
    def getElement(self: Matrix4F, i: int, j: int) -> float: pass
    ...
    # \return 
    #
    def toArray(self: Matrix4F) -> object: pass
    ...
    # \param m 
    #
    def swap(self: Matrix4F, m: Matrix4F) -> None: pass
    ...
    # \param v 
    #
    def setElement(self: Matrix4F, i: int, j: int, v: float) -> None: pass
    ...
    # \return 
    #
    def __call__(self: Matrix4F, i: int, j: int) -> float: pass
    ...
    # \return 
    #
    def __getitem__(self: Matrix4F, ij: tuple) -> float: pass
    ...
    # \return 
    #
    def __len__(self: Matrix4F) -> int: pass
    ...
    #
    def __eq__(self: Matrix4F, m: Matrix4F) -> bool: pass

    ##
    # \brief Returns the result of the comparison operation <tt>self == e</tt>.
    # \param self The \e %Matrix4F instance this method is called upon.
    # \param e The \e %Matrix4F instance to be compared with.
    # \return The result of the comparison operation.
    #
    def __eq__(self: Matrix4F, e: ConstFMatrixExpression) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Matrix4F, m: Matrix4F) -> bool: pass
    ...
    # \return The result of the comparison operation.
    #
    def __ne__(self: Matrix4F, e: ConstFMatrixExpression) -> bool: pass
    ...
    #
    def __str__(self: Matrix4F) -> str: pass
    ...
    # \return 
    #
    def __pos__(self: Matrix4F) -> Matrix4F: pass
    ...
    # \return A \e %Matrix4F instance holding the result of the addition.
    #
    ...
    # \return A \e %Matrix4F instance holding the result of the multiplication.
    #
    ...
    # \return A \e %Matrix4F instance holding the result of the division.
    #
    ...
    # \param v 
    #
    def __setitem__(self: Matrix4F, ij: tuple, v: float) -> None: pass
    ...
    #
    def __iadd__(self: Matrix4F, m: Matrix4F) -> Matrix4F: pass
    ...
    # \return The updated \e %Matrix4F instance \a self.
    #
    def __iadd__(self: Matrix4F, e: ConstFMatrixExpression) -> Matrix4F: pass
    ...
    # \return The updated \e %Matrix4F instance \a self.
    #
    def __isub__(self: Matrix4F, m: Matrix4F) -> Matrix4F: pass
    ...
    # \return The updated \e %Matrix4F instance \a self.
    #
    def __isub__(self: Matrix4F, e: ConstFMatrixExpression) -> Matrix4F: pass
    ...
    # \return The updated \e %Matrix4F instance \a self.
    #
    def __imul__(self: Matrix4F, t: float) -> Matrix4F: pass
    ...
    # \return The updated \e %Matrix4F instance \a self.
    #
    def __idiv__(self: Matrix4F, t: float) -> Matrix4F: pass
    ...
    # \return 
    #
    def __itruediv__(self: Matrix4F, t: float) -> Matrix4F: pass
