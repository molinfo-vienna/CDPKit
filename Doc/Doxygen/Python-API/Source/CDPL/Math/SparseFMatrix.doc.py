...
class SparseFMatrix(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %SparseFMatrix instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %SparseFMatrix instance \a m.
    # \param m The \c %SparseFMatrix instance to copy.
    # 
    ...
    # 
    # Different Python \c %SparseFMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %SparseFMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %SparseFMatrix instance \a m.
    # \param m The \c %SparseFMatrix instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %SparseFMatrix instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %SparseFMatrix instance.
    ...
    # \return A \c %SparseFMatrix instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %SparseFMatrix instance \a self.
    # 
