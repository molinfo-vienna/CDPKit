...
class ConstUnitUpperTriangularLMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %ConstUnitUpperTriangularLMatrixAdapter instance with a copy of the state of the \e %ConstUnitUpperTriangularLMatrixAdapter instance \a a.
