...
class Vector3D(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %Vector3D instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %Vector3D instance \a v.
    # \param v The \c %Vector3D instance to copy.
    # 
    ...
    # 
    # Different Python \c %Vector3D instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector3D instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector3D instance \a v.
    # \param v The \c %Vector3D instance to copy.
    # \return \a self
    # 
    ...
    # \param v The \c %Vector3D instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %Vector3D instance.
    ...
    # \return A \c %Vector3D instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Vector3D instance \a self.
    # 
