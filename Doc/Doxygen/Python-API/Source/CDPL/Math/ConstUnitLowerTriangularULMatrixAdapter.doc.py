...
class ConstUnitLowerTriangularULMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstUnitLowerTriangularULMatrixAdapter instance \a a.
    ...
    # 
    # Different Python \c %ConstUnitLowerTriangularULMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUnitLowerTriangularULMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUnitLowerTriangularULMatrixAdapter instance to be compared with.
    ...
    # \return A \c %ConstUnitLowerTriangularULMatrixAdapter instance holding the result of the subtraction.
    # 
