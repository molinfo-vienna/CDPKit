...
class ConstUnitLowerTriangularULMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %ConstUnitLowerTriangularULMatrixAdapter instance with a copy of the state of the \e %ConstUnitLowerTriangularULMatrixAdapter instance \a a.
    # \param a The \e %ConstUnitLowerTriangularULMatrixAdapter instance to copy.
    # 
