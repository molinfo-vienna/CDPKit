...
class LMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %LMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LMatrix instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LMatrix instance \a m.
    ...
    # \param m The \c %LMatrix instance to be compared with.
    ...
    # \return A \c %LMatrix instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %LMatrix instance \a self.
    # 
