...
##
# \brief A bounded 2 element vector holding integers of type <tt>int</tt>.
# 
class Vector2UL(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %Vector2UL instance \a v.
    ...
    # 
    # Different Python \c %Vector2UL instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector2UL instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector2UL instance \a v.
    # \param v The \c %Vector2UL instance to copy.
    # \return \a self
    # 
    ...
    # \param v The \c %Vector2UL instance to be compared with.
    ...
    # \return A \c %Vector2UL instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Vector2UL instance \a self.
    # 
