...
class Vector2UL(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %Vector2UL instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %Vector2UL instance \a v.
    ...
    ##
    # \brief Returns a string representation of the \c %Vector2UL instance.
