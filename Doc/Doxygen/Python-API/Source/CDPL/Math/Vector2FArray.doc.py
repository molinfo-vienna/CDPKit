...
class Vector2FArray(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %Vector2FArray instance \a array.
    # \param array The \c %Vector2FArray instance to copy.
    # 
    def __init__(array: Vector2FArray) -> None: pass

    ##
    # \brief Initializes the \c %Vector2FArray instance.
    # \param a 
    # 
    ...
    # 
    # Different Python \c %Vector2FArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector2FArray instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector2FArray instance \a array.
    # \param array The \c %Vector2FArray instance to copy.
    # \return \a self
    # 
