...
class SparseFVector(Boost.Python.instance):
    ...
    # 
    # Different Python \c %SparseFVector instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %SparseFVector instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %SparseFVector instance \a v.
    ...
    # \param v The \c %SparseFVector instance to be compared with.
    ...
    # \return A \c %SparseFVector instance holding the result of the subtraction.
    # 
