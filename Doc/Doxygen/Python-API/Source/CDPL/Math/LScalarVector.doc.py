...
class LScalarVector(Boost.Python.instance):
    ...
    # 
    # Different Python \c %LScalarVector instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %LScalarVector instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %LScalarVector instance \a v.
    ...
    # \param v The \c %LScalarVector instance to be compared with.
    ...
    # \return A \c %LScalarVector instance holding the result of the subtraction.
    # 
