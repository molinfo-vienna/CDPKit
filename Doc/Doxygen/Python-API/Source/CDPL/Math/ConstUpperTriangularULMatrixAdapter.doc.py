...
class ConstUpperTriangularULMatrixAdapter(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstUpperTriangularULMatrixAdapter instance \a a.
    # \param a The \e %ConstUpperTriangularULMatrixAdapter instance to copy.
    # 
    ...
    # 
    # Different Python \c %ConstUpperTriangularULMatrixAdapter instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstUpperTriangularULMatrixAdapter instances \e a and \e b reference different C++ objects. 
    ...
    # \param a The \c %ConstUpperTriangularULMatrixAdapter instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(a: ConstUpperTriangularULMatrixAdapter) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(a: ConstUpperTriangularULMatrixAdapter) -> bool: pass
    ...
    # \return 
    #
    def __pos__() -> ConstUpperTriangularULMatrixAdapter: pass
    ...
    # \return A \c %ConstUpperTriangularULMatrixAdapter instance holding the result of the subtraction.
    # 
