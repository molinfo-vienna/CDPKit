...
##
# \brief A bounded 4 element vector holding signed integers of type <tt>int</tt>.
# 
class Vector4L(Boost.Python.instance):

    ##
    # \brief Initializes the \c %Vector4L instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \c %Vector4L instance \a v.
    # \param v The \c %Vector4L instance to copy.
    # 
    def __init__(v: Vector4L) -> None: pass
    ...
    # 
    # Different Python \c %Vector4L instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector4L instances \e a and \e b reference different C++ objects. 
    ...
    # \return \a self
    # 
    def assign(e: ConstFVectorExpression) -> Vector4L: pass
    ...
    # \return \a self
    # 
    def assign(e: ConstDVectorExpression) -> Vector4L: pass
    ...
    # \return \a self
    # 
    def assign(e: ConstLVectorExpression) -> Vector4L: pass
    ...
    # \return \a self
    # 
    def assign(e: ConstULVectorExpression) -> Vector4L: pass

    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector4L instance \a v.
    # \param v The \c %Vector4L instance to copy.
    # \return \a self
    # 
    def assign(v: Vector4L) -> Vector4L: pass
    ...
    # \param v The \c %Vector4L instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(v: Vector4L) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(v: Vector4L) -> bool: pass
    ...
    ##
    # \brief Returns a string representation of the \c %Vector4L instance.
    ...
    # \return A \c %Vector4L instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Vector4L instance \a self.
    # 
    def __iadd__(v: Vector4L) -> Vector4L: pass
    ...
    # \return The updated \c %Vector4L instance \a self.
    # 
    def __iadd__(e: ConstLVectorExpression) -> Vector4L: pass
    ...
    # \return The updated \c %Vector4L instance \a self.
    # 
    def __isub__(v: Vector4L) -> Vector4L: pass
    ...
    # \return The updated \c %Vector4L instance \a self.
    # 
    def __isub__(e: ConstLVectorExpression) -> Vector4L: pass
    ...
    # \return The updated \c %Vector4L instance \a self.
    # 
    def __imul__(t: int) -> Vector4L: pass
