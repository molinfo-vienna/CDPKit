...
class ConstDVectorSlice(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \c %ConstDVectorSlice instance \a s.
    # \param s The \c %ConstDVectorSlice instance to copy.
    # 
    def __init__(s: ConstDVectorSlice) -> None: pass

    ##
    # \brief Initializes the \c %ConstDVectorSlice instance.
    # \param e 
    # \param s 
    # 
    def __init__(e: ConstDVectorExpression, s: Slice) -> None: pass
    ...
    # 
    # Different Python \c %ConstDVectorSlice instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstDVectorSlice instances \e a and \e b reference different C++ objects. 
    ...
    # \param s The \c %ConstDVectorSlice instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %ConstDVectorSlice instance.
    ...
    # \return A \c %ConstDVectorSlice instance holding the result of the subtraction.
    # 
