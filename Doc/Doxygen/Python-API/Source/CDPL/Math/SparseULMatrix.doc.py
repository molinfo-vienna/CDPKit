...
class SparseULMatrix(Boost.Python.instance):
    ...
    # 
    # Different Python \c %SparseULMatrix instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %SparseULMatrix instances \e a and \e b reference different C++ objects. 
    ...
    # \param m The \c %SparseULMatrix instance to be compared with.
    ...
    # \return A \c %SparseULMatrix instance holding the result of the subtraction.
    # 
