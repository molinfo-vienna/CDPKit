...
class Matrix2UL(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \c %Matrix2UL instance.
    # 
    ...
    ##
    # \brief Initializes a copy of the \c %Matrix2UL instance \a m.
    # \param m The \c %Matrix2UL instance to copy.
    # 
    ...
    # 
    # Different Python \c %Matrix2UL instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Matrix2UL instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Matrix2UL instance \a m.
    # \param m The \c %Matrix2UL instance to copy.
    # \return \a self
    # 
    ...
    # \param m The \c %Matrix2UL instance to be compared with.
    ...
    ##
    # \brief Returns a string representation of the \c %Matrix2UL instance.
    ...
    # \return A \c %Matrix2UL instance holding the result of the subtraction.
    # 
    ...
    # \return The updated \c %Matrix2UL instance \a self.
    # 
