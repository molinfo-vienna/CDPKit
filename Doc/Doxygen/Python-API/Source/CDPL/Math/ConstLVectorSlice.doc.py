...
class ConstLVectorSlice(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %ConstLVectorSlice instance \a s.
    # \param s The \e %ConstLVectorSlice instance to copy.
    # 
    ...
    # 
    # Different Python \c %ConstLVectorSlice instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstLVectorSlice instances \e a and \e b reference different C++ objects. 
    ...
    # \param s The \c %ConstLVectorSlice instance to be compared with.
    # \return The result of the comparison operation.
    # 
    def __eq__(s: ConstLVectorSlice) -> bool: pass
    ...
    # \return The result of the comparison operation.
    # 
    def __ne__(s: ConstLVectorSlice) -> bool: pass
    ...
    # \return A \c %ConstLVectorSlice instance holding the result of the subtraction.
    # 
