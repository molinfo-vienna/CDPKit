...
class ConstFMatrixColumn(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ConstFMatrixColumn instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ConstFMatrixColumn instances \e a and \e b reference different C++ objects. 
    ...
    # \param c The \c %ConstFMatrixColumn instance to be compared with.
    ...
    # \return A \c %ConstFMatrixColumn instance holding the result of the subtraction.
    # 
