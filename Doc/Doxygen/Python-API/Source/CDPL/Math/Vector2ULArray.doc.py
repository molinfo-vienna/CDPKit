...
class Vector2ULArray(Boost.Python.instance):
    ...
    # 
    # Different Python \c %Vector2ULArray instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %Vector2ULArray instances \e a and \e b reference different C++ objects. 
    ...
    # 
    def resize(num_elem: int, value: Vector2UL) -> None: pass
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \c %Vector2ULArray instance \a array.
    # \param array The \c %Vector2ULArray instance to copy.
    # \return \a self
    # 
    def assign(array: Vector2ULArray) -> Vector2ULArray: pass
    ...
    # 
    def assign(num_elem: int, value: Vector2UL) -> None: pass
    ...
    # 
    def addElement(value: Vector2UL) -> None: pass

    ##
    # \brief 
    # \param values 
    #
    def addElements(values: Vector2ULArray) -> None: pass
    ...
    # 
    def insertElement(idx: int, value: Vector2UL) -> None: pass
    ...
    # 
    def insertElements(idx: int, num_elem: int, value: Vector2UL) -> None: pass
    ...
    # \param values 
    #
    def insertElements(index: int, values: Vector2ULArray) -> None: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getFirstElement() -> Vector2UL: pass
    ...
    # \throw Base.OperationFailed if the array is empty.
    # 
    def getLastElement() -> Vector2UL: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def getElement(idx: int) -> Vector2UL: pass
    ...
    # \throw Base.IndexError if the array is empty or <em>idx</em> is not in the range [0, getSize() - 1].
    # 
    def setElement(idx: int, value: Vector2UL) -> None: pass
    ...
    # \return 
    #
    def __getitem__(idx: int) -> Vector2UL: pass
