...
class GRAILXDescriptorCalculator(Boost.Python.instance):
    ...
    class ElementIndex(Boost.Python.enum):
        ...
        ##
        # \brief Sum of (any ligand HBD  target HBA-N) interaction scores.
        # 
        HBD_HBA_N_SCORE_SUM = 51

        ##
        # \brief Maximum (any ligand HBD  target HBA-N) interaction score.
        # 
        HBD_HBA_N_SCORE_MAX = 52

        ##
        # \brief Sum of (any ligand HBD  target HBA-O) interaction scores.
        # 
        HBD_HBA_O_SCORE_SUM = 53

        ##
        # \brief Maximum (any ligand HBD  target HBA-O) interaction score.
        # 
        HBD_HBA_O_SCORE_MAX = 54

        ##
        # \brief Sum of (any ligand HBD  target HBA-S) interaction scores.
        # 
        HBD_HBA_S_SCORE_SUM = 55

        ##
        # \brief Maximum (any ligand HBD  target HBA-S) interaction score.
        # 
        HBD_HBA_S_SCORE_MAX = 56

        ##
        # \brief Sum of (ligand HBD-N3  target HBA-N) interaction scores.
        # 
        HBD_N3_HBA_N_SCORE_SUM = 57

        ##
        # \brief Maximum (ligand HBD-N3  target HBA-N) interaction score.
        # 
        HBD_N3_HBA_N_SCORE_MAX = 58

        ##
        # \brief Sum of (ligand HBD-N3  target HBA-O) interaction scores.
        # 
        HBD_N3_HBA_O_SCORE_SUM = 59

        ##
        # \brief Maximum (ligand HBD-N3  target HBA-O) interaction score.
        # 
        HBD_N3_HBA_O_SCORE_MAX = 60

        ##
        # \brief Sum of (ligand HBD-N3  target HBA-S) interaction scores.
        # 
        HBD_N3_HBA_S_SCORE_SUM = 61

        ##
        # \brief Maximum (ligand HBD-N3  target HBA-S) interaction score.
        # 
        HBD_N3_HBA_S_SCORE_MAX = 62

        ##
        # \brief Sum of (ligand HBD-N2  target HBA-N) interaction scores.
        # 
        HBD_N2_HBA_N_SCORE_SUM = 63

        ##
        # \brief Maximum (ligand HBD-N2  target HBA-N) interaction score.
        # 
        HBD_N2_HBA_N_SCORE_MAX = 64

        ##
        # \brief Sum of (ligand HBD-N2  target HBA-O) interaction scores.
        # 
        HBD_N2_HBA_O_SCORE_SUM = 65

        ##
        # \brief Maximum (ligand HBD-N2  target HBA-O) interaction score.
        # 
        HBD_N2_HBA_O_SCORE_MAX = 66

        ##
        # \brief Sum of (ligand HBD-N2  target HBA-S) interaction scores.
        # 
        HBD_N2_HBA_S_SCORE_SUM = 67

        ##
        # \brief Maximum (ligand HBD-N2  target HBA-S) interaction score.
        # 
        HBD_N2_HBA_S_SCORE_MAX = 68

        ##
        # \brief Sum of (ligand HBD-Nar  target HBA-N) interaction scores.
        # 
        HBD_Nar_HBA_N_SCORE_SUM = 69

        ##
        # \brief Maximum (ligand HBD-Nar  target HBA-N) interaction score.
        # 
        HBD_Nar_HBA_N_SCORE_MAX = 70

        ##
        # \brief Sum of (ligand HBD-Nar  target HBA-O) interaction scores.
        # 
        HBD_Nar_HBA_O_SCORE_SUM = 71

        ##
        # \brief Maximum (ligand HBD-Nar  target HBA-O) interaction score.
        # 
        HBD_Nar_HBA_O_SCORE_MAX = 72

        ##
        # \brief Sum of (ligand HBD-Nar  target HBA-S) interaction scores.
        # 
        HBD_Nar_HBA_S_SCORE_SUM = 73

        ##
        # \brief Maximum (ligand HBD-Nar  target HBA-S) interaction score.
        # 
        HBD_Nar_HBA_S_SCORE_MAX = 74

        ##
        # \brief Sum of (ligand HBD-Nam  target HBA-N) interaction scores.
        # 
        HBD_Nam_HBA_N_SCORE_SUM = 75

        ##
        # \brief Maximum (ligand HBD-Nam  target HBA-N) interaction score.
        # 
        HBD_Nam_HBA_N_SCORE_MAX = 76

        ##
        # \brief Sum of (ligand HBD-Nam  target HBA-O) interaction scores.
        # 
        HBD_Nam_HBA_O_SCORE_SUM = 77

        ##
        # \brief Maximum (ligand HBD-Nam  target HBA-O) interaction score.
        # 
        HBD_Nam_HBA_O_SCORE_MAX = 78

        ##
        # \brief Sum of (ligand HBD-Nam  target HBA-S) interaction scores.
        # 
        HBD_Nam_HBA_S_SCORE_SUM = 79

        ##
        # \brief Maximum (ligand HBD-Nam  target HBA-S) interaction score.
        # 
        HBD_Nam_HBA_S_SCORE_MAX = 80

        ##
        # \brief Sum of (ligand HBD-Npl3  target HBA-N) interaction scores.
        # 
        HBD_Npl3_HBA_N_SCORE_SUM = 81

        ##
        # \brief Maximum (ligand HBD-Npl3  target HBA-N) interaction score.
        # 
        HBD_Npl3_HBA_N_SCORE_MAX = 82

        ##
        # \brief Sum of (ligand HBD-Npl3  target HBA-O) interaction scores.
        # 
        HBD_Npl3_HBA_O_SCORE_SUM = 83

        ##
        # \brief Maximum (ligand HBD-Npl3  target HBA-O) interaction score.
        # 
        HBD_Npl3_HBA_O_SCORE_MAX = 84

        ##
        # \brief Sum of (ligand HBD-Npl3  target HBA-S) interaction scores.
        # 
        HBD_Npl3_HBA_S_SCORE_SUM = 85

        ##
        # \brief Maximum (ligand HBD-Npl3  target HBA-S) interaction score.
        # 
        HBD_Npl3_HBA_S_SCORE_MAX = 86

        ##
        # \brief Sum of (ligand HBD-N4  target HBA-N) interaction scores.
        # 
        HBD_N4_HBA_N_SCORE_SUM = 87

        ##
        # \brief Maximum (ligand HBD-N4  target HBA-N) interaction score.
        # 
        HBD_N4_HBA_N_SCORE_MAX = 88

        ##
        # \brief Sum of (ligand HBD-N4  target HBA-O) interaction scores.
        # 
        HBD_N4_HBA_O_SCORE_SUM = 89

        ##
        # \brief Maximum (ligand HBD-N4  target HBA-O) interaction score.
        # 
        HBD_N4_HBA_O_SCORE_MAX = 90

        ##
        # \brief Sum of (ligand HBD-N4  target HBA-S) interaction scores.
        # 
        HBD_N4_HBA_S_SCORE_SUM = 91

        ##
        # \brief Maximum (ligand HBD-N4  target HBA-S) interaction score.
        # 
        HBD_N4_HBA_S_SCORE_MAX = 92

        ##
        # \brief Sum of (ligand HBD-O3  target HBA-N) interaction scores.
        # 
        HBD_O3_HBA_N_SCORE_SUM = 93

        ##
        # \brief Maximum (ligand HBD-O3  target HBA-N) interaction score.
        # 
        HBD_O3_HBA_N_SCORE_MAX = 94

        ##
        # \brief Sum of (ligand HBD-O3  target HBA-O) interaction scores.
        # 
        HBD_O3_HBA_O_SCORE_SUM = 95

        ##
        # \brief Maximum (ligand HBD-O3  target HBA-O) interaction score.
        # 
        HBD_O3_HBA_O_SCORE_MAX = 96

        ##
        # \brief Sum of (ligand HBD-O3  target HBA-S) interaction scores.
        # 
        HBD_O3_HBA_S_SCORE_SUM = 97

        ##
        # \brief Maximum (ligand HBD-O3  target HBA-S) interaction score.
        # 
        HBD_O3_HBA_S_SCORE_MAX = 98

        ##
        # \brief Sum of (ligand HBD-S3  target HBA-N) interaction scores.
        # 
        HBD_S3_HBA_N_SCORE_SUM = 99

        ##
        # \brief Maximum (ligand HBD-S3  target HBA-N) interaction score.
        # 
        HBD_S3_HBA_N_SCORE_MAX = 100

        ##
        # \brief Sum of (ligand HBD-S3  target HBA-O) interaction scores.
        # 
        HBD_S3_HBA_O_SCORE_SUM = 101

        ##
        # \brief Maximum (ligand HBD-S3  target HBA-O) interaction score.
        # 
        HBD_S3_HBA_O_SCORE_MAX = 102

        ##
        # \brief Sum of (ligand HBD-S3  target HBA-S) interaction scores.
        # 
        HBD_S3_HBA_S_SCORE_SUM = 103

        ##
        # \brief Maximum (ligand HBD-S3  target HBA-S) interaction score.
        # 
        HBD_S3_HBA_S_SCORE_MAX = 104

        ##
        # \brief Sum of (any ligand HBA  target HBD-N) interaction scores.
        # 
        HBA_HBD_N_SCORE_SUM = 105

        ##
        # \brief Maximum (any ligand HBA  target HBD-N) interaction score.
        # 
        HBA_HBD_N_SCORE_MAX = 106

        ##
        # \brief Sum of (any ligand HBA  target HBD-O) interaction scores.
        # 
        HBA_HBD_O_SCORE_SUM = 107

        ##
        # \brief Maximum (any ligand HBA  target HBD-O) interaction score.
        # 
        HBA_HBD_O_SCORE_MAX = 108

        ##
        # \brief Sum of (any ligand HBA  target HBD-S) interaction scores.
        # 
        HBA_HBD_S_SCORE_SUM = 109

        ##
        # \brief Maximum (any ligand HBA  target HBD-S) interaction score.
        # 
        HBA_HBD_S_SCORE_MAX = 110

        ##
        # \brief Sum of (ligand HBA-N3  target HBD-N) interaction scores.
        # 
        HBA_N3_HBD_N_SCORE_SUM = 111

        ##
        # \brief Maximum (ligand HBA-N3  target HBD-N) interaction score.
        # 
        HBA_N3_HBD_N_SCORE_MAX = 112

        ##
        # \brief Sum of (ligand HBA-N3  target HBD-O) interaction scores.
        # 
        HBA_N3_HBD_O_SCORE_SUM = 113

        ##
        # \brief Maximum (ligand HBA-N3  target HBD-O) interaction score.
        # 
        HBA_N3_HBD_O_SCORE_MAX = 114

        ##
        # \brief Sum of (ligand HBA-N3  target HBD-S) interaction scores.
        # 
        HBA_N3_HBD_S_SCORE_SUM = 115

        ##
        # \brief Maximum (ligand HBA-N3  target HBD-S) interaction score.
        # 
        HBA_N3_HBD_S_SCORE_MAX = 116

        ##
        # \brief Sum of (ligand HBA-N2  target HBD-N) interaction scores.
        # 
        HBA_N2_HBD_N_SCORE_SUM = 117

        ##
        # \brief Maximum (ligand HBA-N2  target HBD-N) interaction score.
        # 
        HBA_N2_HBD_N_SCORE_MAX = 118

        ##
        # \brief Sum of (ligand HBA-N2  target HBD-O) interaction scores.
        # 
        HBA_N2_HBD_O_SCORE_SUM = 119

        ##
        # \brief Maximum (ligand HBA-N2  target HBD-O) interaction score.
        # 
        HBA_N2_HBD_O_SCORE_MAX = 120

        ##
        # \brief Sum of (ligand HBA-N2  target HBD-S) interaction scores.
        # 
        HBA_N2_HBD_S_SCORE_SUM = 121

        ##
        # \brief Maximum (ligand HBA-N2  target HBD-S) interaction score.
        # 
        HBA_N2_HBD_S_SCORE_MAX = 122

        ##
        # \brief Sum of (ligand HBA-N1  target HBD-N) interaction scores.
        # 
        HBA_N1_HBD_N_SCORE_SUM = 123

        ##
        # \brief Maximum (ligand HBA-N1  target HBD-N) interaction score.
        # 
        HBA_N1_HBD_N_SCORE_MAX = 124

        ##
        # \brief Sum of (ligand HBA-N1  target HBD-O) interaction scores.
        # 
        HBA_N1_HBD_O_SCORE_SUM = 125

        ##
        # \brief Maximum (ligand HBA-N1  target HBD-O) interaction score.
        # 
        HBA_N1_HBD_O_SCORE_MAX = 126

        ##
        # \brief Sum of (ligand HBA-N1  target HBD-S) interaction scores.
        # 
        HBA_N1_HBD_S_SCORE_SUM = 127

        ##
        # \brief Maximum (ligand HBA-N1  target HBD-S) interaction score.
        # 
        HBA_N1_HBD_S_SCORE_MAX = 128

        ##
        # \brief Sum of (ligand HBA-Nar  target HBD-N) interaction scores.
        # 
        HBA_Nar_HBD_N_SCORE_SUM = 129

        ##
        # \brief Maximum (ligand HBA-Nar  target HBD-N) interaction score.
        # 
        HBA_Nar_HBD_N_SCORE_MAX = 130

        ##
        # \brief Sum of (ligand HBA-Nar  target HBD-O) interaction scores.
        # 
        HBA_Nar_HBD_O_SCORE_SUM = 131

        ##
        # \brief Maximum (ligand HBA-Nar  target HBD-O) interaction score.
        # 
        HBA_Nar_HBD_O_SCORE_MAX = 132

        ##
        # \brief Sum of (ligand HBA-Nar  target HBD-S) interaction scores.
        # 
        HBA_Nar_HBD_S_SCORE_SUM = 133

        ##
        # \brief Maximum (ligand HBA-Nar  target HBD-S) interaction score.
        # 
        HBA_Nar_HBD_S_SCORE_MAX = 134

        ##
        # \brief Sum of (ligand HBA-Npl3  target HBD-N) interaction scores.
        # 
        HBA_Npl3_HBD_N_SCORE_SUM = 135

        ##
        # \brief Maximum (ligand HBA-Npl3  target HBD-N) interaction score.
        # 
        HBA_Npl3_HBD_N_SCORE_MAX = 136

        ##
        # \brief Sum of (ligand HBA-Npl3  target HBD-O) interaction scores.
        # 
        HBA_Npl3_HBD_O_SCORE_SUM = 137

        ##
        # \brief Maximum (ligand HBA-Npl3  target HBD-O) interaction score.
        # 
        HBA_Npl3_HBD_O_SCORE_MAX = 138

        ##
        # \brief Sum of (ligand HBA-Npl3  target HBD-S) interaction scores.
        # 
        HBA_Npl3_HBD_S_SCORE_SUM = 139

        ##
        # \brief Maximum (ligand HBA-Npl3  target HBD-S) interaction score.
        # 
        HBA_Npl3_HBD_S_SCORE_MAX = 140

        ##
        # \brief Sum of (ligand HBA-O3  target HBD-N) interaction scores.
        # 
        HBA_O3_HBD_N_SCORE_SUM = 141

        ##
        # \brief Maximum (ligand HBA-O3  target HBD-N) interaction score.
        # 
        HBA_O3_HBD_N_SCORE_MAX = 142

        ##
        # \brief Sum of (ligand HBA-O3  target HBD-O) interaction scores.
        # 
        HBA_O3_HBD_O_SCORE_SUM = 143

        ##
        # \brief Maximum (ligand HBA-O3  target HBD-O) interaction score.
        # 
        HBA_O3_HBD_O_SCORE_MAX = 144

        ##
        # \brief Sum of (ligand HBA-O3  target HBD-S) interaction scores.
        # 
        HBA_O3_HBD_S_SCORE_SUM = 145

        ##
        # \brief Maximum (ligand HBA-O3  target HBD-S) interaction score.
        # 
        HBA_O3_HBD_S_SCORE_MAX = 146

        ##
        # \brief Sum of (ligand HBA-O2  target HBD-N) interaction scores.
        # 
        HBA_O2_HBD_N_SCORE_SUM = 147

        ##
        # \brief Maximum (ligand HBA-O2  target HBD-N) interaction score.
        # 
        HBA_O2_HBD_N_SCORE_MAX = 148

        ##
        # \brief Sum of (ligand HBA-O2  target HBD-O) interaction scores.
        # 
        HBA_O2_HBD_O_SCORE_SUM = 149

        ##
        # \brief Maximum (ligand HBA-O2  target HBD-O) interaction score.
        # 
        HBA_O2_HBD_O_SCORE_MAX = 150

        ##
        # \brief Sum of (ligand HBA-O2  target HBD-S) interaction scores.
        # 
        HBA_O2_HBD_S_SCORE_SUM = 151

        ##
        # \brief Maximum (ligand HBA-O2  target HBD-S) interaction score.
        # 
        HBA_O2_HBD_S_SCORE_MAX = 152

        ##
        # \brief Sum of (ligand HBA-Oco2  target HBD-N) interaction scores.
        # 
        HBA_Oco2_HBD_N_SCORE_SUM = 153

        ##
        # \brief Maximum (ligand HBA-Oco2  target HBD-N) interaction score.
        # 
        HBA_Oco2_HBD_N_SCORE_MAX = 154

        ##
        # \brief Sum of (ligand HBA-Oco2  target HBD-O) interaction scores.
        # 
        HBA_Oco2_HBD_O_SCORE_SUM = 155

        ##
        # \brief Maximum (ligand HBA-Oco2  target HBD-O) interaction score.
        # 
        HBA_Oco2_HBD_O_SCORE_MAX = 156

        ##
        # \brief Sum of (ligand HBA-Oco2  target HBD-S) interaction scores.
        # 
        HBA_Oco2_HBD_S_SCORE_SUM = 157

        ##
        # \brief Maximum (ligand HBA-Oco2  target HBD-S) interaction score.
        # 
        HBA_Oco2_HBD_S_SCORE_MAX = 158

        ##
        # \brief Sum of (ligand HBA-S3  target HBD-N) interaction scores.
        # 
        HBA_S3_HBD_N_SCORE_SUM = 159

        ##
        # \brief Maximum (ligand HBA-S3  target HBD-N) interaction score.
        # 
        HBA_S3_HBD_N_SCORE_MAX = 160

        ##
        # \brief Sum of (ligand HBA-S3  target HBD-O) interaction scores.
        # 
        HBA_S3_HBD_O_SCORE_SUM = 161

        ##
        # \brief Maximum (ligand HBA-S3  target HBD-O) interaction score.
        # 
        HBA_S3_HBD_O_SCORE_MAX = 162

        ##
        # \brief Sum of (ligand HBA-S3  target HBD-S) interaction scores.
        # 
        HBA_S3_HBD_S_SCORE_SUM = 163

        ##
        # \brief Maximum (ligand HBA-S3  target HBD-S) interaction score.
        # 
        HBA_S3_HBD_S_SCORE_MAX = 164

        ##
        # \brief Sum of (ligand HBA-S2  target HBD-N) interaction scores.
        # 
        HBA_S2_HBD_N_SCORE_SUM = 165

        ##
        # \brief Maximum (ligand HBA-S2  target HBD-N) interaction score.
        # 
        HBA_S2_HBD_N_SCORE_MAX = 166

        ##
        # \brief Sum of (ligand HBA-S2  target HBD-O) interaction scores.
        # 
        HBA_S2_HBD_O_SCORE_SUM = 167

        ##
        # \brief Maximum (ligand HBA-S2  target HBD-O) interaction score.
        # 
        HBA_S2_HBD_O_SCORE_MAX = 168

        ##
        # \brief Sum of (ligand HBA-S2  target HBD-S) interaction scores.
        # 
        HBA_S2_HBD_S_SCORE_SUM = 169

        ##
        # \brief Maximum (ligand HBA-S2  target HBD-S) interaction score.
        # 
