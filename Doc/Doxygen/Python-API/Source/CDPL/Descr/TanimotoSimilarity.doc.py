...
class TanimotoSimilarity(Boost.Python.instance):
    ...
    # 
    # Different Python \e %TanimotoSimilarity instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %TanimotoSimilarity instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %TanimotoSimilarity instance \a func.
    # \param func The \e %TanimotoSimilarity instance to copy.
    # \return \a self
    # 
    def assign(func: TanimotoSimilarity) -> TanimotoSimilarity: pass

    ##
    # \brief Calculates the <em>Tanimoto Similarity</em> of the bitsets <em>bs1</em> and <em>bs2</em>.
    # 
    ...
    ##
    # \brief Calculates the <em>Tanimoto Similarity</em> of the vectors <em>v1</em> and <em>v2</em>.
    # 
