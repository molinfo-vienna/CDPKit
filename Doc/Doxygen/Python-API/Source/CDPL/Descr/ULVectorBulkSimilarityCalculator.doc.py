...
class ULVectorBulkSimilarityCalculator(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ULVectorBulkSimilarityCalculator instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ULVectorBulkSimilarityCalculator instances \e a and \e b reference different C++ objects. 
    ...
    # \return \a self
    # 
    def assign(calc: ULVectorBulkSimilarityCalculator) -> ULVectorBulkSimilarityCalculator: pass

    ##
    # \brief 
    # \param func 
    #
    def setSimilarityFunction(func: DoubleULVector2Functor) -> None: pass

    ##
    # \brief 
    # \return 
    #
    def getSimilarityFunction() -> DoubleULVector2Functor: pass
    ...
    # \param descr 
    #
    def addDescriptor(descr: Math.ULVector) -> None: pass
    ...
    # \return 
    #
    def containsDescriptor(descr: Math.ULVector) -> bool: pass
    ...
    # \return 
    #
    def getDescriptor(idx: int) -> Math.ULVector: pass
    ...
    # \param sort_desc 
    #
    def calculate(descr: Math.ULVector, sort: bool = False, sort_desc: bool = True) -> None: pass
    ...
    # 
    def __contains__(descr: Math.ULVector) -> bool: pass
