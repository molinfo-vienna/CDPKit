...
class MoleculeAutoCorr3DDescriptorCalculator(Boost.Python.instance):
    ...
    ##
    # \brief Initializes a copy of the \e %MoleculeAutoCorr3DDescriptorCalculator instance \a calc.
    ...
    # 
    # Different Python \c %MoleculeAutoCorr3DDescriptorCalculator instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %MoleculeAutoCorr3DDescriptorCalculator instances \e a and \e b reference different C++ objects. 
