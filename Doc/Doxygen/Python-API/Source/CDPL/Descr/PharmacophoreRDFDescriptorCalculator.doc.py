...
class PharmacophoreRDFDescriptorCalculator(Boost.Python.instance):
    ...
    ##
    # \brief Constructs the <tt>PharmacophoreRDFDescriptorCalculator</tt> instance.
    # 
    def __init__() -> None: pass

    ##
    # \brief Initializes a copy of the \e %PharmacophoreRDFDescriptorCalculator instance \a calc.
    ...
    # 
    # Different Python \c %PharmacophoreRDFDescriptorCalculator instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %PharmacophoreRDFDescriptorCalculator instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Allows to specify the smoothing factor used in the calculation of feature pair <em>RDF</em> contributions.
    # 
    ...
    ##
    # \brief Returns the smoothing factor used in the calculation of feature pair <em>RDF</em> contributions.
    # 
