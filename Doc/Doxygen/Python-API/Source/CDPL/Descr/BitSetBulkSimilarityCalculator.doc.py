...
class BitSetBulkSimilarityCalculator(Boost.Python.instance):
    ...
    # 
    # Different Python \c %BitSetBulkSimilarityCalculator instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %BitSetBulkSimilarityCalculator instances \e a and \e b reference different C++ objects. 
    ...
    # 
    def __contains__(descr: Util.BitSet) -> bool: pass
