...
class AtomAutoCorrelation3DVectorCalculator(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %AtomAutoCorrelation3DVectorCalculator instance with a copy of the state of the \e %AtomAutoCorrelation3DVectorCalculator instance \a calc.
