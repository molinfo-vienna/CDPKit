...
class ManhattanSimilarity(Boost.Python.instance):
    ...
    # 
    # Different Python \e %ManhattanSimilarity instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %ManhattanSimilarity instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %ManhattanSimilarity instance \a func.
    # \param func The \e %ManhattanSimilarity instance to copy.
    # \return \a self
    # 
    def assign(func: ManhattanSimilarity) -> ManhattanSimilarity: pass
