...
class EuclideanSimilarity(Boost.Python.instance):
    ...
    # 
    # Different Python \e %EuclideanSimilarity instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %EuclideanSimilarity instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %EuclideanSimilarity instance \a func.
    # \param func The \e %EuclideanSimilarity instance to copy.
    # \return \a self
    # 
