...
class PharmacophoreAutoCorr3DDescriptorCalculator(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %PharmacophoreAutoCorr3DDescriptorCalculator instance with a copy of the state of the \e %PharmacophoreAutoCorr3DDescriptorCalculator instance \a calc.
