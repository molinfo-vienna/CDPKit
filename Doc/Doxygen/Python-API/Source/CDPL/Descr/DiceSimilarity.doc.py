...
class DiceSimilarity(Boost.Python.instance):
    ...
    # 
    # Different Python \e %DiceSimilarity instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \e %DiceSimilarity instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Replaces the current state of \a self with a copy of the state of the \e %DiceSimilarity instance \a func.
    # \param func The \e %DiceSimilarity instance to copy.
    # \return \a self
    # 
    def assign(func: DiceSimilarity) -> DiceSimilarity: pass
