...
class MolecularGraphPointerStringFunctor(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %MolecularGraphPointerStringFunctor instance with a copy of the state of the \e %MolecularGraphPointerStringFunctor instance \a func.
    # \param func The \e %MolecularGraphPointerStringFunctor instance to copy.
    # 
