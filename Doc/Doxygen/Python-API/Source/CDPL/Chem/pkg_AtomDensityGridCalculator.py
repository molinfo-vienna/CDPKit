...
class AtomDensityGridCalculator(Boost.Python.instance):
    ...
    # \param comb_func 
    #
    def __init__(density_func: DoubleVector3D2AtomFunctor, comb_func: CDPL.Math.DoubleDVectorFunctor) -> None: pass
    ...
    # \return 
    #
    def getDensityFunction() -> DoubleVector3D2AtomFunctor: pass

    ##
    # \brief 
    # \param func 
    #
    def setDensityFunction(func: DoubleVector3D2AtomFunctor) -> None: pass
