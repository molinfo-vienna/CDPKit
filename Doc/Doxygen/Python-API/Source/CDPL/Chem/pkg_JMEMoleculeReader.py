...
# </table>
# 
# The error handling behaviour of a <tt>JMEMoleculeReader</tt> instance can be configured with the following control-parameter:
# 
# <table>
...
class JMEMoleculeReader(MoleculeReaderBase):
    ...
    ##
    # \brief Constructs a <tt>JMEMoleculeReader</tt> instance that will read the molecule data from the input stream <em>is</em>.
    # 
