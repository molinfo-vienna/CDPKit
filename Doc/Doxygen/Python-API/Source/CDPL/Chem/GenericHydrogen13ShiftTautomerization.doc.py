...
class GenericHydrogen13ShiftTautomerization(PatternBasedTautomerizationRule):
    ...
    ##
    # \brief Initializes the \e %GenericHydrogen13ShiftTautomerization instance with a copy of the state of the \e %GenericHydrogen13ShiftTautomerization instance \a rule.
