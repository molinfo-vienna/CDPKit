...
class MaxCommonAtomSubstructureSearch(Boost.Python.instance):
    ...
    # 
    # Different Python \c %MaxCommonAtomSubstructureSearch instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %MaxCommonAtomSubstructureSearch instances \e a and \e b reference different C++ objects. 
