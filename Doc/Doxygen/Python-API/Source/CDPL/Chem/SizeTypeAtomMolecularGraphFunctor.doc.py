...
class SizeTypeAtomMolecularGraphFunctor(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %SizeTypeAtomMolecularGraphFunctor instance with a copy of the state of the \e %SizeTypeAtomMolecularGraphFunctor instance \a func.
    # \param func The \e %SizeTypeAtomMolecularGraphFunctor instance to copy.
    # 
