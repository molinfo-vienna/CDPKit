...
class SubstructureHistogramGenerator(Boost.Python.instance):
    ...
    # \param generator 
    #
    def __init__(generator: SubstructureHistogramGenerator) -> None: pass
    ...
    # \param histo 
    #
    def generate(molgraph: MolecularGraph, histo: object) -> None: pass
    ...
    # \return The assignment target \a self.
    #
    def assign(generator: SubstructureHistogramGenerator) -> SubstructureHistogramGenerator: pass
