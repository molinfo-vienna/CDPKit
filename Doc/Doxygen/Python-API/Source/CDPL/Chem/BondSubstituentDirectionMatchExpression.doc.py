...
class BondSubstituentDirectionMatchExpression(BondMatchExpression):
    ...
    ##
    # \brief Initializes the \e %BondSubstituentDirectionMatchExpression instance with a copy of the state of the \e %BondSubstituentDirectionMatchExpression instance \a expr.
