...
##
# \brief Singleton class that serves as a global registry for Chem.MoleculeInputHandler and Chem.MoleculeOutputHandler implementation instances.
# 
...
class MoleculeIOManager(Boost.Python.instance):
    ...
    class InputHandlerSequence(Boost.Python.instance):
        ...
        #
        @staticmethod
        def __getitem__(fmt: Base.DataFormat) -> MoleculeInputHandler: pass
    ...
    class OutputHandlerSequence(Boost.Python.instance):
        ...
        #
        @staticmethod
        def __getitem__(fmt: Base.DataFormat) -> MoleculeOutputHandler: pass
    ...
    # 
    # \return A reference to a Chem.MoleculeInputHandler implementation instance registered for the specified data format, or <tt>None</tt> if not available.
    # 
    @staticmethod
    def getInputHandlerByFormat(fmt: Base.DataFormat) -> MoleculeInputHandler: pass
    ...
    # 
    # \return A reference to a Chem.MoleculeInputHandler implementation instance registered for the data format with the specified name, or <tt>None</tt> if not available. 
    # 
    ...
    # 
    # \return A reference to a Chem.MoleculeInputHandler implementation instance registered for the data format with the specified file extension, or <tt>None</tt> if not available. 
    # 
    ...
    ##
    # \brief Returns a reference to a Chem.MoleculeInputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>.
    # 
    # \param file_name Specifies the file name for which to search for a data format that matches its extension.
    # 
    # \return A reference to a Chem.MoleculeInputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    def getInputHandlerByFileName(file_name: str) -> MoleculeInputHandler: pass
    ...
    # 
    # \return A reference to a Chem.MoleculeInputHandler implementation instance registered for the data format with the specified mime-type, or <tt>None</tt> if not available. 
    # 
    ...
    # 
    # \return A reference to a Chem.MoleculeOutputHandler implementation instance registered for the specified data format, or <tt>None</tt> if not available.
    # 
    @staticmethod
    def getOutputHandlerByFormat(fmt: Base.DataFormat) -> MoleculeOutputHandler: pass
    ...
    # 
    # \return A reference to a Chem.MoleculeOutputHandler implementation instance registered for the data format with the specified name, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the name is not case-sensitive.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Chem.MoleculeOutputHandler implementation instance registered for the data format with the specified file extension, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    ...
    ##
    # \brief Returns a reference to a Chem.MoleculeOutputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>.
    # 
    # \param file_name Specifies the file name for which to search for a data format that matches its extension.
    # 
    # \return A reference to a Chem.MoleculeOutputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    def getOutputHandlerByFileName(file_name: str) -> MoleculeOutputHandler: pass
    ...
    # 
    # \return A reference to a Chem.MoleculeOutputHandler implementation instance registered for the data format with the specified mime-type, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the mime-type is not case-sensitive.
    # 
    @staticmethod
