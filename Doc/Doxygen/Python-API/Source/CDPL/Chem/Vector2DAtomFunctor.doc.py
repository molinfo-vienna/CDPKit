...
class Vector2DAtomFunctor(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %Vector2DAtomFunctor instance with a copy of the state of the \e %Vector2DAtomFunctor instance \a func.
    ...
    # \return 
    #
    def __call__(arg1: Atom) -> Math.Vector2D: pass
