...
##
# \brief Singleton class that serves as a global registry for Chem.MolecularGraphInputHandler and Chem.MolecularGraphOutputHandler implementation instances.
# 
...
class MolecularGraphIOManager(Boost.Python.instance):
    ...
    # 
    # \return A reference to a Chem.MolecularGraphInputHandler implementation instance registered for the specified data format, or <tt>None</tt> if not available.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Chem.MolecularGraphInputHandler implementation instance registered for the data format with the specified name, or <tt>None</tt> if not available. 
    # 
    ...
    # 
    # \return A reference to a Chem.MolecularGraphInputHandler implementation instance registered for the data format with the specified file extension, or <tt>None</tt> if not available. 
    # 
    ...
    ##
    # \brief Returns a reference to a Chem.MolecularGraphInputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>.
    # 
    # \param file_name Specifies the file name for which to search for a data format that matches its extension.
    # 
    # \return A reference to a Chem.MolecularGraphInputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    def getInputHandlerByFileName(file_name: str) -> MolecularGraphInputHandler: pass
    ...
    # 
    # \return A reference to a Chem.MolecularGraphInputHandler implementation instance registered for the data format with the specified mime-type, or <tt>None</tt> if not available. 
    # 
    ...
    # 
    # \return A reference to a Chem.MolecularGraphOutputHandler implementation instance registered for the specified data format, or <tt>None</tt> if not available.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Chem.MolecularGraphOutputHandler implementation instance registered for the data format with the specified name, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the name is not case-sensitive.
    # 
    @staticmethod
    ...
    # 
    # \return A reference to a Chem.MolecularGraphOutputHandler implementation instance registered for the data format with the specified file extension, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    ...
    ##
    # \brief Returns a reference to a Chem.MolecularGraphOutputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>.
    # 
    # \param file_name Specifies the file name for which to search for a data format that matches its extension.
    # 
    # \return A reference to a Chem.MolecularGraphOutputHandler implementation instance registered for the data format matching the extension of <em>file_name</em>, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the file extension is not case-sensitive.
    # 
    @staticmethod
    def getOutputHandlerByFileName(file_name: str) -> MolecularGraphOutputHandler: pass
    ...
    # 
    # \return A reference to a Chem.MolecularGraphOutputHandler implementation instance registered for the data format with the specified mime-type, or <tt>None</tt> if not available. 
    # 
    # \note The matching of the mime-type is not case-sensitive.
    # 
    @staticmethod
