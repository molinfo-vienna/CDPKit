...
class ANDReactionMatchExpressionList(ReactionMatchExpressionList):
    ...
    # \param expr 
    #
    def __init__(self: object, expr: ANDReactionMatchExpressionList) -> None: pass
    ...
    #
    def assign(self: ANDReactionMatchExpressionList, expr: ANDReactionMatchExpressionList) -> ANDReactionMatchExpressionList: pass
