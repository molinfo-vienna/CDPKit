...
class BondMatchExpression(Boost.Python.instance):
    ...
    # \param self The \e %BondMatchExpression instance to initialize.
    # 
    def __init__() -> None: pass

    ##
    # \brief Returns the numeric identifier (ID) of the wrapped C++ class instance.
    # \param self The \e %BondMatchExpression instance this method is called upon.
    # 
    ...
    # 
    def __call__(query_bond: Bond, query_molgraph: MolecularGraph, target_bond: Bond, target_molgraph: MolecularGraph, aux_data: CDPL.Base.Any) -> bool: pass
    ...
    # 
    def __call__(query_bond: Bond, query_molgraph: MolecularGraph, target_bond: Bond, target_molgraph: MolecularGraph, mapping: AtomBondMapping, aux_data: CDPL.Base.Any) -> bool: pass
