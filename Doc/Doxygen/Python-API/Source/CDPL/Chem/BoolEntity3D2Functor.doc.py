...
class BoolEntity3D2Functor(Boost.Python.instance):
    ...
    ##
    # \brief Initializes the \e %BoolEntity3D2Functor instance with a copy of the state of the \e %BoolEntity3D2Functor instance \a func.
    ...
    # \return 
    #
    def __call__(arg1: Entity3D, arg2: Entity3D) -> bool: pass
