...
class ReactionMatchExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %ReactionMatchExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %ReactionMatchExpression instances \e a and \e b reference different C++ objects. 
    ...
    ##
    # \brief Performs an evaluation of the expression for the given query and target reactions.
    # 
    ...
    # 
    # \return The result of the expression evaluation for the specified query and target reactions. 
    # 
