...
class ORReactionMatchExpressionList(ReactionMatchExpressionList):
    ...
    # \param expr 
    #
    def __init__(self: object, expr: ORReactionMatchExpressionList) -> None: pass
    ...
    #
    def assign(self: ORReactionMatchExpressionList, expr: ORReactionMatchExpressionList) -> ORReactionMatchExpressionList: pass
