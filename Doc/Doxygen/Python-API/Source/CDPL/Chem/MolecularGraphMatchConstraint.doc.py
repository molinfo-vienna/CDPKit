...
class MolecularGraphMatchConstraint(Boost.Python.instance):
    ...
    ##
    # \brief Specifies a constraint which requires the target molecular graph to fulfill additional constraints specified by a Chem.MatchConstraintList object.
    # 
    CONSTRAINT_LIST = 0
