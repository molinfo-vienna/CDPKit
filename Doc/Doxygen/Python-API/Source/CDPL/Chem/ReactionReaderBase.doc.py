...
# 
# For reading data records in a random access manner, the method read(idx: int, rxn: Reaction) is available. In contrast to the former read() method, this method expects the index of the record to read as the first argument.
# 
