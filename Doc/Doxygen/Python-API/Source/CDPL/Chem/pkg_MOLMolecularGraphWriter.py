...
# </table>
# 
class MOLMolecularGraphWriter(MolecularGraphWriterBase):

    ##
    # \brief Constructs a <tt>MOLMolecularGraphWriter</tt> instance that will write data of molecular graphs to the output stream <em>os</em>.
    # 
