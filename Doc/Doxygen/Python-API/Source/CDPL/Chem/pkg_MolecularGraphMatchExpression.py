...
class MolecularGraphMatchExpression(Boost.Python.instance):
    ...
    # 
    def __call__(query_molgraph: MolecularGraph, target_molgraph: MolecularGraph, aux_data: CDPL.Base.Any) -> bool: pass
    ...
    # 
    def __call__(query_molgraph: MolecularGraph, target_molgraph: MolecularGraph, mapping: AtomBondMapping, aux_data: CDPL.Base.Any) -> bool: pass
