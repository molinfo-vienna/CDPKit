...
class ControlParameter(Boost.Python.instance):
    ...
    ##
    # \brief Specifies the minimum ring size that is required for the specification of ring double bond geometries in generated <em>SMILES</em> strings.
    # 
    # \see [\ref SMILES] 
    # \valuetype  <tt>std::size_t</tt> 
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings with atom parity specifications.
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings that include directional bonds for the definition of double bond geometries.
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings that also include directional bonds for the definition of ring double bond geometries.
    # 
