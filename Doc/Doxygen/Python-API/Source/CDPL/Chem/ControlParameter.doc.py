...
class ControlParameter(Boost.Python.instance):
    ...
    # 
    # If the parameter is set to <tt>True</tt>, the calculation result will be equivalent to the result that would have been obtained for the same input structure with all explicit ordinary hydrogens removed. If the parameter is set to <tt>False</tt>, the calculation will be performed for the unmodified molecular graph.
    # 
    ...
    # 
    # The value of this parameter specifies which method of conversion shall be used. If the parameter is set to <tt>True</tt> the latter method will be used, and the former method otherwise.
    # 
    # \valuetype  <tt>bool</tt>
    # 
    ...
    ##
    # \brief Specifies the separator for <em>SMILES</em>, <em>SMARTS</em>, <em>JME</em> and <em>InChI</em> output data records.
    # 
    ...
    ##
    # \brief Specifies for the output of data in <em>JME</em> format whether the components of a molecular graph shall be written separately or all together as a single <em>JME</em> component.
    # 
    # If the parameter is set to <tt>True</tt>, each component of a molecular graph will be represented by a corresponding <em>JME</em> molecule component in the output data record. If <tt>JME_SEPARATE_COMPONENTS</tt> is <tt>False</tt>, the components of the output molecular graph are written all together as a single <em>JME</em> component.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref JME]
    # 
    ...
    ##
    # \brief Specifies the desired version of the connection table data format for the output of molecular graphs in <em>MDL SD-</em> or <em>Mol-File</em> format.
    # 
    ...
    # 
    # If, after all, both the parameter and the property do not specify a particular connection table format version, a suitable output format is chosen as follows:
    ...
    # 
    # If, after all, both the parameter and the property do not specify a particular <em>Rxn-File</em> format version, a suitable output format is chosen as follows:
    ...
    # 
    # If the parameter is set to <tt>True</tt>, leading and trailing whitespace of data lines will be removed before processing continues. Otherwise, whitespace is considered to be significant and will be preserved.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref CTFILE]
    # 
    ...
    # 
    # If the parameter is set to <tt>True</tt>, leading and trailing whitespace of string data field values will be removed before processing continues. Otherwise, whitespace is considered to be significant and will be preserved.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref CTFILE]
    # 
    ...
    ##
    # \brief Specifies whether to output conformer energies into the energy field of the molecule header block when writing data in an <em>MDL CTFile</em>-based format.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref CTFILE]
    # 
    ...
    ##
    # \brief Specifies whether to output the energy of conformers as an <em>MDL SD-File</em> structure data entry when writing data in an <em>MDL CTFile</em>-based format.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref CTFILE]
    # 
    ...
    ##
    # \brief Specifies the format of <em>SMILES</em> molecular graph or reaction data records.
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings with explicit aromatic bond specifications.
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings with isotopic mass specifications.
    # 
    # If the parameter is set to <tt>True</tt>, the generated <em>SMILES</em> string will specify the isotopic mass of of atoms (if non-standard). If the value of <tt>SMILES_OUTPUT_ISOTOPE</tt> is <tt>False</tt>, the isotopic mass is left unspecified.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings with implicit hydrogen count specifications.
    # 
    # If the parameter is set to <tt>True</tt>, the generated <em>SMILES</em> string will specify the implicit hydrogen count of atoms (if non-standard). If the value of <tt>SMILES_OUTPUT_HYDROGEN_COUNT</tt> is <tt>False</tt>, the implicit hydrogen count is always left unspecified.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies whether to generate molecule <em>SMILES</em> strings that contain atom-atom mapping numbers.
    # 
    # If the parameter is set to <tt>True</tt>, the generated <em>SMILES</em> string will specify reaction atom-atom mapping numbers (see Chem.AtomProperty.ATOM_MAPPING_ID). If the value of <tt>SMILES_OUTPUT_ATOM_MAPPING_ID</tt> is <tt>False</tt>, atom-atom mapping numbers will not be specified.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies whether to generate reaction <em>SMILES</em> strings that contain atom-atom mapping numbers.
    # 
    # If the parameter is set to <tt>True</tt>, the generated <em>SMILES</em> string will specify reaction atom-atom mapping numbers (see Chem.AtomProperty.ATOM_MAPPING_ID). If the value of <tt>SMILES_OUTPUT_ATOM_MAPPING_ID</tt> is <tt>False</tt>, atom-atom mapping numbers will not be specified.
    # 
    # \valuetype  <tt>bool</tt> 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings with atom configuration specifications.
    # 
    # If the parameter is set to <tt>True</tt>, the generated <em>SMILES</em> string will specify the configuration of terahedral stereogenic atoms. If the value of the parameter is <tt>False</tt>, the stereochemistry of atoms is left unspecified.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings that include directional bonds for the definition of double bond configurations.
    # 
    # If the parameter is set to <tt>True</tt>, the generated <em>SMILES</em> string will contain directional bonds for the specification of chain double bond configurations. If the value of the parameter is <tt>False</tt>, the stereochemistry of double bonds is left unspecified.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies whether to generate canonical <em>SMILES</em> strings.
    # 
    # If the parameter is set to <tt>True</tt>, canonical <em>SMILES</em> strings will be generated. A canonical <em>SMILES</em> string is unique for a given chemical structure and is always identical regardless of the atom and bond order in the Chem.MolecularGraph instance that describes the structure. If the value of <tt>SMILES_OUTPUT_CANONICAL_FORM</tt> is <tt>False</tt>, the form of a generated <em>SMILES</em> string depends on the order of the atoms and bonds in the output molecular graph and thus may differ across a set of Chem.MolecularGraph instances that otherwise represent the same chemical structure.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings with kekulized aromatic rings.
    # 
    # If the parameter is set to <tt>True</tt>, aromatic rings will be represented as <em>Kekul&eacute;</em> structures with standard (non-lowercase) atom element symbols and localized bond orders. If the value of <tt>SMILES_OUTPUT_KEKULE_FORM</tt> is <tt>False</tt>, the order of localized aromatic bonds is left unspecified and aromatic atoms of type <em>C, N, O, S, Se, Te</em> or <em>As</em> will be indicated by lowercase atom element symbols.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings that also include directional bonds for the definition of ring double bond configurations.
    # 
    ...
    ##
    # \brief Specifies whether to generate <em>SMILES</em> strings with explicit single bond specifications.
    # 
    # If the parameter is set to <tt>True</tt>, generated <em>SMILES</em> strings will not only specify double and triple bonds, but also single bonds. If the value of <tt>SMILES_OUTPUT_SINGLE_BONDS</tt> is <tt>False</tt>, single bonds are left unspecified.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref SMILES] 
    # 
    ...
    ##
    # \brief Specifies options for the input of <em>InChI</em> strings.
    # 
    ...
    ##
    # \brief Specifies options for the output of <em>InChI</em> strings.
    # 
    # Please refer to the <em>InChI C-API</em> documentation [\ref INCHI] for further information about the syntax and meaning of the available options.
    # 
    # \valuetype  <tt>std::string</tt>
    ...
    # 
    # The placeholder "%I%" in the pattern will be raplaced by the one-based conformer index and the resulting string is then appended to the molecule name. An empty pattern string disables the suffix.
    # 
    # \valuetype  <tt>std::string</tt>
    # 
    ...
    ##
    # \brief Specifies whether to enable the <em>CDPL</em>-specific extended <em>Sybyl</em> atom type set when reading/writing <em>Sybyl MOL2</em> data.
    # 
    # \valuetype  <tt>bool</tt>
    # 
    ...
    ##
    # \brief Specifies whether to interpret/write the <em>Sybyl</em> bond type <tt>"ar"</tt> as aromatic when reading/writing <em>Sybyl MOL2</em> data.
    # 
    # \valuetype  <tt>bool</tt>
    # 
    ...
    ##
    # \brief Specifies whether to interpret read partial charges as formal charges (obtained by rounding to the nearest integer value) on <em>Sybyl MOL2</em> input.
    # 
    # \valuetype  <tt>bool</tt> \since 1.2.3
    # 
    ...
    ##
    # \brief Specifies whether to recompute formal atomic charges after the bond perception step when reading <em>XYZ</em> data.
    # 
    # \valuetype  <tt>bool</tt> \since 1.1
    # 
    ...
    ##
    # \brief Specifies whether to emit tetrahedral atom parities when generating <em>CML</em> output.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref CML] 
    # 
    ...
    ##
    # \brief Specifies whether to emit cis/trans descriptors for double bonds when generating <em>CML</em> output.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref CML] 
    # 
    ...
    ##
    # \brief Specifies whether to interpret/write <em>CML's</em> aromatic bond type <tt>"a"</tt> when reading/writing <em>CML</em> data.
    # 
    # \valuetype  <tt>bool</tt> 
    # \see [\ref CML] 
    # 
