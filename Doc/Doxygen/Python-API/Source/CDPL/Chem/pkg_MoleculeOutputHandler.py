...
class MoleculeOutputHandler(Boost.Python.instance):
    ...
    #
    def getObjectID(self: MoleculeOutputHandler) -> int: pass
    ...
    # \return 
    #
    def getDataFormat(self: MoleculeOutputHandler) -> CDPL.Base.DataFormat: pass
    ...
    # \return 
    #
    def createWriter(self: MoleculeOutputHandler, is: CDPL.Base.IStream) -> MoleculeWriter: pass
    ...
    # \return 
    #
    def createWriter(self: MoleculeOutputHandler, file_name: str, mode: OpenMode = CDPL.Base.OpenMode60) -> MoleculeWriter: pass
