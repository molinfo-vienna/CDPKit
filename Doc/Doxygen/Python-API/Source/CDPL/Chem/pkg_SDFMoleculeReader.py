...
# </table>
# 
class SDFMoleculeReader(MoleculeReaderBase):

    ##
    # \brief Constructs a <tt>SDFMoleculeReader</tt> instance that will read the molecule data from the input stream <em>is</em>.
    # 
