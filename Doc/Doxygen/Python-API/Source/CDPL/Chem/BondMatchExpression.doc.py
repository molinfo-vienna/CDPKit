...
class BondMatchExpression(Boost.Python.instance):
    ...
    # 
    # Different Python \c %BondMatchExpression instances may reference the same underlying C++ class instance. The commonly used Python expression
    # <tt>a is not b</tt> thus cannot tell reliably whether the two \c %BondMatchExpression instances \e a and \e b reference different C++ objects. 
    ...
    # \param target_bond The target bond.
    ...
    # 
    def __call__(query_bond: Bond, query_molgraph: MolecularGraph, target_bond: Bond, target_molgraph: MolecularGraph, aux_data: Base.Any) -> bool: pass
    ...
    # \return The result of the expression evaluation for the specified query and target objects. 
    # 
    # \note The default implementation returns the result of <tt>__call__(query_bond, query_molgraph, target_bond, target_molgraph, aux_data)</tt>.
    # 
    def __call__(query_bond: Bond, query_molgraph: MolecularGraph, target_bond: Bond, target_molgraph: MolecularGraph, mapping: AtomBondMapping, aux_data: Base.Any) -> bool: pass
