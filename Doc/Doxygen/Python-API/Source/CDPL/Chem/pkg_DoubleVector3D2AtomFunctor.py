...
class DoubleVector3D2AtomFunctor(Boost.Python.instance):
    ...
    ##
    # \brief 
    # \param self The \e %DoubleVector3D2AtomFunctor instance this method is called upon.
    # \param arg1 
    # \param arg2 
    # \param arg3 
    # \return 
    #
    def __call__(self: DoubleVector3D2AtomFunctor, arg1: CDPL.Math.Vector3D, arg2: CDPL.Math.Vector3D, arg3: Atom) -> float: pass
    ...
    # \return 
    #
    def __bool__(self: DoubleVector3D2AtomFunctor) -> bool: pass
    ...
    # \return 
    #
    def __nonzero__(self: DoubleVector3D2AtomFunctor) -> bool: pass
