...
.. note::
   Please install CDPKit before proceeding with the tutorial. For installation instructions, please refer to the `CDPKit installation documentation <../installation.html>`_.
...
libraries like RDKit, you'll find that CDPKit offers a unique set of tools and functionalities that can take your 
...
.. note::
   For a detailed description of the available functionality, just go to the `CDPL Python API Documentation <../python_api_doc/index.html>`_
   and search for the desired method or class. There you will find an exact description of the method, its parameters and return values.
