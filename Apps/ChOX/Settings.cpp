...
void Settings::load()
{
    ...
    readParameter<bool>(*this, settings, ControlParameter::SHOW_RECORD_PROPERTIES, ControlParameterDefault::SHOW_RECORD_PROPERTIES);
...
void Settings::save() const
{
    ...
    writeParameter<bool>(*this, settings, ControlParameter::SHOW_RECORD_PROPERTIES);
