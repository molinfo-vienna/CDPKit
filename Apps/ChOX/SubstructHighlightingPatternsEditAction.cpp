...
SubstructHighlightingPatternsEditAction::SubstructHighlightingPatternsEditAction(QWidget* parent, Settings& settings):
    QWidgetAction(parent), settings(settings)
{}

QWidget* SubstructHighlightingPatternsEditAction::createWidget(QWidget* parent)
{
