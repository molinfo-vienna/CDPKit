...
MAKE_CONTROL_PARAM_FUNCTIONS(SHOW_RECORD_PROPERTIES, bool, ShowRecordProperties)
...
MAKE_CONTROL_PARAM_FUNCTIONS(OUTPUT_SINGLE_RECORD_FILES, bool, OutputSingleRecordFiles)
...
MAKE_CONTROL_PARAM_FUNCTIONS(SUBSTRUCT_HIGHLIGHTING_PATTERNS, const QStringList&, SubstructHighlightingPatterns)
MAKE_CONTROL_PARAM_FUNCTIONS(SUBSTRUCT_HIGHLIGHTING_ENABLED, bool, SubstructHighlightingEnabled)

MAKE_CONTROL_PARAM_FUNCTIONS(SUBSTRUCT_SEARCH_QUERY, const QStringList&, SubstructSearchQuery)
