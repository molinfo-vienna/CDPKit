...
#ifndef SIMSCREEN_EUCLIDEANSIMILARITY_HPP
#define SIMSCREEN_EUCLIDEANSIMILARITY_HPP
...
namespace SimScreen
{
    ...
    class EuclideanSimilarity : public ScoringFunction
    {
...
#endif // SIMSCREEN_EUCLIDEANSIMILARITY_HPP
