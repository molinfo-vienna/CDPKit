...
#ifndef SIMSCREEN_COSINESIMILARITY_HPP
#define SIMSCREEN_COSINESIMILARITY_HPP
...
namespace SimScreen
{
    ...
    class CosineSimilarity : public ScoringFunction
    {
...
#endif // SIMSCREEN_COSINESIMILARITY_HPP
