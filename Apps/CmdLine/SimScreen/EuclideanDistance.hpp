...
#ifndef SIMSCREEN_EUCLIDEANDISTANCE_HPP
#define SIMSCREEN_EUCLIDEANDISTANCE_HPP
...
namespace SimScreen
{
    ...
    class EuclideanDistance : public ScoringFunction
    {
...
#endif // SIMSCREEN_EUCLIDEANDISTANCE_HPP
