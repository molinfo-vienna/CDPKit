...
#ifndef SIMSCREEN_PHARM3DFPCALCULATOR_HPP
#define SIMSCREEN_PHARM3DFPCALCULATOR_HPP
...
namespace SimScreen
{
    ...
    class Pharm3DFPCalculator : public DescriptorCalculator
    {
      ...
      private:
        typedef std::unique_ptr<CDPL::Descr::NPoint3DPharmacophoreFingerprintGenerator> FPGeneratorImplPtr;
...
#endif // SIMSCREEN_PHARM3DFPCALCULATOR_HPP
