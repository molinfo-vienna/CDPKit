...
#ifndef SIMSCREEN_MANHATTANSIMILARITY_HPP
#define SIMSCREEN_MANHATTANSIMILARITY_HPP
...
namespace SimScreen
{
    ...
    class ManhattanSimilarity : public ScoringFunction
    {
...
#endif // SIMSCREEN_MANHATTANSIMILARITY_HPP
